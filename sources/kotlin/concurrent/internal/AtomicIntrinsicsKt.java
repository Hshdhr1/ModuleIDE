...
public final class AtomicIntrinsicsKt {
    ...
    @SinceKotlin(version = "2.1")
    @PublishedApi
    public static final Object compareAndExchange(@NotNull AtomicReference atomicReference, Object obj, Object obj2) {
        ...
        } while (!AtomicIntrinsicsKt$$ExternalSyntheticBackportWithForwarding1.m(atomicReference, obj, obj2));
        return obj;
    }
    ...
    @SinceKotlin(version = "2.1")
    @PublishedApi
    public static final Object compareAndExchange(@NotNull AtomicReferenceArray atomicReferenceArray, int i, Object obj, Object obj2) {
        Intrinsics.checkNotNullParameter(atomicReferenceArray, "<this>");
        do {
            Object obj3 = atomicReferenceArray.get(i);
            if (obj != obj3) {
                return obj3;
            }
        } while (!AtomicIntrinsicsKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReferenceArray, i, obj, obj2));
        return obj;
    }
}
