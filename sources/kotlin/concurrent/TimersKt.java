...
public final class TimersKt {
    @InlineOnly
    private static final TimerTask schedule(Timer timer, long j, Function1 action) {
    ...
    @InlineOnly
    private static final TimerTask schedule(Timer timer, Date time, Function1 action) {
        Intrinsics.checkNotNullParameter(timer, "<this>");
        Intrinsics.checkNotNullParameter(time, "time");
        Intrinsics.checkNotNullParameter(action, "action");
        1 r0 = new 1(action);
        timer.schedule(r0, time);
        return r0;
    }

    @InlineOnly
    private static final TimerTask schedule(Timer timer, long j, long j2, Function1 action) {
        Intrinsics.checkNotNullParameter(timer, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        1 r0 = new 1(action);
        timer.schedule(r0, j, j2);
        return r0;
    }

    @InlineOnly
    private static final TimerTask schedule(Timer timer, Date time, long j, Function1 action) {
        Intrinsics.checkNotNullParameter(timer, "<this>");
        Intrinsics.checkNotNullParameter(time, "time");
        Intrinsics.checkNotNullParameter(action, "action");
        1 r0 = new 1(action);
        timer.schedule(r0, time, j);
        return r0;
    }

    @InlineOnly
    private static final TimerTask scheduleAtFixedRate(Timer timer, long j, long j2, Function1 action) {
        Intrinsics.checkNotNullParameter(timer, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        1 r0 = new 1(action);
        timer.scheduleAtFixedRate(r0, j, j2);
        return r0;
    }

    @InlineOnly
    private static final TimerTask scheduleAtFixedRate(Timer timer, Date time, long j, Function1 action) {
        Intrinsics.checkNotNullParameter(timer, "<this>");
        Intrinsics.checkNotNullParameter(time, "time");
        Intrinsics.checkNotNullParameter(action, "action");
        1 r0 = new 1(action);
        timer.scheduleAtFixedRate(r0, time, j);
        return r0;
    }
    ...
    static /* synthetic */ Timer timer$default(String str, boolean z, long j, long j2, Function1 action, int i, Object obj) {
        ...
        timer.schedule(new 1(action), j, j2);
        return timer;
    }

    @InlineOnly
    private static final Timer timer(String str, boolean z, long j, long j2, Function1 action) {
        Intrinsics.checkNotNullParameter(action, "action");
        Timer timer = timer(str, z);
        timer.schedule(new 1(action), j, j2);
        return timer;
    ...
    static /* synthetic */ Timer timer$default(String str, boolean z, Date startAt, long j, Function1 action, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        Timer timer = timer(str, z);
        timer.schedule(new 1(action), startAt, j);
        return timer;
    }

    @InlineOnly
    private static final Timer timer(String str, boolean z, Date startAt, long j, Function1 action) {
        Intrinsics.checkNotNullParameter(startAt, "startAt");
        Intrinsics.checkNotNullParameter(action, "action");
        Timer timer = timer(str, z);
        timer.schedule(new 1(action), startAt, j);
    ...
    static /* synthetic */ Timer fixedRateTimer$default(String str, boolean z, long j, long j2, Function1 action, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        Timer timer = timer(str, z);
        timer.scheduleAtFixedRate(new 1(action), j, j2);
        return timer;
    }

    @InlineOnly
    private static final Timer fixedRateTimer(String str, boolean z, long j, long j2, Function1 action) {
        Intrinsics.checkNotNullParameter(action, "action");
        Timer timer = timer(str, z);
        timer.scheduleAtFixedRate(new 1(action), j, j2);
        return timer;
    ...
    static /* synthetic */ Timer fixedRateTimer$default(String str, boolean z, Date startAt, long j, Function1 action, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(action, "action");
        Timer timer = timer(str, z);
        timer.scheduleAtFixedRate(new 1(action), startAt, j);
        return timer;
    }

    @InlineOnly
    private static final Timer fixedRateTimer(String str, boolean z, Date startAt, long j, Function1 action) {
        Intrinsics.checkNotNullParameter(startAt, "startAt");
        Intrinsics.checkNotNullParameter(action, "action");
        Timer timer = timer(str, z);
        timer.scheduleAtFixedRate(new 1(action), startAt, j);
    ...
    public static final class 1 extends TimerTask {
