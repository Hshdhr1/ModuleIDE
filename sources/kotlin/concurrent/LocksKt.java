...
public final class LocksKt {
    @InlineOnly
    private static final Object withLock(Lock lock, Function0 action) {
    ...
    @InlineOnly
    private static final Object read(ReentrantReadWriteLock reentrantReadWriteLock, Function0 action) {
    ...
    @InlineOnly
    private static final Object write(ReentrantReadWriteLock reentrantReadWriteLock, Function0 action) {
        Intrinsics.checkNotNullParameter(reentrantReadWriteLock, "<this>");
        Intrinsics.checkNotNullParameter(action, "action");
        ReentrantReadWriteLock.ReadLock readLock = reentrantReadWriteLock.readLock();
        int i = 0;
