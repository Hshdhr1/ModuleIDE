...
public final class ThreadsKt {
    ...
    @NotNull
    public static final Thread thread(boolean z, boolean z2, @Nullable ClassLoader classLoader, @Nullable String str, int i, @NotNull Function0 block) {
        Intrinsics.checkNotNullParameter(block, "block");
        ThreadsKt$thread$thread$1 threadsKt$thread$thread$1 = new ThreadsKt$thread$thread$1(block);
        if (z2) {
    ...
    @InlineOnly
    private static final Object getOrSet(ThreadLocal threadLocal, Function0 function0) {
