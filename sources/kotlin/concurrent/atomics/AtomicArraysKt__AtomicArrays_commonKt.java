...
class AtomicArraysKt__AtomicArrays_commonKt {
    ...
    @NotNull
    public static final AtomicIntegerArray AtomicIntArray(int i, @NotNull Function1 init) {
        Intrinsics.checkNotNullParameter(init, "init");
        int[] iArr = new int[i];
        for (int i2 = 0; i2 < i; i2++) {
            iArr[i2] = ((Number) init.invoke(Integer.valueOf(i2))).intValue();
        }
    ...
    @SinceKotlin(version = "2.1")
    @NotNull
    public static final AtomicLongArray AtomicLongArray(int i, @NotNull Function1 init) {
        Intrinsics.checkNotNullParameter(init, "init");
        long[] jArr = new long[i];
        for (int i2 = 0; i2 < i; i2++) {
            jArr[i2] = ((Number) init.invoke(Integer.valueOf(i2))).longValue();
        }
    ...
    @ExperimentalAtomicApi
    @SinceKotlin(version = "2.1")
    public static final /* synthetic */ AtomicReferenceArray AtomicArray(int i, Function1 init) {
        Intrinsics.checkNotNullParameter(init, "init");
