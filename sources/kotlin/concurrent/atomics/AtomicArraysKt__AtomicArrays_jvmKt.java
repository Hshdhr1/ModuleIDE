...
class AtomicArraysKt__AtomicArrays_jvmKt extends AtomicArraysKt__AtomicArrays_commonKt {
    ...
    @SinceKotlin(version = "2.1")
    @NotNull
    public static final AtomicReferenceArray asJavaAtomicArray(@NotNull AtomicReferenceArray atomicReferenceArray) {
    ...
    @SinceKotlin(version = "2.1")
    @NotNull
    public static final AtomicReferenceArray asKotlinAtomicArray(@NotNull AtomicReferenceArray atomicReferenceArray) {
        Intrinsics.checkNotNullParameter(atomicReferenceArray, "<this>");
        return atomicReferenceArray;
    }
}
