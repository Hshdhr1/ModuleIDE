...
public class ULongProgression implements Iterable, KMappedMarker {
    ...
    public boolean isEmpty() {
        ...
        long j2 = this.first;
        long j3 = this.last;
        return j > 0 ? ULongProgression$$ExternalSyntheticBackport0.m(j2, j3) > 0 : ULongProgression$$ExternalSyntheticBackport0.m(j2, j3) < 0;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int i = ((int) ULong.constructor-impl(j ^ ULong.constructor-impl(j >>> 32))) * 31;
        long j2 = this.last;
        int i2 = (i + ((int) ULong.constructor-impl(j2 ^ ULong.constructor-impl(j2 >>> 32)))) * 31;
        long j3 = this.step;
