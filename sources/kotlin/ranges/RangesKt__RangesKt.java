...
class RangesKt__RangesKt {
    @NotNull
    public static final ClosedRange rangeTo(@NotNull Comparable comparable, @NotNull Comparable that) {
    ...
    @NotNull
    public static final OpenEndRange rangeUntil(@NotNull Comparable comparable, @NotNull Comparable that) {
        Intrinsics.checkNotNullParameter(comparable, "<this>");
        Intrinsics.checkNotNullParameter(that, "that");
        return new ComparableOpenEndRange(comparable, that);
    }
