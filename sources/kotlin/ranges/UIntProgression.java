...
public class UIntProgression implements Iterable, KMappedMarker {
    ...
    public boolean isEmpty() {
        return this.step > 0 ? UIntProgression$$ExternalSyntheticBackport1.m(this.first, this.last) > 0 : UIntProgression$$ExternalSyntheticBackport2.m(this.first, this.last) < 0;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(UInt.toString-impl(this.first));
            sb.append("..");
            sb.append(UInt.toString-impl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
