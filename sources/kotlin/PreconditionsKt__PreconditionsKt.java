...
class PreconditionsKt__PreconditionsKt extends PreconditionsKt__AssertionsJVMKt {
    ...
    @InlineOnly
    private static final void require(boolean z, Function0 lazyMessage) {
    ...
    @InlineOnly
    private static final Object requireNotNull(Object obj, Function0 lazyMessage) {
        Intrinsics.checkNotNullParameter(lazyMessage, "lazyMessage");
        if (obj != null) {
            return obj;
        }
    ...
    @InlineOnly
    private static final void check(boolean z, Function0 lazyMessage) {
        Intrinsics.checkNotNullParameter(lazyMessage, "lazyMessage");
        if (!z) {
    ...
    @InlineOnly
    private static final Object checkNotNull(Object obj, Function0 lazyMessage) {
        Intrinsics.checkNotNullParameter(lazyMessage, "lazyMessage");
        if (obj != null) {
            return obj;
        }
