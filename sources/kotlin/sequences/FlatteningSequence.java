...
public final class FlatteningSequence implements Sequence {
    ...
    public static final class 1 implements Iterator, KMappedMarker {
        ...
        1() {
            this.iterator = FlatteningSequence.access$getSequence$p(FlatteningSequence.this).iterator();
        }
        ...
        public final void setItemIterator(Iterator it) {
        ...
        private final boolean ensureItemIterator() {
            ...
            while (this.iterator.hasNext()) {
                Iterator it2 = (Iterator) FlatteningSequence.access$getIterator$p(FlatteningSequence.this).invoke(FlatteningSequence.access$getTransformer$p(FlatteningSequence.this).invoke(this.iterator.next()));
                if (it2.hasNext()) {
