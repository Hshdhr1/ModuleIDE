...
class SequencesKt___SequencesJvmKt extends SequencesKt__SequencesKt {
    public static /* synthetic */ boolean $r8$lambda$WeyGZ8R6LXB0qgrMNVCUE2jdcHA(Class cls, Object obj) {
        return filterIsInstance$lambda$0$SequencesKt___SequencesJvmKt(cls, obj);
    }

    @NotNull
    public static final Sequence filterIsInstance(@NotNull Sequence sequence, @NotNull Class klass) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Intrinsics.checkNotNullParameter(klass, "klass");
        Sequence filter = SequencesKt.filter(sequence, new SequencesKt___SequencesJvmKt$$ExternalSyntheticLambda0(klass));
    ...
    private static final boolean filterIsInstance$lambda$0$SequencesKt___SequencesJvmKt(Class cls, Object obj) {
        return cls.isInstance(obj);
    }

    @NotNull
    public static final Collection filterIsInstanceTo(@NotNull Sequence sequence, @NotNull Collection destination, @NotNull Class klass) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    @NotNull
    public static final SortedSet toSortedSet(@NotNull Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt.toCollection(sequence, new TreeSet());
    }

    @NotNull
    public static final SortedSet toSortedSet(@NotNull Sequence sequence, @NotNull Comparator comparator) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        return SequencesKt.toCollection(sequence, new TreeSet(comparator));
    }

    @Deprecated(message = "Use maxOrNull instead.", replaceWith = @ReplaceWith(expression = "this.maxOrNull()", imports = {}))
    @SinceKotlin(version = "1.1")
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    public static final /* synthetic */ Double max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    @SinceKotlin(version = "1.1")
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    public static final /* synthetic */ Float max(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt.maxOrNull(sequence);
    }
    ...
    @SinceKotlin(version = "1.1")
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    public static final /* synthetic */ Double min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    @SinceKotlin(version = "1.1")
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    public static final /* synthetic */ Float min(Sequence sequence) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        return SequencesKt.minOrNull(sequence);
    }
    ...
    private static final BigDecimal sumOfBigDecimal(Sequence sequence, Function1 selector) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
    ...
    @OverloadResolutionByLambdaReturnType
    private static final BigInteger sumOfBigInteger(Sequence sequence, Function1 selector) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    public static final /* synthetic */ Object maxBy(Sequence sequence, Function1 selector) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        Iterator it = sequence.iterator();
        if (!it.hasNext()) {
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    public static final /* synthetic */ Object minBy(Sequence sequence, Function1 selector) {
        Intrinsics.checkNotNullParameter(sequence, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        Iterator it = sequence.iterator();
        if (!it.hasNext()) {
