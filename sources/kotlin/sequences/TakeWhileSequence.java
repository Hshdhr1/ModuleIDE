...
public final class TakeWhileSequence implements Sequence {
    ...
    public static final class 1 implements Iterator, KMappedMarker {
        ...
        1() {
            this.iterator = TakeWhileSequence.access$getSequence$p(TakeWhileSequence.this).iterator();
        }
        ...
        private final void calcNext() {
            if (this.iterator.hasNext()) {
                ...
                if (((Boolean) TakeWhileSequence.access$getPredicate$p(TakeWhileSequence.this).invoke(next)).booleanValue()) {
                    this.nextState = 1;
                    this.nextItem = next;
                    return;
                }
