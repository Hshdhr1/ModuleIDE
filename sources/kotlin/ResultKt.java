...
public final class ResultKt {
    ...
    private static final Object runCatching(Function0 block) {
        ...
        try {
            ...
            return Result.constructor-impl(block.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.constructor-impl(createFailure(th));
        }
    }

    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object runCatching(Object obj, Function1 block) {
        Intrinsics.checkNotNullParameter(block, "block");
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.constructor-impl(block.invoke(obj));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.constructor-impl(createFailure(th));
        }
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object getOrElse(Object obj, Function1 onFailure) {
        Intrinsics.checkNotNullParameter(onFailure, "onFailure");
        Throwable th = Result.exceptionOrNull-impl(obj);
        return th == null ? obj : onFailure.invoke(th);
    }

    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object getOrDefault(Object obj, Object obj2) {
        return Result.isFailure-impl(obj) ? obj2 : obj;
    }

    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object fold(Object obj, Function1 onSuccess, Function1 onFailure) {
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object map(Object obj, Function1 transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        if (!Result.isSuccess-impl(obj)) {
            return Result.constructor-impl(obj);
        }
        Result.Companion companion = Result.INSTANCE;
        return Result.constructor-impl(transform.invoke(obj));
    }

    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object mapCatching(Object obj, Function1 transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        if (!Result.isSuccess-impl(obj)) {
            return Result.constructor-impl(obj);
        }
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object recover(Object obj, Function1 transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable th = Result.exceptionOrNull-impl(obj);
        if (th == null) {
            return obj;
        ...
        Result.Companion companion = Result.INSTANCE;
        return Result.constructor-impl(transform.invoke(th));
    }

    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object recoverCatching(Object obj, Function1 transform) {
        Intrinsics.checkNotNullParameter(transform, "transform");
        Throwable th = Result.exceptionOrNull-impl(obj);
        if (th == null) {
            return obj;
        ...
        try {
            ...
            Result.Companion companion2 = Result.INSTANCE;
            return Result.constructor-impl(createFailure(th2));
        }
    }

    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object onFailure(Object obj, Function1 action) {
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object onSuccess(Object obj, Function1 action) {
        Intrinsics.checkNotNullParameter(action, "action");
        if (Result.isSuccess-impl(obj)) {
            action.invoke(obj);
        }
