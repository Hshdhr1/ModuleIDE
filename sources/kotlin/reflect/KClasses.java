...
public final class KClasses {
    ...
    @NotNull
    public static final Object cast(@NotNull KClass kClass, @Nullable Object obj) {
    ...
    @SinceKotlin(version = "1.4")
    @Nullable
    public static final Object safeCast(@NotNull KClass kClass, @Nullable Object obj) {
        Intrinsics.checkNotNullParameter(kClass, "<this>");
        if (!kClass.isInstance(obj)) {
            return null;
        }
