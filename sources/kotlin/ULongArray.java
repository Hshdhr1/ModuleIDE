...
public final class ULongArray implements Collection, KMappedMarker {
    ...
    public static final /* synthetic */ ULongArray box-impl(long[] jArr) {
    ...
    @NotNull
    public static java.util.Iterator iterator-impl(long[] jArr) {
    ...
    public static boolean containsAll-impl(long[] jArr, @NotNull Collection elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
