...
public final class MapAccessorsKt {
    @InlineOnly
    private static final Object getValue(Map map, Object obj, KProperty property) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(property, "property");
        return MapsKt.getOrImplicitDefaultNullable(map, property.getName());
    }

    @InlineOnly
    @JvmName(name = "getVar")
    private static final Object getVar(Map map, Object obj, KProperty property) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(property, "property");
        return MapsKt.getOrImplicitDefaultNullable(map, property.getName());
    }
    ...
    @InlineOnly
    private static final void setValue(Map map, Object obj, KProperty property, Object obj2) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(property, "property");
