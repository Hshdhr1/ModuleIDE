...
class CollectionsKt__MutableCollectionsJVMKt extends CollectionsKt__IteratorsKt {
    ...
    @InlineOnly
    private static final void sort(List list, Function2 comparison) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        Intrinsics.checkNotNullParameter(comparison, "comparison");
        throw new NotImplementedError(null, 1, null);
    }

    public static final void sort(@NotNull List list) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        if (list.size() > 1) {
    ...
    public static final void sortWith(@NotNull List list, @NotNull Comparator comparator) {
        Intrinsics.checkNotNullParameter(list, "<this>");
        Intrinsics.checkNotNullParameter(comparator, "comparator");
        if (list.size() > 1) {
