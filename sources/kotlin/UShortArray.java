...
public final class UShortArray implements Collection, KMappedMarker {
    ...
    public static final /* synthetic */ UShortArray box-impl(short[] sArr) {
    ...
    @NotNull
    public static java.util.Iterator iterator-impl(short[] sArr) {
    ...
    public static boolean containsAll-impl(short[] sArr, @NotNull Collection elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
