...
class StringsKt___StringsJvmKt extends StringsKt__StringsKt {
    ...
    @NotNull
    public static final SortedSet toSortedSet(@NotNull CharSequence charSequence) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        return StringsKt.toCollection(charSequence, new TreeSet());
    }
    ...
    private static final BigDecimal sumOfBigDecimal(CharSequence charSequence, Function1 selector) {
        ...
        for (int i = 0; i < charSequence.length(); i++) {
            valueOf = valueOf.add((BigDecimal) selector.invoke(Character.valueOf(charSequence.charAt(i))));
    ...
    private static final BigInteger sumOfBigInteger(CharSequence charSequence, Function1 selector) {
        ...
        Intrinsics.checkNotNullExpressionValue(valueOf, "valueOf(...)");
        for (int i = 0; i < charSequence.length(); i++) {
            valueOf = valueOf.add((BigInteger) selector.invoke(Character.valueOf(charSequence.charAt(i))));
            Intrinsics.checkNotNullExpressionValue(valueOf, "add(...)");
        }
        return valueOf;
    }
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    public static final /* synthetic */ Character maxBy(CharSequence charSequence, Function1 selector) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
    ...
    @DeprecatedSinceKotlin(errorSince = "1.5", hiddenSince = "1.6", warningSince = "1.4")
    public static final /* synthetic */ Character minBy(CharSequence charSequence, Function1 selector) {
        Intrinsics.checkNotNullParameter(charSequence, "<this>");
        Intrinsics.checkNotNullParameter(selector, "selector");
        if (charSequence.length() == 0) {
            return null;
