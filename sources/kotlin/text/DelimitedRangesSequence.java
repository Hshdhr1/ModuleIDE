...
final class DelimitedRangesSequence implements Sequence {
    ...
    public static final class 1 implements Iterator, KMappedMarker {
        ...
        1() {
            int coerceIn = RangesKt.coerceIn(DelimitedRangesSequence.access$getStartIndex$p(DelimitedRangesSequence.this), 0, DelimitedRangesSequence.access$getInput$p(DelimitedRangesSequence.this).length());
