...
public final class RegexKt {
    ...
    private static final /* synthetic */ Set fromInt(int i) {
        Intrinsics.reifiedOperationMarker(4, "T");
        Set allOf = EnumSet.allOf(Enum.class);
        Intrinsics.checkNotNull(allOf);
        Intrinsics.needClassReification();
        CollectionsKt.retainAll((Iterable) allOf, new RegexKt$fromInt$1$1(i));
    ...
    private static final int toInt(Iterable iterable) {
