...
public final class UStringsKt {
    ...
    public static final UByte toUByteOrNull(@NotNull String str, int i) {
        ...
        if (UStringsKt$$ExternalSyntheticBackport8.m(data, UInt.constructor-impl(255)) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(@NotNull String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (UStringsKt$$ExternalSyntheticBackport3.m(data, UInt.constructor-impl(65535)) > 0) {
            return null;
        }
    ...
    public static final UInt toUIntOrNull(@NotNull String str, int i) {
        ...
        while (i2 < length) {
            ...
            if (UStringsKt$$ExternalSyntheticBackport4.m(i3, i5) > 0) {
                if (i5 == 119304647) {
                    i5 = UStringsKt$$ExternalSyntheticBackport5.m(-1, i4);
                    if (UStringsKt$$ExternalSyntheticBackport6.m(i3, i5) > 0) {
                    }
                }
                return null;
            }
            int i6 = UInt.constructor-impl(i3 * i4);
            int i7 = UInt.constructor-impl(UInt.constructor-impl(digitOf) + i6);
            if (UStringsKt$$ExternalSyntheticBackport7.m(i7, i6) < 0) {
                return null;
            }
            i2++;
            i3 = i7;
    ...
    public static final ULong toULongOrNull(@NotNull String str, int i) {
        ...
        long j = ULong.constructor-impl(i);
        long j2 = 0;
        ...
        while (i2 < length) {
            ...
            if (UStringsKt$$ExternalSyntheticBackport0.m(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UStringsKt$$ExternalSyntheticBackport1.m(-1L, j);
                    if (UStringsKt$$ExternalSyntheticBackport0.m(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long j4 = ULong.constructor-impl(j2 * j);
            long j5 = ULong.constructor-impl(ULong.constructor-impl(UInt.constructor-impl(r13) & 4294967295L) + j4);
            if (UStringsKt$$ExternalSyntheticBackport0.m(j5, j4) < 0) {
                return null;
            }
            i2++;
            j2 = j5;
        }
        return ULong.box-impl(j2);
    }
}
