...
public final class HexExtensionsKt {
    ...
    */
    ...
    private static final int checkFormatLength(long j) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ULong.toString-impl(ULong.constructor-impl(j)));
    }
    ...
    private static final byte[] hexToByteArrayShortByteSeparatorNoPrefixAndSuffix(String str, int i, int i2, HexFormat.BytesHexFormat bytesHexFormat) {
        ...
        for (int i9 = 1; i9 < i8; i9++) {
            if (str.charAt(i4) != charAt) {
                CharSequence byteSeparator = bytesHexFormat.getByteSeparator();
    ...
    private static final byte[] hexToByteArrayNoLineAndGroupSeparatorSlowPath(String str, int i, int i2, HexFormat.BytesHexFormat bytesHexFormat) {
        CharSequence bytePrefix = bytesHexFormat.getBytePrefix();
        CharSequence byteSuffix = bytesHexFormat.getByteSuffix();
        String byteSeparator = bytesHexFormat.getByteSeparator();
        ...
        CharSequence charSequence2 = byteSuffix + byteSeparator + bytePrefix;
        int i5 = i3 - 1;
        for (int i6 = 0; i6 < i5; i6++) {
            ...
            if (charSequence3.length() != 0) {
                ...
                for (int i7 = 0; i7 < length4; i7++) {
                    if (!CharsKt.equals(charSequence2.charAt(i7), str.charAt(i + i7), ignoreCase$kotlin_stdlib)) {
                        throwNotContainedAt(str, i, i2, charSequence2, "byte suffix + byte separator + byte prefix");
                    }
                }
        ...
        int i8 = i + 2;
        CharSequence charSequence4 = byteSuffix;
    ...
    */
    ...
    private static final void checkPrefixSuffixNumberOfDigits(String str, int i, int i2, String str2, String str3, boolean z, int i3) {
        ...
        CharSequence charSequence = (CharSequence) str2;
        if (charSequence.length() != 0) {
        ...
        CharSequence charSequence2 = (CharSequence) str3;
