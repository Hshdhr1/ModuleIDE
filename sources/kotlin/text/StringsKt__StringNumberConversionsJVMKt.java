...
class StringsKt__StringNumberConversionsJVMKt extends StringsKt__StringBuilderKt {
    ...
    private static final Object screenFloatValue$StringsKt__StringNumberConversionsJVMKt(String str, Function1 function1) {
        try {
    ...
    */
    ...
    @InlineOnly
    private static final int advanceWhile$StringsKt__StringNumberConversionsJVMKt(String str, int i, int i2, Function1 function1) {
        while (i <= i2 && ((Boolean) function1.invoke(Character.valueOf(str.charAt(i)))).booleanValue()) {
            i++;
        }
        return i;
    }
    ...
    @InlineOnly
    private static final int backtrackWhile$StringsKt__StringNumberConversionsJVMKt(String str, int i, int i2, Function1 function1) {
        while (i2 > i && ((Boolean) function1.invoke(Character.valueOf(str.charAt(i2)))).booleanValue()) {
            i2--;
        }
        return i2;
    }
    ...
    @InlineOnly
    private static final int advanceAndValidateMantissa$StringsKt__StringNumberConversionsJVMKt(String str, int i, int i2, boolean z, Function1 function1) {
        boolean z2;
        String str2;
        int i3 = i;
        while (i3 <= i2 && ((Boolean) function1.invoke(Character.valueOf(str.charAt(i3)))).booleanValue()) {
            i3++;
        }
        boolean z3 = i != i3;
        if (i3 > i2) {
        ...
        if (str.charAt(i3) == '.') {
            int i4 = i3 + 1;
            int i5 = i4;
            while (i5 <= i2 && ((Boolean) function1.invoke(Character.valueOf(str.charAt(i5)))).booleanValue()) {
                i5++;
            }
            z2 = i4 != i5;
            i3 = i5;
