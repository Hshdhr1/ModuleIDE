...
public final class HexFormat {
    ...
    public static final class BytesHexFormat {
        ...
        public BytesHexFormat(int i, int i2, @NotNull String groupSeparator, @NotNull String byteSeparator, @NotNull String bytePrefix, @NotNull String byteSuffix) {
            ...
            this.shortByteSeparatorNoPrefixAndSuffix = ((CharSequence) bytePrefix).length() == 0 && ((CharSequence) byteSuffix).length() == 0 && byteSeparator.length() <= 1;
        ...
        public static final class Builder {
            ...
            public final void setByteSeparator(@NotNull String value) {
                ...
                if (StringsKt.contains$default(charSequence, '\n', false, 2, (Object) null) || StringsKt.contains$default(charSequence, '\r', false, 2, (Object) null)) {
    ...
    public static final class NumberHexFormat {
        ...
        public NumberHexFormat(@NotNull String prefix, @NotNull String suffix, boolean z, int i) {
            ...
            this.minLength = i;
            boolean z2 = ((CharSequence) prefix).length() == 0 && ((CharSequence) suffix).length() == 0;
