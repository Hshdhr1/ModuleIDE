...
public final class TypeReference implements KType {
    ...
    public static /* synthetic */ CharSequence $r8$lambda$TqUhj1JlPuVAfFHzMnjOlMDw418(TypeReference typeReference, KTypeProjection kTypeProjection) {
    ...
    @SinceKotlin(version = "1.6")
    public TypeReference(@NotNull KClassifier classifier, @NotNull List arguments, @Nullable KType kType, int i) {
    ...
    private final String asString(boolean convertPrimitiveToWrapper) {
        ...
        String str = name + (getArguments().isEmpty() ? "" : CollectionsKt.joinToString$default(getArguments(), ", ", "<", ">", 0, null, new TypeReference$$ExternalSyntheticLambda0(this), 24, null)) + (isMarkedNullable() ? "?" : "");
    ...
    private static final CharSequence asString$lambda$0(TypeReference typeReference, KTypeProjection it) {
