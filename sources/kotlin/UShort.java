...
public final class UShort implements Comparable {
    ...
    public /* bridge */ /* synthetic */ int compareTo(Object obj) {
        return Intrinsics.compare(getData() & 65535, ((UShort) obj).getData() & 65535);
    }
    ...
    private static final int compareTo-WZ4Q5Ns(short s, int i) {
        return UShort$$ExternalSyntheticBackport6.m(UInt.constructor-impl(s & 65535), i);
    }

    @InlineOnly
    private static final int compareTo-VKZWuLQ(short s, long j) {
        return UShort$$ExternalSyntheticBackport1.m(ULong.constructor-impl(s & 65535), j);
    }

    @InlineOnly
    private static final int plus-7apg3OU(short s, byte b) {
        return UInt.constructor-impl(UInt.constructor-impl(s & 65535) + UInt.constructor-impl(b & 255));
    }
    ...
    private static final int plus-WZ4Q5Ns(short s, int i) {
        return UInt.constructor-impl(UInt.constructor-impl(s & 65535) + i);
    }

    @InlineOnly
    private static final long plus-VKZWuLQ(short s, long j) {
        return ULong.constructor-impl(ULong.constructor-impl(s & 65535) + j);
    }
    ...
    private static final int div-7apg3OU(short s, byte b) {
        return UShort$$ExternalSyntheticBackport0.m(UInt.constructor-impl(s & 65535), UInt.constructor-impl(b & 255));
    }

    @InlineOnly
    private static final int div-xj2QHRw(short s, short s2) {
        return UShort$$ExternalSyntheticBackport0.m(UInt.constructor-impl(s & 65535), UInt.constructor-impl(s2 & 65535));
    }

    @InlineOnly
    private static final int div-WZ4Q5Ns(short s, int i) {
        return UShort$$ExternalSyntheticBackport0.m(UInt.constructor-impl(s & 65535), i);
    }

    @InlineOnly
    private static final long div-VKZWuLQ(short s, long j) {
        return UShort$$ExternalSyntheticBackport5.m(ULong.constructor-impl(s & 65535), j);
    }

    @InlineOnly
    private static final int rem-7apg3OU(short s, byte b) {
        return UShort$$ExternalSyntheticBackport3.m(UInt.constructor-impl(s & 65535), UInt.constructor-impl(b & 255));
    }

    @InlineOnly
    private static final int rem-xj2QHRw(short s, short s2) {
        return UShort$$ExternalSyntheticBackport3.m(UInt.constructor-impl(s & 65535), UInt.constructor-impl(s2 & 65535));
    }

    @InlineOnly
    private static final int rem-WZ4Q5Ns(short s, int i) {
        return UShort$$ExternalSyntheticBackport3.m(UInt.constructor-impl(s & 65535), i);
    }

    @InlineOnly
    private static final long rem-VKZWuLQ(short s, long j) {
        return UShort$$ExternalSyntheticBackport2.m(ULong.constructor-impl(s & 65535), j);
    }
    ...
    private static final byte mod-7apg3OU(short s, byte b) {
        return UByte.constructor-impl((byte) UShort$$ExternalSyntheticBackport3.m(UInt.constructor-impl(s & 65535), UInt.constructor-impl(b & 255)));
    }

    @InlineOnly
    private static final short mod-xj2QHRw(short s, short s2) {
        return constructor-impl((short) UShort$$ExternalSyntheticBackport3.m(UInt.constructor-impl(s & 65535), UInt.constructor-impl(s2 & 65535)));
    }
    ...
    private static final UIntRange rangeUntil-xj2QHRw(short s, short s2) {
        return URangesKt.until-J1ME1BU(UInt.constructor-impl(s & 65535), UInt.constructor-impl(s2 & 65535));
    }
