...
public final class TextStreamsKt {
    public static /* synthetic */ Unit $r8$lambda$uJuWTzuh3RiWd3H-eZeBP1NitVI(ArrayList arrayList, String str) {
        return readLines$lambda$1(arrayList, str);
    }
    ...
    @NotNull
    public static final List readLines(@NotNull Reader reader) {
        Intrinsics.checkNotNullParameter(reader, "<this>");
        List arrayList = new ArrayList();
        forEachLine(reader, new TextStreamsKt$$ExternalSyntheticLambda0(arrayList));
        return arrayList;
    }

    private static final Unit readLines$lambda$1(ArrayList arrayList, String it) {
        Intrinsics.checkNotNullParameter(it, "it");
        arrayList.add(it);
        return Unit.INSTANCE;
    }

    public static final Object useLines(@NotNull Reader reader, @NotNull Function1 block) {
        Intrinsics.checkNotNullParameter(reader, "<this>");
        Intrinsics.checkNotNullParameter(block, "block");
        BufferedReader bufferedReader = (Closeable) (reader instanceof BufferedReader ? (BufferedReader) reader : new BufferedReader(reader, 8192));
        try {
            Object invoke = block.invoke(lineSequence(bufferedReader));
    ...
    @NotNull
    public static final Sequence lineSequence(@NotNull BufferedReader bufferedReader) {
    ...
    public static final byte[] readBytes(@NotNull URL url) {
        Intrinsics.checkNotNullParameter(url, "<this>");
        InputStream inputStream = (Closeable) url.openStream();
        try {
    ...
    public static final void forEachLine(@NotNull Reader reader, @NotNull Function1 action) {
        Intrinsics.checkNotNullParameter(reader, "<this>");
