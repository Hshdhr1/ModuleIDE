    ...
    private final class FileTreeWalkIterator extends AbstractIterator {
        ...
        public FileTreeWalkIterator() {
            ...
            if (FileTreeWalk.access$getStart$p(FileTreeWalk.this).isDirectory()) {
                arrayDeque.push(directoryState(FileTreeWalk.access$getStart$p(FileTreeWalk.this)));
            } else if (FileTreeWalk.access$getStart$p(FileTreeWalk.this).isFile()) {
                arrayDeque.push(new SingleFileState(this, FileTreeWalk.access$getStart$p(FileTreeWalk.this)));
            } else {
                done();
            }
        }
        ...
        private final DirectoryState directoryState(File root) {
            int i = WhenMappings.$EnumSwitchMapping$0[FileTreeWalk.access$getDirection$p(FileTreeWalk.this).ordinal()];
            if (i == 1) {
        ...
        private final class BottomUpDirectoryState extends DirectoryState {
            ...
            public File step() {
                if (!this.failed && this.fileList == null) {
                    Function1 access$getOnEnter$p = FileTreeWalk.access$getOnEnter$p(FileTreeWalk.this);
                    ...
                    if (listFiles == null) {
                        Function2 access$getOnFail$p = FileTreeWalk.access$getOnFail$p(FileTreeWalk.this);
                ...
                Function1 access$getOnLeave$p = FileTreeWalk.access$getOnLeave$p(FileTreeWalk.this);
