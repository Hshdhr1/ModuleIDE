...
public interface FileVisitorBuilder {
    void onPostVisitDirectory(@NotNull Function2 function);

    void onPreVisitDirectory(@NotNull Function2 function);

    void onVisitFile(@NotNull Function2 function);

    void onVisitFileFailed(@NotNull Function2 function);
}
