...
public final class ContinuationKt {
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final void resume(Continuation continuation, Object obj) {
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final void resumeWithException(Continuation continuation, Throwable exception) {
        Intrinsics.checkNotNullParameter(continuation, "<this>");
    ...
    /* compiled from: Continuation.kt */
    @Metadata(d1 = {"\u0000!\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u001b\u0010\u0006\u001a\u00020\u00072\f\u0010\b\u001a\b\u0012\u0004\u0012\u00028\u00000\tH\u0016¢\u0006\u0002\u0010\nR\u0014\u0010\u0002\u001a\u00020\u00038VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005¨\u0006\u000b"}, d2 = {"kotlin/coroutines/ContinuationKt$Continuation$1", "Lkotlin/coroutines/Continuation;", "context", "Lkotlin/coroutines/CoroutineContext;", "getContext", "()Lkotlin/coroutines/CoroutineContext;", "resumeWith", "", "result", "Lkotlin/Result;", "(Ljava/lang/Object;)V", "kotlin-stdlib"}, k = 1, mv = {2, 1, 0}, xi = 176)
    public static final class 1 implements Continuation {
        final /* synthetic */ CoroutineContext $context;
        final /* synthetic */ Function1 $resumeWith;

        public 1(CoroutineContext coroutineContext, Function1 function1) {
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Continuation Continuation(CoroutineContext context, Function1 resumeWith) {
    ...
    @SinceKotlin(version = "1.3")
    @NotNull
    public static final Continuation createCoroutine(@NotNull Function1 function1, @NotNull Continuation completion) {
    ...
    @SinceKotlin(version = "1.3")
    @NotNull
    public static final Continuation createCoroutine(@NotNull Function2 function2, Object obj, @NotNull Continuation completion) {
    ...
    @SinceKotlin(version = "1.3")
    public static final void startCoroutine(@NotNull Function1 function1, @NotNull Continuation completion) {
        Intrinsics.checkNotNullParameter(function1, "<this>");
        Intrinsics.checkNotNullParameter(completion, "completion");
    ...
    @SinceKotlin(version = "1.3")
    public static final void startCoroutine(@NotNull Function2 function2, Object obj, @NotNull Continuation completion) {
        Intrinsics.checkNotNullParameter(function2, "<this>");
        Intrinsics.checkNotNullParameter(completion, "completion");
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final Object suspendCoroutine(Function1 function1, Continuation continuation) {
