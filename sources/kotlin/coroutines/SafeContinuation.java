...
public final class SafeContinuation implements Continuation, CoroutineStackFrame {
    ...
    public void resumeWith(@NotNull Object result) {
        while (true) {
            ...
            if (obj == CoroutineSingletons.UNDECIDED) {
                if (SafeContinuation$$ExternalSyntheticBackportWithForwarding0.m(RESULT, this, CoroutineSingletons.UNDECIDED, result)) {
                    return;
                }
            } else {
                ...
                if (SafeContinuation$$ExternalSyntheticBackportWithForwarding0.m(RESULT, this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), CoroutineSingletons.RESUMED)) {
    ...
    public final Object getOrThrow() {
        Object obj = this.result;
        if (obj == CoroutineSingletons.UNDECIDED) {
            if (SafeContinuation$$ExternalSyntheticBackportWithForwarding0.m(RESULT, this, CoroutineSingletons.UNDECIDED, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
