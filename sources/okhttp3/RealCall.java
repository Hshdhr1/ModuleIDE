...
final class RealCall implements Call {
    ...
    static /* synthetic */ EventListener access$000(RealCall x0) {
        ...
        protected void execute() {
            try {
                ...
                if (0 != 0) {
                    ...
                    RealCall.access$000(RealCall.this).callFailed(RealCall.this, e);
    ...
    Response getResponseWithInterceptorChain() throws IOException {
        ...
        Interceptor.Chain chain = new RealInterceptorChain(arrayList, null, null, null, 0, this.originalRequest, this, this.eventListener, this.client.connectTimeoutMillis(), this.client.readTimeoutMillis(), this.client.writeTimeoutMillis());
