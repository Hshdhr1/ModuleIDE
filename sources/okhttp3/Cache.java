...
public final class Cache implements Closeable, Flushable {
    ...
    CacheRequest put(Response response) {
        ...
        if (!requestMethod.equals("GET") || HttpHeaders.hasVaryAll(response)) {
            return null;
        }
    ...
    private final class CacheRequestImpl implements CacheRequest {
        ...
        CacheRequestImpl(DiskLruCache.Editor editor) {
            ...
            this.body = new 1(this.cacheOut, Cache.this, editor);
        }

        class 1 extends ForwardingSink {
            final /* synthetic */ DiskLruCache.Editor val$editor;
            final /* synthetic */ Cache val$this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            1(Sink x0, Cache cache, DiskLruCache.Editor editor) {
                super(x0);
    ...
    private static final class Entry {
        ...
        private List readCertificateList(BufferedSource source) throws IOException {
            ...
            try {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    arrayList.add(certificateFactory.generateCertificate(bytes.inputStream()));
                }
                return arrayList;
        ...
        private void writeCertList(BufferedSink sink, List list) throws IOException {
            try {
    ...
    private static class CacheResponseBody extends ResponseBody {
        ...
        CacheResponseBody(DiskLruCache.Snapshot snapshot, String contentType, String contentLength) {
            this.snapshot = snapshot;
            this.contentType = contentType;
            this.contentLength = contentLength;
            Source source = snapshot.getSource(1);
            this.bodySource = Okio.buffer(new 1(source, snapshot));
        }

        class 1 extends ForwardingSource {
            final /* synthetic */ DiskLruCache.Snapshot val$snapshot;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            1(Source x0, DiskLruCache.Snapshot snapshot) {
                super(x0);
