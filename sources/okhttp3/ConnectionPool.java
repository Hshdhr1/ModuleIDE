...
public final class ConnectionPool {
    ...
    private int pruneAndGetAllocationCount(RealConnection connection, long now) {
        ...
        while (i < references.size()) {
            StreamAllocation.StreamAllocationReference streamAllocationReference = (Reference) references.get(i);
            if (streamAllocationReference.get() != null) {
                i++;
            } else {
                StreamAllocation.StreamAllocationReference streamAllocRef = streamAllocationReference;
