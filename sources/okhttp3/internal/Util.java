...
public final class Util {
    ...
    public static final Comparator NATURAL_ORDER = new 1();
    ...
    final class 2 implements ThreadFactory {
    ...
    public static String[] intersect(Comparator comparator, String[] first, String[] second) {
    ...
    public static boolean nonEmptyIntersection(Comparator comparator, String[] first, String[] second) {
    ...
    public static AssertionError assertionError(String message, Exception e) {
        return new AssertionError(message).initCause(e);
    }
