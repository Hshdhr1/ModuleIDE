...
final class Http2Writer implements Closeable {
    ...
    public synchronized void pushPromise(int streamId, int promisedStreamId, List list) throws IOException {
        if (this.closed) {
            throw new IOException("closed");
        }
    ...
    public synchronized void synStream(boolean outFinished, int streamId, int associatedStreamId, List list) throws IOException {
        if (this.closed) {
            throw new IOException("closed");
        }
    ...
    public synchronized void synReply(boolean outFinished, int streamId, List list) throws IOException {
        if (this.closed) {
            throw new IOException("closed");
        }
        headers(outFinished, streamId, list);
    ...
    public synchronized void headers(int streamId, List list) throws IOException {
        if (this.closed) {
            throw new IOException("closed");
        }
    ...
    void headers(boolean outFinished, int streamId, List list) throws IOException {
        if (this.closed) {
            throw new IOException("closed");
        }
        this.hpackWriter.writeHeaders(list);
