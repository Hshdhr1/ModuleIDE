...
public final class Http2Codec implements HttpCodec {
    ...
    private static final List HTTP_2_SKIPPED_REQUEST_HEADERS = Util.immutableList(CONNECTION, HOST, KEEP_ALIVE, PROXY_CONNECTION, TE, TRANSFER_ENCODING, ENCODING, UPGRADE, Header.TARGET_METHOD, Header.TARGET_PATH, Header.TARGET_SCHEME, Header.TARGET_AUTHORITY);
    ...
    public static List http2HeadersList(Request request) {
        ...
        if (host != null) {
            arrayList.add(new Header(Header.TARGET_AUTHORITY, host));
        }
    ...
    public ResponseBody openResponseBody(Response response) throws IOException {
        ...
        return new RealResponseBody(contentType, contentLength, Okio.buffer(new StreamFinishingSource(this.stream.getSource())));
    }
