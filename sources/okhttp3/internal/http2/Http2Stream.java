...
public final class Http2Stream {
    ...
    Http2Stream(int id, Http2Connection connection, boolean outFinished, boolean inFinished, List list) {
        if (connection == null) {
    ...
    */
    ...
    public synchronized List takeResponseHeaders() throws IOException {
        List<Header> result;
    ...
    public void sendResponseHeaders(List list, boolean out) throws IOException {
