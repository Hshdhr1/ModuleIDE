    ...
    */
    ...
    /*  JADX ERROR: IIiLliI1l1li1 in pass: RegionMakerVisitor
        l1LI1IIIL1lLl.IIiLliI1l1li1: Failed to find switch 'out' block (already processed)
        	...
        	at jadx.core.dex.visitors.regions.maker.LoopRegionMaker.process(Unknown Source:235)
    ...
    class 1 extends RealWebSocket.Streams {
        final /* synthetic */ StreamAllocation val$streamAllocation;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        1(boolean client, BufferedSource source, BufferedSink sink, StreamAllocation streamAllocation) {
    ...
    public RealWebSocket.Streams newWebSocketStreams(StreamAllocation streamAllocation) {
        return new 1(true, this.source, this.sink, streamAllocation);
    }
