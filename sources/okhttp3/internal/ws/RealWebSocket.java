...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public void connect(OkHttpClient client) {
        ...
        this.call.enqueue(new 2(request, pingIntervalMillis));
    }
        ...
        public void onResponse(Call call, Response response) {
            try {
                ...
                try {
                    ...
                    String name = "OkHttp WebSocket " + this.val$request.url().redact();
                    RealWebSocket.this.initReaderAndWriter(name, this.val$pingIntervalMillis, streams);
