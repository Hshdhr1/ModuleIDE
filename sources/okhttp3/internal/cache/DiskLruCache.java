...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    class 2 extends FaultHidingSink {
        static final /* synthetic */ boolean $assertionsDisabled;
    ...
    private BufferedSink newJournalWriter() throws FileNotFoundException {
        ...
        return Okio.buffer(new 2(fileSink));
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:30:0x0056 A[Catch: all -> 0x000d, TryCatch #0 {, blocks: (B:3:0x0001, B:5:0x0007, B:6:0x000c, B:9:0x0012, B:12:0x0017, B:14:0x001b, B:24:0x0021, B:25:0x003c, B:16:0x003d, B:20:0x0049, B:28:0x0052, B:30:0x0056, B:32:0x005c, B:34:0x0064, B:36:0x0081, B:38:0x0084, B:41:0x008a, B:43:0x0098, B:45:0x00bd, B:46:0x00c6, B:48:0x00d3, B:50:0x00d9, B:51:0x00e2), top: B:2:0x0001 }] */
    /* JADX WARN: Removed duplicated region for block: B:43:0x0098 A[Catch: all -> 0x000d, TryCatch #0 {, blocks: (B:3:0x0001, B:5:0x0007, B:6:0x000c, B:9:0x0012, B:12:0x0017, B:14:0x001b, B:24:0x0021, B:25:0x003c, B:16:0x003d, B:20:0x0049, B:28:0x0052, B:30:0x0056, B:32:0x005c, B:34:0x0064, B:36:0x0081, B:38:0x0084, B:41:0x008a, B:43:0x0098, B:45:0x00bd, B:46:0x00c6, B:48:0x00d3, B:50:0x00d9, B:51:0x00e2), top: B:2:0x0001 }] */
    /* JADX WARN: Removed duplicated region for block: B:50:0x00d9 A[Catch: all -> 0x000d, TryCatch #0 {, blocks: (B:3:0x0001, B:5:0x0007, B:6:0x000c, B:9:0x0012, B:12:0x0017, B:14:0x001b, B:24:0x0021, B:25:0x003c, B:16:0x003d, B:20:0x0049, B:28:0x0052, B:30:0x0056, B:32:0x005c, B:34:0x0064, B:36:0x0081, B:38:0x0084, B:41:0x008a, B:43:0x0098, B:45:0x00bd, B:46:0x00c6, B:48:0x00d3, B:50:0x00d9, B:51:0x00e2), top: B:2:0x0001 }] */
    /* JADX WARN: Removed duplicated region for block: B:51:0x00e2 A[Catch: all -> 0x000d, TRY_LEAVE, TryCatch #0 {, blocks: (B:3:0x0001, B:5:0x0007, B:6:0x000c, B:9:0x0012, B:12:0x0017, B:14:0x001b, B:24:0x0021, B:25:0x003c, B:16:0x003d, B:20:0x0049, B:28:0x0052, B:30:0x0056, B:32:0x005c, B:34:0x0064, B:36:0x0081, B:38:0x0084, B:41:0x008a, B:43:0x0098, B:45:0x00bd, B:46:0x00c6, B:48:0x00d3, B:50:0x00d9, B:51:0x00e2), top: B:2:0x0001 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    synchronized void completeEdit(okhttp3.internal.cache.DiskLruCache.Editor r13, boolean r14) throws java.io.IOException {
        /*
    ...
    void trimToSize() throws IOException {
        while (this.size > this.maxSize) {
            Entry toEvict = (Entry) this.lruEntries.values().iterator().next();
            removeEntry(toEvict);
        }
        this.mostRecentTrimFailed = false;
    }
    ...
    class 3 implements Iterator {
        ...
        public void remove() {
            ...
            try {
                DiskLruCache.this.remove(Snapshot.access$000(this.removeSnapshot));
            } catch (IOException e) {
            } finally {
    ...
    public final class Snapshot implements Closeable {
        ...
        static /* synthetic */ String access$000(Snapshot x0) {
            return x0.key;
        }
    ...
    public final class Editor {
        ...
        class 1 extends FaultHidingSink {
            1(Sink delegate) {
                super(delegate);
            }
    ...
    private final class Entry {
        ...
        Snapshot snapshot() {
            ...
            return DiskLruCache.this.new Snapshot(this.key, this.sequenceNumber, closeableArr, lengths);
        }
    }
}
