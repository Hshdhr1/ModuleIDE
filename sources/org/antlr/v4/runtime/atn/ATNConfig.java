...
public class ATNConfig {
    ...
    public boolean equals(ATNConfig other) {
        ...
        return this.state.stateNumber == other.state.stateNumber && this.alt == other.alt && (this.context == other.context || (this.context != null && this.context.equals(other.context))) && this.semanticContext.equals(other.semanticContext) && isPrecedenceFilterSuppressed() == other.isPrecedenceFilterSuppressed();
    }

    public int hashCode() {
        int hashCode = MurmurHash.initialize(7);
        return MurmurHash.finish(MurmurHash.update(MurmurHash.update(MurmurHash.update(MurmurHash.update(hashCode, this.state.stateNumber), this.alt), this.context), this.semanticContext), 4);
    }
    ...
    public String toString(Recognizer recognizer, boolean showAlt) {
