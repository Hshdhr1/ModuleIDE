...
public class RequestHandle {
    ...
    public RequestHandle(RequestQueue requestQueue, String url, WebAddress uri, String method, Map map, InputStream bodyProvider, int bodyLength, Request request) {
        throw new RuntimeException("Stub!");
    }

    public RequestHandle(RequestQueue requestQueue, String url, WebAddress uri, String method, Map map, InputStream bodyProvider, int bodyLength, Request request, Connection conn) {
        throw new RuntimeException("Stub!");
    }
    ...
    public boolean setupRedirect(String redirectTo, int statusCode, Map map) {
        throw new RuntimeException("Stub!");
    }
