...
class UnixNativeDispatcher {
    ...
    static native int getlinelen(long j) throws UnixException;
    ...
    static native void rewind(long j) throws UnixException;
    ...
    static int stat(UnixPath unixPath) {
        NativeBuffer copyToNativeBuffer = copyToNativeBuffer(unixPath);
        try {
    ...
    static boolean exists(UnixPath unixPath) {
        NativeBuffer copyToNativeBuffer = copyToNativeBuffer(unixPath);
        try {
