...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new 1();
    final ViewPropertyAnimatorListener mShowListener = new 2();
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new 3();
    ...
    private void init(View decor) {
        ActionBarOverlayLayout findViewById = decor.findViewById(R.id.decor_content_parent);
        this.mOverlayLayout = findViewById;
        ...
        this.mContextView = decor.findViewById(R.id.action_context_bar);
        ActionBarContainer findViewById2 = decor.findViewById(R.id.action_bar_container);
        this.mContainerView = findViewById2;
        DecorToolbar decorToolbar = this.mDecorToolbar;
        if (decorToolbar == null || this.mContextView == null || findViewById2 == null) {
    ...
    public void setSelectedNavigationItem(int position) {
        switch (this.mDecorToolbar.getNavigationMode()) {
            case 1:
                ...
                return;
            case 2:
                selectTab((ActionBar.Tab) this.mTabs.get(position));
                return;
            default:
    ...
    public void removeTabAt(int position) {
        ...
        if (selectedTabPosition == position) {
            selectTab(this.mTabs.isEmpty() ? null : (ActionBar.Tab) this.mTabs.get(Math.max(0, position - 1)));
        }
    }
