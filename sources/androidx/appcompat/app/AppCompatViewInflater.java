...
public class AppCompatViewInflater {
    ...
    private View createViewByPrefix(Context context, String name, String prefix) throws ClassNotFoundException, InflateException {
        ...
        Constructor<? extends View> constructor = (Constructor) simpleArrayMap.get(name);
        if (constructor == null) {
            if (prefix != null) {
                try {
                    str = prefix + name;
            ...
            Class<? extends View> clazz = Class.forName(str, false, context.getClassLoader()).asSubclass(View.class);
