...
class AlertController {
    ...
    private final View.OnClickListener mButtonHandler = new 1();
    ...
    private void setupView() {
        ...
        if (!hasCustomPanel) {
            ...
            if (nestedScrollView2 != null) {
                ...
                setScrollIndicators(contentPanel, nestedScrollView2, indicators, 3);
            }
        }
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        ...
        if (indicatorUp != null || indicatorDown != null) {
            ...
            if (this.mMessage != null) {
                this.mScrollView.setOnScrollChangeListener(new 2(top, bottom));
                this.mScrollView.post(new 3(top, bottom));
                return;
            }
            ListView listView = this.mListView;
            if (listView != null) {
                listView.setOnScrollListener(new 4(top, bottom));
                this.mListView.post(new 5(top, bottom));
                return;
            }
            if (top != null) {
    ...
    class 2 implements NestedScrollView.OnScrollChangeListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        2(View view, View view2) {
            this.val$top = view;
    ...
    class 4 implements AbsListView.OnScrollListener {
        final /* synthetic */ View val$bottom;
        final /* synthetic */ View val$top;

        4(View view, View view2) {
            this.val$top = view;
            this.val$bottom = view2;
        }
    ...
    private void setupCustomContent(ViewGroup customPanel) {
        ...
        if (hasCustomView) {
            FrameLayout custom = this.mWindow.findViewById(R.id.custom);
            custom.addView(customView, new ViewGroup.LayoutParams(-1, -1));
            if (this.mViewSpacingSpecified) {
                custom.setPadding(this.mViewSpacingLeft, this.mViewSpacingTop, this.mViewSpacingRight, this.mViewSpacingBottom);
            }
            if (this.mListView != null) {
                customPanel.getLayoutParams().weight = 0.0f;
                return;
            }
            return;
        }
    ...
    private void setupTitle(ViewGroup topPanel) {
        ...
        this.mIconView = this.mWindow.findViewById(16908294);
        boolean hasTextTitle = !TextUtils.isEmpty(this.mTitle);
        if (hasTextTitle && this.mShowTitle) {
            TextView findViewById = this.mWindow.findViewById(R.id.alertTitle);
            this.mTitleView = findViewById;
            findViewById.setText(this.mTitle);
            int i = this.mIconId;
            if (i != 0) {
    ...
    private void setupContent(ViewGroup contentPanel) {
        NestedScrollView findViewById = this.mWindow.findViewById(R.id.scrollView);
        this.mScrollView = findViewById;
        findViewById.setFocusable(false);
        this.mScrollView.setNestedScrollingEnabled(false);
        TextView findViewById2 = contentPanel.findViewById(16908299);
        ...
        if (this.mListView != null) {
            ViewGroup scrollParent = this.mScrollView.getParent();
    ...
    private void setupButtons(ViewGroup buttonPanel) {
        int whichButtons = 0;
        Button findViewById = buttonPanel.findViewById(16908313);
        this.mButtonPositive = findViewById;
        ...
        Button findViewById2 = buttonPanel.findViewById(16908314);
        this.mButtonNegative = findViewById2;
        findViewById2.setOnClickListener(this.mButtonHandler);
        ...
        Button findViewById3 = buttonPanel.findViewById(16908315);
        this.mButtonNeutral = findViewById3;
        findViewById3.setOnClickListener(this.mButtonHandler);
    ...
    public static class AlertParams {
        ...
        private void createListView(AlertController dialog) {
            int layout;
            ListAdapter adapter;
            RecycleListView listView = this.mInflater.inflate(dialog.mListLayout, (ViewGroup) null);
            if (this.mIsMultiChoice) {
                if (this.mCursor == null) {
                    adapter = new 1(this.mContext, dialog.mMultiChoiceItemLayout, 16908308, this.mItems, listView);
                } else {
                    adapter = new 2(this.mContext, this.mCursor, false, listView, dialog);
                }
            } else {
            ...
            if (this.mOnClickListener != null) {
                listView.setOnItemClickListener(new 3(dialog));
            } else if (this.mOnCheckboxClickListener != null) {
                listView.setOnItemClickListener(new 4(listView, dialog));
            }
        ...
        class 1 extends ArrayAdapter {
            ...
            1(Context arg0, int arg1, int arg2, CharSequence[] arg3, RecycleListView recycleListView) {
        ...
        class 2 extends CursorAdapter {
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            2(Context arg0, Cursor arg1, boolean arg2, RecycleListView recycleListView, AlertController alertController) {
            ...
            public void bindView(View view, Context context, Cursor cursor) {
                CheckedTextView text = view.findViewById(16908308);
        ...
        class 3 implements AdapterView.OnItemClickListener {
            ...
            3(AlertController alertController) {
                this.val$dialog = alertController;
            }
        ...
        class 4 implements AdapterView.OnItemClickListener {
            final /* synthetic */ AlertController val$dialog;
            final /* synthetic */ RecycleListView val$listView;

            4(RecycleListView recycleListView, AlertController alertController) {
                this.val$listView = recycleListView;
                this.val$dialog = alertController;
            }
