...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    static {
        ...
        if (z && !sInstalledExceptionHandler) {
            ...
            Thread.setDefaultUncaughtExceptionHandler(new 1(defHandler));
    ...
    class 1 implements Thread.UncaughtExceptionHandler {
        ...
        1(Thread.UncaughtExceptionHandler uncaughtExceptionHandler) {
    ...
    private AppCompatDelegateImpl(Context context, Window window, AppCompatCallback callback, Object host) {
        ...
        this.mInvalidatePanelMenuRunnable = new 2();
        ...
        if (this.mLocalNightMode == -100) {
            ...
            Integer value = (Integer) simpleArrayMap.get(host.getClass().getName());
            if (value != null) {
    ...
    public void setContentView(View v) {
        ensureSubDecor();
        ViewGroup contentParent = this.mSubDecor.findViewById(16908290);
    ...
    */
    ...
    private ViewGroup createSubDecor() {
        ...
        if (!this.mWindowNoTitle) {
            if (this.mIsFloating) {
                ...
                if (outValue.resourceId != 0) {
                    contextThemeWrapper = new androidx.appcompat.view.ContextThemeWrapper(this.mContext, outValue.resourceId);
                } else {
                    contextThemeWrapper = this.mContext;
                }
                ViewGroup subDecor2 = LayoutInflater.from(contextThemeWrapper).inflate(R.layout.abc_screen_toolbar, (ViewGroup) null);
                subDecor = subDecor2;
                DecorContentParent findViewById = subDecor.findViewById(R.id.decor_content_parent);
            ...
            ViewGroup subDecor3 = inflater.inflate(R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null);
            subDecor = subDecor3;
        } else {
            ViewGroup subDecor4 = inflater.inflate(R.layout.abc_screen_simple, (ViewGroup) null);
            subDecor = subDecor4;
        }
        if (subDecor == null) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ViewCompat.setOnApplyWindowInsetsListener(subDecor, new 3());
        } else if (subDecor instanceof FitWindowsViewGroup) {
            ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new 4());
        }
        if (this.mDecorContentParent == null) {
            this.mTitleView = subDecor.findViewById(R.id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(subDecor);
        ContentFrameLayout contentView = subDecor.findViewById(R.id.action_bar_activity_content);
        FrameLayout frameLayout = (ViewGroup) this.mWindow.findViewById(16908290);
        if (frameLayout != null) {
        ...
        contentView.setAttachListener(new 5());
        return subDecor;
    }
    ...
    class 4 implements FitWindowsViewGroup.OnFitSystemWindowsListener {
        4() {
        }
    ...
    class 5 implements ContentFrameLayout.OnAttachListener {
        5() {
        }
    ...
    private void applyFixedSizeWindow() {
        ContentFrameLayout cfl = this.mSubDecor.findViewById(16908290);
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    contextThemeWrapper.getTheme().resolveAttribute(R.attr.actionBarSize, outValue, true);
                    int height = TypedValue.complexToDimensionPixelSize(outValue.data, contextThemeWrapper.getResources().getDisplayMetrics());
                    this.mActionModeView.setContentHeight(height);
                    this.mActionModePopup.setHeight(-2);
                    this.mShowActionModePopup = new 6();
                } else {
    ...
    class 6 implements Runnable {
        ...
        public void run() {
            ...
            if (AppCompatDelegateImpl.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImpl.this.mFadeAnim.setListener(new 1());
                return;
            }
    ...
    */
    ...
    private void openPanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.decorView == null || st.refreshDecorView) {
            ...
            ViewGroup parent = st.shownPanelView.getParent();
            if (parent instanceof ViewGroup) {
                parent.removeView(st.shownPanelView);
            }
    ...
    private boolean initializePanelContent(PanelFeatureState st) {
        ...
        st.shownPanelView = st.getListMenuView(this.mPanelMenuPresenterCallback);
    ...
    */
    ...
    private void updateResourcesConfigurationForNightMode(int uiModeNightModeValue, boolean callOnConfigChange, Configuration configOverlay) {
        ...
        if (callOnConfigChange) {
            Object obj = this.mHost;
            if (obj instanceof Activity) {
                LifecycleOwner lifecycleOwner = (Activity) obj;
                if (lifecycleOwner instanceof LifecycleOwner) {
                    Lifecycle lifecycle = lifecycleOwner.getLifecycle();
                    if (lifecycle.getCurrentState().isAtLeast(Lifecycle.State.CREATED)) {
                        lifecycleOwner.onConfigurationChanged(conf);
                        return;
                    }
                    return;
                }
    ...
    protected static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            TypedArray a = contextThemeWrapper.obtainStyledAttributes(R.styleable.AppCompatTheme);
    ...
    class AppCompatWindowCallback extends WindowCallbackWrapper {
        ...
        public void onProvideKeyboardShortcuts(List list, Menu menu, int deviceId) {
            ...
            if (panel != null && panel.menu != null) {
                super.onProvideKeyboardShortcuts(list, panel.menu, deviceId);
            } else {
