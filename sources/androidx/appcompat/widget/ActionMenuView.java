...
public class ActionMenuView extends LinearLayoutCompat implements MenuBuilder.ItemInvoker, MenuView {
    ...
    */
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (isLayoutRtl) {
            ...
            while (i4 < childCount) {
                ...
                LayoutParams lp = v3.getLayoutParams();
        ...
        while (i5 < childCount) {
            ...
            LayoutParams lp2 = v4.getLayoutParams();
    ...
    protected boolean hasSupportDividerBeforeChildAt(int childIndex) {
        ...
        ActionMenuChildView childAt = getChildAt(childIndex - 1);
        ActionMenuChildView childAt2 = getChildAt(childIndex);
        boolean result = false;
        if (childIndex < getChildCount() && (childAt instanceof ActionMenuChildView)) {
            result = false | childAt.needsDividerAfter();
        }
        if (childIndex > 0 && (childAt2 instanceof ActionMenuChildView)) {
            return result | childAt2.needsDividerBefore();
        }
        return result;
    }
