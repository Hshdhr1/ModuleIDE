...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    class 2 implements ViewTreeObserver.OnGlobalLayoutListener {
        2() {
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetObserver = new 1();
        this.mOnGlobalLayoutListener = new 2();
        ...
        FrameLayout findViewById2 = findViewById(R.id.default_activity_button);
        this.mDefaultActivityButton = findViewById2;
        findViewById2.setOnClickListener(callbacks);
        findViewById2.setOnLongClickListener(callbacks);
        this.mDefaultActivityButtonImage = findViewById2.findViewById(R.id.image);
        FrameLayout expandButton = findViewById(R.id.expand_activities_button);
        expandButton.setOnClickListener(callbacks);
        expandButton.setAccessibilityDelegate(new 3());
        expandButton.setOnTouchListener(new 4(expandButton));
        this.mExpandActivityOverflowButton = expandButton;
        ImageView findViewById3 = expandButton.findViewById(R.id.image);
        this.mExpandActivityOverflowButtonImage = findViewById3;
        findViewById3.setImageDrawable(expandActivityOverflowButtonDrawable);
        ActivityChooserViewAdapter activityChooserViewAdapter = new ActivityChooserViewAdapter();
        this.mAdapter = activityChooserViewAdapter;
        activityChooserViewAdapter.registerDataSetObserver(new 5());
    ...
    class 3 extends View.AccessibilityDelegate {
        3() {
        }
    ...
    class 4 extends ForwardingListener {
        4(View src) {
            super(src);
        }
    ...
    class 5 extends DataSetObserver {
        5() {
        }
    ...
    void updateAppearance() {
        ...
        if (activityCount == 1 || (activityCount > 1 && historySize > 0)) {
            ...
            if (this.mDefaultActionButtonContentDescription != 0) {
                ...
                String contentDescription = getContext().getString(this.mDefaultActionButtonContentDescription, new Object[]{label});
    ...
    private class Callbacks implements AdapterView.OnItemClickListener, View.OnClickListener, View.OnLongClickListener, PopupWindow.OnDismissListener {
        ...
        public void onItemClick(AdapterView adapterView, View view, int position, long id) {
            ActivityChooserViewAdapter adapter = adapterView.getAdapter();
            ...
            switch (itemViewType) {
                ...
                case 1:
                    if (convertView == null || convertView.getId() != 1) {
                        ...
                        TextView titleView2 = convertView2.findViewById(R.id.title);
