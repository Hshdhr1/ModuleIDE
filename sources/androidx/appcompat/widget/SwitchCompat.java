...
public class SwitchCompat extends CompoundButton implements EmojiCompatConfigurationView {
    ...
    private static final Property THUMB_POS = new 1(Float.class, "thumbPos");
    ...
    private void animateThumbToCheckedState(boolean newCheckedState) {
        ...
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this, THUMB_POS, new float[]{targetPosition});
    ...
    private void setOnStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (str == null) {
                str = getResources().getString(R.string.abc_capital_on);
            }
            ViewCompat.setStateDescription(this, str);
        }
    }
    ...
    private void setOffStateDescriptionOnRAndAbove() {
        if (Build.VERSION.SDK_INT >= 30) {
            ...
            if (str == null) {
                str = getResources().getString(R.string.abc_capital_off);
            }
            ViewCompat.setStateDescription(this, str);
        }
    }
    ...
    static class EmojiCompatInitCallback extends EmojiCompat.InitCallback {
        ...
        public void onInitialized() {
            SwitchCompat view = (SwitchCompat) this.mOuterWeakRef.get();
            if (view != null) {
