...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public SuggestionsAdapter(Context context, SearchView searchView, SearchableInfo searchable, WeakHashMap weakHashMap) {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        ImageView iconRefine = v.findViewById(R.id.edit_query);
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            this.mText1 = v.findViewById(16908308);
            this.mText2 = v.findViewById(16908309);
            this.mIcon1 = v.findViewById(16908295);
            this.mIcon2 = v.findViewById(16908296);
            this.mIconRefine = v.findViewById(R.id.edit_query);
        }
    }
    ...
    private Drawable checkIconCache(String resourceUri) {
        Drawable.ConstantState cached = (Drawable.ConstantState) this.mOutsideDrawablesCache.get(resourceUri);
        if (cached == null) {
            return null;
        }
    ...
    private Drawable getActivityIconWithCache(ComponentName component) {
        ...
        if (this.mOutsideDrawablesCache.containsKey(componentIconKey)) {
            Drawable.ConstantState cached = (Drawable.ConstantState) this.mOutsideDrawablesCache.get(componentIconKey);
            if (cached == null) {
                return null;
            }
