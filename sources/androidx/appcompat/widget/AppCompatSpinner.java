...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    public AppCompatSpinner(Context context, AttributeSet attrs, int defStyleAttr, int mode, Resources.Theme popupTheme) {
        ...
        switch (mode) {
            ...
            case 1:
                ...
                pa.recycle();
                this.mPopup = popup;
                this.mForwardingListener = new 1(this, popup);
                break;
        }
    ...
    class 1 extends ForwardingListener {
        ...
        1(View src, DropdownPopup dropdownPopup) {
            super(src);
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        if (ss.mShowDropdown && (vto = getViewTreeObserver()) != null) {
            ViewTreeObserver.OnGlobalLayoutListener listener = new 2();
    ...
    class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        static /* synthetic */ void access$001(DropdownPopup x0) {
            super.show();
        }
        ...
        public void show(int textDirection, int textAlignment) {
            ...
            if (!wasShowing && (vto = AppCompatSpinner.this.getViewTreeObserver()) != null) {
                ViewTreeObserver.OnGlobalLayoutListener layoutListener = new 2();
                vto.addOnGlobalLayoutListener(layoutListener);
                setOnDismissListener(new 3(layoutListener));
            }
        }
        ...
        class 3 implements PopupWindow.OnDismissListener {
            final /* synthetic */ ViewTreeObserver.OnGlobalLayoutListener val$layoutListener;

            3(ViewTreeObserver.OnGlobalLayoutListener onGlobalLayoutListener) {
