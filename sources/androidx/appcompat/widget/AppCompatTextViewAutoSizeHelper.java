...
class AppCompatTextViewAutoSizeHelper {
    ...
    private int[] cleanupAutoSizePresetSizes(int[] presetValues) {
        ...
        for (int currentPresetValue : presetValues) {
            if (currentPresetValue > 0 && Collections.binarySearch(arrayList, Integer.valueOf(currentPresetValue)) < 0) {
                arrayList.add(Integer.valueOf(currentPresetValue));
            }
        }
        ...
        int uniqueValidSizesLength = arrayList.size();
        int[] cleanedUpSizes = new int[uniqueValidSizesLength];
        for (int i2 = 0; i2 < uniqueValidSizesLength; i2++) {
            cleanedUpSizes[i2] = ((Integer) arrayList.get(i2)).intValue();
        }
    ...
    static Object invokeAndReturnWithDefault(Object object, String methodName, Object obj) {
        Object obj2 = null;
    ...
    private static Object accessAndReturnWithDefault(Object object, String fieldName, Object obj) {
        try {
