...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean style, int defaultNavigationContentDescription, int defaultNavigationIcon) {
        ...
        this.mToolbar.setNavigationOnClickListener(new 1());
    }
    ...
    public void setEmbeddedTabView(ScrollingTabContainerView tabView) {
        ...
        if (tabView != null && this.mNavigationMode == 2) {
            ...
            Toolbar.LayoutParams lp = this.mTabView.getLayoutParams();
            lp.width = -2;
            lp.height = -2;
            lp.gravity = 8388691;
        ...
        if (mode != oldMode) {
            switch (oldMode) {
                case 1:
                    ...
                    if (spinner != null) {
                        Toolbar parent = spinner.getParent();
                        Toolbar toolbar = this.mToolbar;
                        if (parent == toolbar) {
                ...
                case 2:
                    View view = this.mTabView;
                    if (view != null) {
                        Toolbar parent2 = view.getParent();
                        Toolbar toolbar2 = this.mToolbar;
                        if (parent2 == toolbar2) {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int visibility, long duration) {
        return ViewCompat.animate(this.mToolbar).alpha(visibility == 0 ? 1.0f : 0.0f).setDuration(duration).setListener(new 2(visibility));
    }
