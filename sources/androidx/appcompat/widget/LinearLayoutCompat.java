...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public final class InspectionCompanion implements android.view.inspector.InspectionCompanion {
        ...
        public void mapProperties(PropertyMapper propertyMapper) {
            ...
            this.mOrientationId = propertyMapper.mapIntEnum("orientation", 16842948, new 1());
            ...
            this.mShowDividersId = propertyMapper.mapIntFlag("showDividers", R.attr.showDividers, new 2());
            this.mPropertiesMapped = true;
        }

        /* compiled from: LinearLayoutCompat$InspectionCompanion.java */
        class 1 implements IntFunction {
            1() {
            }
        ...
        /* compiled from: LinearLayoutCompat$InspectionCompanion.java */
        class 2 implements IntFunction {
            2() {
            }

            public Set apply(int value) {
