...
public class ActionBarContextView extends AbsActionBarView {
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            this.mTitleLayout = childAt;
            this.mTitleView = childAt.findViewById(R.id.action_bar_title);
            this.mSubtitleView = this.mTitleLayout.findViewById(R.id.action_bar_subtitle);
    ...
    public void initForMode(ActionMode mode) {
        ...
        if (view == null) {
            LayoutInflater inflater = LayoutInflater.from(getContext());
            View inflate = inflater.inflate(this.mCloseItemLayout, this, false);
            this.mClose = inflate;
            addView(inflate);
        ...
        findViewById.setOnClickListener(new 1(mode));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (view != null) {
            ...
            ViewGroup.MarginLayoutParams lp = this.mClose.getLayoutParams();
