...
class ActivityChooserModel extends DataSetObservable {
    ...
    public static ActivityChooserModel get(Context context, String historyFileName) {
        ...
        synchronized (sRegistryLock) {
            ...
            dataModel = (ActivityChooserModel) map.get(historyFileName);
            if (dataModel == null) {
    ...
    public int getActivityIndex(ResolveInfo activity) {
        synchronized (this.mInstanceLock) {
            ...
            for (int i = 0; i < activityCount; i++) {
                ActivityResolveInfo currentActivity = (ActivityResolveInfo) activities.get(i);
    ...
    private static final class DefaultSorter implements ActivitySorter {
        ...
        public void sort(Intent intent, List list, List list2) {
            ...
            for (int i = 0; i < activityCount; i++) {
                ActivityResolveInfo activity = (ActivityResolveInfo) list.get(i);
            ...
            for (int i3 = lastShareIndex; i3 >= 0; i3--) {
                HistoricalRecord historicalRecord = (HistoricalRecord) list2.get(i3);
                ComponentName componentName2 = historicalRecord.activity;
                ActivityResolveInfo activity2 = (ActivityResolveInfo) componentNameToActivityMap.get(componentName2);
                if (activity2 != null) {
