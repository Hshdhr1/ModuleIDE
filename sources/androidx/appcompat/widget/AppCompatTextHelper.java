...
class AppCompatTextHelper {
    ...
    void loadFromAttributes(AttributeSet attrs, int defStyleAttr) {
        ...
        if (a4.hasValue(R.styleable.AppCompatTextView_drawableTintMode)) {
            PorterDuff.Mode tintMode = DrawableUtils.parseTintMode(a4.getInt(R.styleable.AppCompatTextView_drawableTintMode, -1), (PorterDuff.Mode) null);
    ...
    private void updateTypefaceAndStyle(Context context, TintTypedArray a) {
        ...
        if (a.hasValue(R.styleable.TextAppearance_android_fontFamily) || a.hasValue(R.styleable.TextAppearance_fontFamily)) {
            ...
            if (!context.isRestricted()) {
                WeakReference<TextView> textViewWeak = new WeakReference<>(this.mView);
                ResourcesCompat.FontCallback replyCallback = new 1(fontWeight, style, textViewWeak);
                try {
    ...
    class 1 extends ResourcesCompat.FontCallback {
        ...
        1(int i, int i2, WeakReference weakReference) {
        ...
        if (this.mAsyncFontPending) {
            ...
            if (textView != null) {
                if (ViewCompat.isAttachedToWindow(textView)) {
                    int style = this.mStyle;
                    textView.post(new 2(textView, typeface, style));
                } else {
    ...
    class 2 implements Runnable {
        ...
        2(TextView textView, Typeface typeface, int i) {
