...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    class 1 implements ActionMenuView.OnMenuItemClickListener {
        1() {
        }
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new 1();
        this.mShowOverflowMenuRunnable = new 2();
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            this.mCollapseButtonView.setOnClickListener(new 3());
        }
    }
    ...
    private void measureChildConstrained(View child, int parentWidthSpec, int widthUsed, int parentHeightSpec, int heightUsed, int heightConstraint) {
        int size;
        ViewGroup.MarginLayoutParams lp = child.getLayoutParams();
    ...
    */
    ...
    private int getViewListMeasuredWidth(List list, int[] collapsingMargins) {
    ...
    private void addCustomViewsWithGravity(List list, int gravity) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            LayoutParams lp2 = child2.getLayoutParams();
    ...
    private int getHorizontalMargins(View v) {
        ViewGroup.MarginLayoutParams mlp = v.getLayoutParams();
    ...
    void removeChildrenForExpandedActionView() {
        ...
        for (int i = childCount - 1; i >= 0; i--) {
            ...
            if (lp.mViewType != 2 && childAt != this.mMenuView) {
                removeViewAt(i);
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menu, MenuItemImpl item) {
            ...
            Toolbar parent = Toolbar.this.mCollapseButtonView.getParent();
            Toolbar toolbar = Toolbar.this;
            if (parent != toolbar) {
                if (parent instanceof ViewGroup) {
                    parent.removeView(toolbar.mCollapseButtonView);
                }
            ...
            Toolbar parent2 = Toolbar.this.mExpandedActionView.getParent();
            Toolbar toolbar3 = Toolbar.this;
            if (parent2 != toolbar3) {
                if (parent2 instanceof ViewGroup) {
                    parent2.removeView(toolbar3.mExpandedActionView);
                }
