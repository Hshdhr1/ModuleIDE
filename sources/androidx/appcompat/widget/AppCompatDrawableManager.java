    ...
    public static synchronized void preload() {
        synchronized (AppCompatDrawableManager.class) {
            if (INSTANCE == null) {
                ...
                INSTANCE.mResourceManager.setHooks(new 1());
            }
        }
    }

    class 1 implements ResourceManagerInternal.ResourceManagerHooks {
        ...
        private LayerDrawable getRatingBarLayerDrawable(ResourceManagerInternal resourceManager, Context context, int dimenResId) {
            ...
            BitmapDrawable drawable = resourceManager.getDrawable(context, R.drawable.abc_star_black_48dp);
            BitmapDrawable drawable2 = resourceManager.getDrawable(context, R.drawable.abc_star_half_black_48dp);
            if ((drawable instanceof BitmapDrawable) && drawable.getIntrinsicWidth() == starSize && drawable.getIntrinsicHeight() == starSize) {
                starBitmapDrawable = drawable;
            ...
            if ((drawable2 instanceof BitmapDrawable) && drawable2.getIntrinsicWidth() == starSize && drawable2.getIntrinsicHeight() == starSize) {
                halfStarBitmapDrawable = drawable2;
            } else {
                ...
                drawable2.setBounds(0, 0, starSize, starSize);
                drawable2.draw(canvasHalfStar);
        ...
        private void setPorterDuffColorFilter(Drawable d, int color, PorterDuff.Mode mode) {
            ...
            d.setColorFilter(AppCompatDrawableManager.getPorterDuffColorFilter(color, mode == null ? AppCompatDrawableManager.access$000() : mode));
        }
        ...
        public boolean tintDrawable(Context context, int resId, Drawable drawable) {
            if (resId == R.drawable.abc_seekbar_track_material) {
                ...
                setPorterDuffColorFilter(ld.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, R.attr.colorControlNormal), AppCompatDrawableManager.access$000());
                setPorterDuffColorFilter(ld.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, R.attr.colorControlNormal), AppCompatDrawableManager.access$000());
                setPorterDuffColorFilter(ld.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, R.attr.colorControlActivated), AppCompatDrawableManager.access$000());
                return true;
            }
            if (resId == R.drawable.abc_ratingbar_material || resId == R.drawable.abc_ratingbar_indicator_material || resId == R.drawable.abc_ratingbar_small_material) {
                ...
                setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, R.attr.colorControlNormal), AppCompatDrawableManager.access$000());
                setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, R.attr.colorControlActivated), AppCompatDrawableManager.access$000());
                setPorterDuffColorFilter(ld2.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, R.attr.colorControlActivated), AppCompatDrawableManager.access$000());
                return true;
            }
            return false;
        }
        ...
        public boolean tintDrawableUsingColorFilter(Context context, int resId, Drawable drawable) {
            PorterDuff.Mode tintMode = AppCompatDrawableManager.access$000();
