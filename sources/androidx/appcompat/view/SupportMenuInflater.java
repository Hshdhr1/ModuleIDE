...
public class SupportMenuInflater extends MenuInflater {
    ...
    public void inflate(int menuRes, Menu menu) {
        ...
        try {
            try {
                xmlPullParser = this.mContext.getResources().getLayout(menuRes);
                AttributeSet attrs = Xml.asAttributeSet(xmlPullParser);
                parseMenu(xmlPullParser, attrs, menu);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x005d, code lost:
        ...
        if (r8.equals("group") == false) goto L25;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x0096, code lost:
        ...
        if (r8.equals("group") == false) goto L43;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:50:0x00aa, code lost:
        ...
        if (r8.equals("menu") == false) goto L49;
     */
    ...
    */
    ...
    private class MenuState {
        ...
        private Object newInstance(String className, Class[] clsArr, Object[] arguments) {
            try {
