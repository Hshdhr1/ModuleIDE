...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    protected void onFinishInflate() {
        ...
        TextView findViewById = findViewById(R.id.title);
        this.mTitleView = findViewById;
        int i = this.mTextAppearance;
        if (i != -1) {
            findViewById.setTextAppearance(this.mTextAppearanceContext, i);
        }
        this.mShortcutView = findViewById(R.id.shortcut);
        ImageView findViewById2 = findViewById(R.id.submenuarrow);
        this.mSubMenuArrowView = findViewById2;
        if (findViewById2 != null) {
            findViewById2.setImageDrawable(this.mSubMenuArrow);
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (this.mIconView != null && this.mPreserveIconSpacing) {
            ...
            LinearLayout.LayoutParams iconLp = this.mIconView.getLayoutParams();
    ...
    private void insertIconView() {
        ...
        ImageView inflate = inflater.inflate(R.layout.abc_list_menu_item_icon, this, false);
        this.mIconView = inflate;
        addContentView(inflate, 0);
    }

    private void insertRadioButton() {
        LayoutInflater inflater = getInflater();
        RadioButton inflate = inflater.inflate(R.layout.abc_list_menu_item_radio, this, false);
        this.mRadioButton = inflate;
        addContentView(inflate);
    }

    private void insertCheckBox() {
        LayoutInflater inflater = getInflater();
        CheckBox inflate = inflater.inflate(R.layout.abc_list_menu_item_checkbox, this, false);
        this.mCheckBox = inflate;
        addContentView(inflate);
    }
    ...
    public void adjustListItemSelectionBounds(Rect rect) {
        ...
        if (imageView != null && imageView.getVisibility() == 0) {
            LinearLayout.LayoutParams lp = this.mGroupDivider.getLayoutParams();
