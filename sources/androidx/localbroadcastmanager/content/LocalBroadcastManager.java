...
/* loaded from: /storage/emulated/0/Android/data/com.apktools.app.decompile/files/decompile_temp/jadx/classes47.dex */
public final class LocalBroadcastManager {
    ...
    private static final class BroadcastRecord {
        ...
        BroadcastRecord(Intent _intent, ArrayList arrayList) {
            this.intent = _intent;
    ...
    private LocalBroadcastManager(Context context) {
        ...
        this.mHandler = new 1(context.getMainLooper());
    }
            ...
            if (entries != null) {
                ...
                if (receivers3 != null) {
                    for (int i3 = 0; i3 < receivers3.size(); i3++) {
                        ((ReceiverRecord) receivers3.get(i3)).broadcasting = false;
                    }
    ...
    /*  JADX ERROR: IIiLliI1l1li1 in pass: RegionMakerVisitor
        l1LI1IIIL1lLl.IIiLliI1l1li1: Can't find top splitter block for handler:B:29:0x0049
        	at LillLiIILLi.LLll11I1I1lL.llLliLLIll1lI(Unknown Source:36)
    ...
    void executePendingBroadcasts() {
        /*
            ...
            r0 = 0
        L1:
            java.util.HashMap r1 = r9.mReceivers
            monitor-enter(r1)
            java.util.ArrayList r2 = r9.mPendingBroadcasts     // Catch: java.lang.Throwable -> L46
        ...
        Le:
            ...
            java.util.ArrayList r3 = r9.mPendingBroadcasts     // Catch: java.lang.Throwable -> L49
        ...
        L1c:
            ...
            if (r1 >= r2) goto L45
            r2 = r0[r1]
            java.util.ArrayList r3 = r2.receivers
            int r3 = r3.size()
            r4 = 0
        L28:
            if (r4 >= r3) goto L42
            java.util.ArrayList r5 = r2.receivers
