...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (peopleList = notification.extras.getParcelableArrayList("android.people.list")) != null && !peopleList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    android.app.Person person2 = (android.app.Person) it.next();
    ...
    public static abstract class Style {
        ...
        static Style constructCompatStyleForBundle(Bundle extras) {
            Style style = constructCompatStyleByName(extras.getString("androidx.core.app.extra.COMPAT_TEMPLATE"));
            if (style != null) {
                return style;
            }
            if (extras.containsKey("android.selfDisplayName") || extras.containsKey("android.messagingStyleUser")) {
                return new MessagingStyle();
            }
            ...
            return constructCompatStyleByPlatformName(extras.getString("android.template"));
        }
    ...
    public static class BigPictureStyle extends Style {
        ...
        protected void restoreFromCompatExtras(Bundle extras) {
            ...
            if (extras.containsKey("android.largeIcon.big")) {
                this.mBigLargeIcon = asIconCompat(extras.getParcelable("android.largeIcon.big"));
                this.mBigLargeIconSet = true;
            }
            this.mPicture = extras.getParcelable("android.picture");
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor builder) {
            ...
            if (Build.VERSION.SDK_INT >= 24) {
                ...
                while (it.hasNext()) {
                    frameworkStyle.addMessage(((Message) it.next()).toAndroidMessage());
                }
        ...
        protected void restoreFromCompatExtras(Bundle extras) {
            ...
            if (extras.containsKey("android.messagingStyleUser")) {
                this.mUser = Person.fromBundle(extras.getBundle("android.messagingStyleUser"));
            } else {
            ...
            if (extras.containsKey("android.isGroupConversation")) {
                this.mIsGroupConversation = Boolean.valueOf(extras.getBoolean("android.isGroupConversation"));
            }
        }
        ...
        public static final class Message {
            ...
            static Bundle[] getBundleArrayForMessages(List list) {
                ...
                int N = list.size();
                for (int i = 0; i < N; i++) {
                    bundles[i] = ((Message) list.get(i)).toBundle();
                }
                return bundles;
            }
                ...
                try {
                    if (bundle.containsKey("text") && bundle.containsKey("time")) {
                        ...
                        if (bundle.containsKey("person")) {
                            ...
                            person = Person.fromAndroidPerson(bundle.getParcelable("sender_person"));
    ...
    public static class InboxStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor builder) {
            if (Build.VERSION.SDK_INT >= 16) {
                ...
                while (it.hasNext()) {
                    CharSequence text = (CharSequence) it.next();
                    style.addLine(text);
                }
            }
        }
        ...
        private RemoteViews createRemoteViews(RemoteViews innerView, boolean showActions) {
            ...
            if (showActions && nonContextualActions != null && (numActions = Math.min(nonContextualActions.size(), 3)) > 0) {
                ...
                for (int i = 0; i < numActions; i++) {
                    RemoteViews button = generateActionButton((Action) nonContextualActions.get(i));
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public Action build() {
                ...
                RemoteInput[] dataOnlyInputsArr = arrayList.isEmpty() ? null : (RemoteInput[]) arrayList.toArray(new RemoteInput[arrayList.size()]);
                RemoteInput[] textInputsArr = arrayList2.isEmpty() ? null : (RemoteInput[]) arrayList2.toArray(new RemoteInput[arrayList2.size()]);
    ...
    public static final class WearableExtender implements Extender {
        ...
        public WearableExtender(Notification notification) {
            ...
            if (wearableBundle != null) {
                ...
                this.mFlags = wearableBundle.getInt("flags", 1);
                this.mDisplayIntent = wearableBundle.getParcelable("displayIntent");
                ...
                this.mBackground = wearableBundle.getParcelable("background");
        ...
        public Builder extend(Builder builder) {
            ...
            if (!this.mActions.isEmpty()) {
                if (Build.VERSION.SDK_INT >= 16) {
                    ...
                    wearableBundle.putParcelableArrayList("actions", (ArrayList) null);
                }
            }
            int i = this.mFlags;
            if (i != 1) {
            ...
            if (!this.mPages.isEmpty()) {
                ...
                wearableBundle.putParcelableArray("pages", (Parcelable[]) arrayList.toArray(new Notification[arrayList.size()]));
            }
    ...
    public static final class CarExtender implements Extender {
        ...
        public CarExtender(Notification notification) {
            ...
            if (carBundle != null) {
                this.mLargeIcon = carBundle.getParcelable("large_icon");
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle b) {
            ...
            Bundle[] parcelableArray = b.getParcelableArray("messages");
            String[] messages = null;
            if (parcelableArray != null) {
                String[] tmp = new String[parcelableArray.length];
                ...
                while (true) {
                    ...
                    tmp[i] = parcelableArray[i].getString("text");
                    if (tmp[i] != null) {
                        i++;
                    } else {
                        success = false;
            ...
            PendingIntent onRead = b.getParcelable("on_read");
            PendingIntent onReply = b.getParcelable("on_reply");
            android.app.RemoteInput remoteInput = b.getParcelable("remote_input");
    ...
    public static final class BubbleMetadata {
        ...
        /* synthetic */ BubbleMetadata(PendingIntent x0, PendingIntent x1, IconCompat x2, int x3, int x4, int x5, String x6, 1 x7) {
        ...
        public static final class Builder {
            ...
            public BubbleMetadata build() {
                ...
                BubbleMetadata data = new BubbleMetadata(this.mPendingIntent, this.mDeleteIntent, this.mIcon, this.mDesiredHeight, this.mDesiredHeightResId, this.mFlags, str, null);
    ...
    static Notification[] getNotificationArrayFromBundle(Bundle bundle, String key) {
        Notification[] parcelableArray = bundle.getParcelableArray(key);
        if ((parcelableArray instanceof Notification[]) || parcelableArray == null) {
            return parcelableArray;
        }
        Notification[] typedArray = new Notification[parcelableArray.length];
        for (int i = 0; i < parcelableArray.length; i++) {
            typedArray[i] = parcelableArray[i];
        }
    ...
    public static List getPeople(Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ArrayList<android.app.Person> peopleList = notification.extras.getParcelableArrayList("android.people.list");
        ...
        } else if (Build.VERSION.SDK_INT >= 19 && (peopleArray = notification.extras.getStringArray("android.people")) != null && peopleArray.length != 0) {
