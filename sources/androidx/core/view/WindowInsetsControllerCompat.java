...
public final class WindowInsetsControllerCompat {
    ...
    private static class Impl20 extends Impl {
            ...
            switch (type) {
                ...
                case 8:
                    ...
                    if (view != null && view.hasWindowFocus()) {
                        View finalView = view;
                        finalView.post(new 1(finalView));
                        break;
                    }
                    break;
            }
        ...
        class 1 implements Runnable {
            ...
            public void run() {
                InputMethodManager imm = (InputMethodManager) this.val$finalView.getContext().getSystemService("input_method");
                imm.showSoftInput(this.val$finalView, 0);
            }
        }
    ...
    private static class Impl30 extends Impl {
        ...
        class 1 implements WindowInsetsAnimationControlListener {
            ...
            1(WindowInsetsAnimationControlListenerCompat windowInsetsAnimationControlListenerCompat) {
        ...
        void controlWindowInsetsAnimation(int types, long durationMillis, Interpolator interpolator, CancellationSignal cancellationSignal, WindowInsetsAnimationControlListenerCompat listener) {
            WindowInsetsAnimationControlListener fwListener = new 1(listener);
        ...
        void addOnControllableInsetsChangedListener(OnControllableInsetsChangedListener listener) {
            ...
            WindowInsetsController.OnControllableInsetsChangedListener fwListener = new 2(listener);
        ...
        class 2 implements WindowInsetsController.OnControllableInsetsChangedListener {
            ...
            2(OnControllableInsetsChangedListener onControllableInsetsChangedListener) {
        ...
        void removeOnControllableInsetsChangedListener(OnControllableInsetsChangedListener listener) {
            WindowInsetsController.OnControllableInsetsChangedListener fwListener = (WindowInsetsController.OnControllableInsetsChangedListener) this.mListeners.remove(listener);
            if (fwListener != null) {
