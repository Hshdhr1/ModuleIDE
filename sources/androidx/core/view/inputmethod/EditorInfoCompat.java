...
public final class EditorInfoCompat {
    ...
    public static String[] getContentMimeTypes(EditorInfo editorInfo) {
        ...
        String[] result2 = editorInfo.extras.getStringArray("androidx.core.view.inputmethod.EditorInfoCompat.CONTENT_MIME_TYPES");
        if (result2 == null) {
    ...
    private static void trimLongSurroundingText(EditorInfo editorInfo, CharSequence subText, int selStart, int selEnd) {
        ...
        if (newSelLength != sourceSelLength) {
            ...
            newInitialSurroundingText = TextUtils.concat(new CharSequence[]{beforeCursor, afterCursor});
        } else {
    ...
    public static CharSequence getInitialTextBeforeCursor(EditorInfo editorInfo, int length, int flags) {
        ...
        if (editorInfo.extras == null || (surroundingText = editorInfo.extras.getCharSequence("androidx.core.view.inputmethod.EditorInfoCompat.CONTENT_SURROUNDING_TEXT")) == null) {
            return null;
        }
        int selectionHead = editorInfo.extras.getInt("androidx.core.view.inputmethod.EditorInfoCompat.CONTENT_SELECTION_HEAD");
    ...
    public static CharSequence getInitialSelectedText(EditorInfo editorInfo, int flags) {
        ...
        int selectionHead = editorInfo.extras.getInt("androidx.core.view.inputmethod.EditorInfoCompat.CONTENT_SELECTION_HEAD");
        int selectionEnd = editorInfo.extras.getInt("androidx.core.view.inputmethod.EditorInfoCompat.CONTENT_SELECTION_END");
        int sourceSelLength = correctedTextSelEnd - correctedTextSelStart;
        if (editorInfo.initialSelStart < 0 || editorInfo.initialSelEnd < 0 || selectionEnd - selectionHead != sourceSelLength || (surroundingText = editorInfo.extras.getCharSequence("androidx.core.view.inputmethod.EditorInfoCompat.CONTENT_SURROUNDING_TEXT")) == null) {
            return null;
        }
        if ((flags & 1) != 0) {
    ...
    static int getProtocol(EditorInfo editorInfo) {
        ...
        boolean hasNewKey = editorInfo.extras.containsKey("androidx.core.view.inputmethod.EditorInfoCompat.CONTENT_MIME_TYPES");
        boolean hasOldKey = editorInfo.extras.containsKey("android.support.v13.view.inputmethod.EditorInfoCompat.CONTENT_MIME_TYPES");
