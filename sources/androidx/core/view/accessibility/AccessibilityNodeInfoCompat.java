...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        private AccessibilityActionCompat(int actionId, CharSequence label, Class cls) {
            this(null, actionId, label, null, cls);
        }

        AccessibilityActionCompat(Object action, int id, CharSequence label, AccessibilityViewCommand command, Class cls) {
            this.mId = id;
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public TouchDelegateInfoCompat(Map map) {
    ...
    private List extrasIntList(String key) {
        if (Build.VERSION.SDK_INT < 19) {
    ...
    public List findAccessibilityNodeInfosByText(String text) {
        ...
        for (int i = 0; i < infoCount; i++) {
            AccessibilityNodeInfo info = (AccessibilityNodeInfo) infos.get(i);
            arrayList.add(wrap(info));
        }
        return arrayList;
    }
    ...
    public CharSequence getText() {
        if (hasSpans()) {
            List<Integer> starts = extrasIntList("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_START_KEY");
            List<Integer> ends = extrasIntList("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_END_KEY");
            List<Integer> flags = extrasIntList("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_FLAGS_KEY");
            List<Integer> ids = extrasIntList("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ID_KEY");
            SpannableString spannableString = new SpannableString(TextUtils.substring(this.mInfo.getText(), 0, this.mInfo.getText().length()));
            for (int i = 0; i < starts.size(); i++) {
                spannableString.setSpan(new AccessibilityClickableSpanCompat(((Integer) ids.get(i)).intValue(), this, getExtras().getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.SPANS_ACTION_ID_KEY")), ((Integer) starts.get(i)).intValue(), ((Integer) ends.get(i)).intValue(), ((Integer) flags.get(i)).intValue());
            }
    ...
    private SparseArray getOrCreateSpansFromViewTags(View host) {
    ...
    private SparseArray getSpansFromViewTags(View host) {
    ...
    private int idForClickableSpan(ClickableSpan span, SparseArray sparseArray) {
        if (sparseArray != null) {
            for (int i = 0; i < sparseArray.size(); i++) {
                ClickableSpan aSpan = (ClickableSpan) ((WeakReference) sparseArray.valueAt(i)).get();
    ...
    private void removeCollectedSpans(View view) {
        ...
        if (spans != null) {
            ...
            for (int i2 = 0; i2 < arrayList.size(); i2++) {
                spans.remove(((Integer) arrayList.get(i2)).intValue());
            }
        }
    }
    ...
    public List getActionList() {
        ...
        if (actions != null) {
            ...
            for (int i = 0; i < actionCount; i++) {
                ...
                arrayList.add(new AccessibilityActionCompat(action));
            }
            return arrayList;
        }
        List<AccessibilityActionCompat> result = Collections.emptyList();
        return result;
    }
    ...
    public List findAccessibilityNodeInfosByViewId(String viewId) {
        ...
        List<AccessibilityNodeInfo> nodes2 = Collections.emptyList();
        return nodes2;
    }
    ...
    public String toString() {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            for (int i = 0; i < actions.size(); i++) {
                AccessibilityActionCompat action = (AccessibilityActionCompat) actions.get(i);
