...
public final class ViewPropertyAnimatorCompat {
    ...
    public Interpolator getInterpolator() {
        ...
        if (view != null && Build.VERSION.SDK_INT >= 18) {
            return view.animate().getInterpolator();
        }
        return null;
    }
    ...
    private void setListenerInternal(View view, ViewPropertyAnimatorListener listener) {
        if (listener != null) {
            view.animate().setListener(new 1(listener, view));
        } else {
    ...
    class 2 implements ValueAnimator.AnimatorUpdateListener {
        ...
        2(ViewPropertyAnimatorUpdateListener viewPropertyAnimatorUpdateListener, View view) {
