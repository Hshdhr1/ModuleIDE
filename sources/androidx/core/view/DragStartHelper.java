...
public class DragStartHelper {
    ...
    private final View.OnLongClickListener mLongClickListener = new 1();
    private final View.OnTouchListener mTouchListener = new 2();
    ...
    class 2 implements View.OnTouchListener {
        2() {
        }
