...
public class PrecomputedTextCompat implements Spannable {
    ...
    public PrecomputedText getPrecomputedText() {
        PrecomputedText precomputedText = this.mText;
        if (precomputedText instanceof PrecomputedText) {
    ...
    public Object[] getSpans(int start, int end, Class cls) {
        if (Build.VERSION.SDK_INT >= 29) {
            return this.mWrapped.getSpans(start, end, cls);
        }
        return this.mText.getSpans(start, end, cls);
    }
