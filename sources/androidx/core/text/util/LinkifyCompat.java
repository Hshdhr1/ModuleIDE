...
public final class LinkifyCompat {
    ...
    private static void gatherLinks(ArrayList arrayList, Spannable s, Pattern pattern, String[] schemes, Linkify.MatchFilter matchFilter, Linkify.TransformFilter transformFilter) {
    ...
    private static void gatherMapLinks(ArrayList arrayList, Spannable s) {
        int start;
    ...
    private static void pruneOverlaps(ArrayList arrayList, Spannable text) {
        ...
        int i2 = 0;
        while (i2 < len - 1) {
            LinkSpec a = (LinkSpec) arrayList.get(i2);
            LinkSpec b = (LinkSpec) arrayList.get(i2 + 1);
            int remove = -1;
            if (a.start > b.start || a.end <= b.start) {
                ...
                if (remove != -1) {
                    URLSpan span = ((LinkSpec) arrayList.get(remove)).frameworkAddedSpan;
                    if (span != null) {
