...
public final class PackageInfoCompat {
    ...
    public static List getSignatures(PackageManager packageManager, String packageName) throws PackageManager.NameNotFoundException {
        Signature[] array;
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    */
    public static boolean hasSignatures(android.content.pm.PackageManager r10, java.lang.String r11, java.util.Map r12, boolean r13) throws android.content.pm.PackageManager.NameNotFoundException {
        /*
