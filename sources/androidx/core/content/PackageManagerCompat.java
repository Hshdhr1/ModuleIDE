...
public final class PackageManagerCompat {
    ...
    public static ListenableFuture getUnusedAppRestrictionsStatus(Context context) {
    ...
    public static String getPermissionRevocationVerifierApp(PackageManager packageManager) {
        Intent permissionRevocationSettingsIntent = new Intent("android.intent.action.AUTO_REVOKE_PERMISSIONS").setData(Uri.fromParts("package", "com.example", (String) null));
