...
public class FontResourcesParserCompat {
    ...
    public static List readCerts(Resources resources, int certsId) {
        if (certsId == 0) {
        ...
        try {
            ...
            if (getType(typedArray, 0) == 1) {
                for (int i = 0; i < typedArray.length(); i++) {
                    ...
                    if (certId != 0) {
                        arrayList.add(toByteArrayList(resources.getStringArray(certId)));
                    }
                }
            } else {
    ...
    private static List toByteArrayList(String[] stringArray) {
        ...
        for (String item : stringArray) {
            arrayList.add(Base64.decode(item, 0));
        }
        return arrayList;
    }
