...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private int evaluateColorChange(float f, int i, int i2) {
        return ((((i >> 24) & 255) + ((int) (f * (((i2 >> 24) & 255) - r12)))) << 24) | ((((i >> 16) & 255) + ((int) (f * (((i2 >> 16) & 255) - r12)))) << 16) | ((((i >> 8) & 255) + ((int) (f * (((i2 >> 8) & 255) - r12)))) << 8) | ((i & 255) + ((int) (f * ((i2 & 255) - r12))));
    }
    ...
    void applyTransformation(float f, Ring ring, boolean z) {
        ...
        if (f != 1.0f || z) {
            ...
            if (f < 0.5f) {
                ...
                startingStartTrim = interpolation + (0.79f * MATERIAL_INTERPOLATOR.getInterpolation(f / 0.5f)) + 0.01f;
            } else {
            ...
            float f3 = 216.0f * (f + this.mRotationCount);
    ...
    private void setupAnimators() {
        ...
        ofFloat.addUpdateListener(new 1(ring));
        ofFloat.setRepeatCount(-1);
        ofFloat.setRepeatMode(1);
        ofFloat.setInterpolator(LINEAR_INTERPOLATOR);
        ofFloat.addListener(new 2(ring));
    ...
    class 2 implements Animator.AnimatorListener {
        final /* synthetic */ Ring val$ring;
