            ...
            if (view != null) {
                ...
                if (iArr != null && i < iArr.length) {
                    ...
                    if (num != null && num.intValue() != -1) {
                        ...
                        String valueOf = String.valueOf((String) this.mMap.get(Integer.valueOf(view.getId())));
                ...
                if (fArr != null && i < fArr.length) {
                    ...
                    if (f != null && f.floatValue() != -1.0f) {
                        ...
                        String valueOf2 = String.valueOf((String) this.mMap.get(Integer.valueOf(view.getId())));
                        Log.e("CircularFlow", valueOf2.length() != 0 ? "Added angle to view with id: ".concat(valueOf2) : new String("Added angle to view with id: "));
                    }
                }
                ConstraintLayout.LayoutParams params = view.getLayoutParams();
