...
public class MotionEffect extends MotionHelper {
    ...
    public void onPreSetup(MotionLayout motionLayout, HashMap controllerMap) {
        View[] views;
        HashMap hashMap = controllerMap;
        View[] views2 = getViews((ConstraintLayout) getParent());
        if (views2 == null) {
            Log.v("FadeMove", String.valueOf(Debug.getLoc()).concat(" views = null"));
            return;
        }
        ...
        if (this.fadeMove == -1) {
            ...
            for (View view : views2) {
                MotionController mc = (MotionController) hashMap.get(view);
                if (mc != null) {
        ...
        while (i2 < views2.length) {
            MotionController mc2 = (MotionController) hashMap.get(views2[i2]);
            if (mc2 == null) {
                views = views2;
            } else {
