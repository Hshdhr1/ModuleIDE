...
public class Carousel extends MotionHelper {
    ...
    static /* synthetic */ MotionLayout access$000(Carousel x0) {
        return x0.mMotionLayout;
    }

    static /* synthetic */ void access$100(Carousel x0) {
        x0.updateItems();
    }

    static /* synthetic */ int access$200(Carousel x0) {
        return x0.mIndex;
    }

    static /* synthetic */ Adapter access$300(Carousel x0) {
        return x0.mAdapter;
    }

    static /* synthetic */ int access$400(Carousel x0) {
        return x0.touchUpMode;
    }

    static /* synthetic */ float access$500(Carousel x0) {
        return x0.velocityThreshold;
    }

    static /* synthetic */ float access$600(Carousel x0) {
        return x0.dampening;
    }

    static /* synthetic */ int access$700(Carousel x0) {
        return x0.mPreviousIndex;
    }
    ...
    class 1 implements Runnable {
        ...
        public void run() {
            ...
            if (Carousel.access$400(Carousel.this) == 2 && velocity > Carousel.access$500(Carousel.this) && Carousel.access$200(Carousel.this) < Carousel.access$300(Carousel.this).count() - 1) {
                float v = Carousel.access$600(Carousel.this) * velocity;
                ...
                Carousel.access$000(Carousel.this).post(new 1(v));
            }
        }
        ...
        class 1 implements Runnable {
            ...
            public void run() {
                Carousel.access$000(Carousel.this).touchAnimateTo(5, 1.0f, this.val$v);
            }
        }
    }
    ...
    protected void onAttachedToWindow() {
        ...
        if (getParent() instanceof MotionLayout) {
            MotionLayout container = getParent();
