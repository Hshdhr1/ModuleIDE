...
public class Flow extends VirtualLayout {
    ...
    static /* synthetic */ int access$000(Flow x0) {
        return x0.mHorizontalGap;
    }

    static /* synthetic */ int access$100(Flow x0) {
        return x0.mVerticalGap;
    }

    static /* synthetic */ int access$1000(Flow x0) {
        return x0.mFirstHorizontalStyle;
    }

    static /* synthetic */ float access$1100(Flow x0) {
        return x0.mFirstHorizontalBias;
    }

    static /* synthetic */ int access$1200(Flow x0) {
        return x0.mLastHorizontalStyle;
    }

    static /* synthetic */ float access$1300(Flow x0) {
        return x0.mLastHorizontalBias;
    }

    static /* synthetic */ float access$1400(Flow x0) {
        return x0.mVerticalBias;
    }

    static /* synthetic */ int access$1500(Flow x0) {
        return x0.mFirstVerticalStyle;
    }

    static /* synthetic */ float access$1600(Flow x0) {
        return x0.mFirstVerticalBias;
    }

    static /* synthetic */ int access$1700(Flow x0) {
        return x0.mLastVerticalStyle;
    }

    static /* synthetic */ float access$1800(Flow x0) {
        return x0.mLastVerticalBias;
    }

    static /* synthetic */ int access$1900(Flow x0) {
        return x0.mHorizontalAlign;
    }

    static /* synthetic */ int access$200(Flow x0, ConstraintWidget x1, int x2) {
        return x0.getWidgetWidth(x1, x2);
    }

    static /* synthetic */ int access$300(Flow x0, ConstraintWidget x1, int x2) {
        return x0.getWidgetHeight(x1, x2);
    }

    static /* synthetic */ int access$400(Flow x0) {
        return x0.mDisplayedWidgetsCount;
    }

    static /* synthetic */ ConstraintWidget[] access$500(Flow x0) {
        return x0.mDisplayedWidgets;
    }

    static /* synthetic */ int access$600(Flow x0) {
        return x0.mVerticalStyle;
    }

    static /* synthetic */ int access$700(Flow x0) {
        return x0.mVerticalAlign;
    }

    static /* synthetic */ int access$800(Flow x0) {
        return x0.mHorizontalStyle;
    }

    static /* synthetic */ float access$900(Flow x0) {
        return x0.mHorizontalBias;
    }

    public void copy(ConstraintWidget src, HashMap hashMap) {
    ...
    */
    ...
    private class WidgetsList {
        ...
        static /* synthetic */ ConstraintWidget access$2000(WidgetsList x0) {
            return x0.biggest;
        }
        ...
        public void add(ConstraintWidget widget) {
            if (this.mOrientation == 0) {
                int width = Flow.access$200(Flow.this, widget, this.mMax);
                if (widget.getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    this.mNbMatchConstraintsWidgets++;
                    width = 0;
                }
                int gap = Flow.access$000(Flow.this);
                if (widget.getVisibility() == 8) {
                    gap = 0;
                }
                this.mWidth += width + gap;
                int height = Flow.access$300(Flow.this, widget, this.mMax);
                ...
                int width2 = Flow.access$200(Flow.this, widget, this.mMax);
                int height2 = Flow.access$300(Flow.this, widget, this.mMax);
                if (widget.getVerticalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT) {
                    this.mNbMatchConstraintsWidgets++;
                    height2 = 0;
                }
                int gap2 = Flow.access$100(Flow.this);
                if (widget.getVisibility() == 8) {
                    gap2 = 0;
                }
        ...
        public void createConstraints(boolean isInRtl, int chainIndex, boolean isLastChain) {
            ...
            for (int i = 0; i < count && this.mStartIndex + i < Flow.access$400(Flow.this); i++) {
                ConstraintWidget widget = Flow.access$500(Flow.this)[this.mStartIndex + i];
                if (widget != null) {
                    widget.resetAnchors();
                }
            }
            ...
            for (int i2 = 0; i2 < count; i2++) {
                ...
                if (this.mStartIndex + index >= Flow.access$400(Flow.this)) {
                    break;
                }
                ConstraintWidget widget2 = Flow.access$500(Flow.this)[this.mStartIndex + index];
            ...
            if (this.mOrientation == 0) {
                ...
                verticalWidget.setVerticalChainStyle(Flow.access$600(Flow.this));
                int padding = this.mPaddingTop;
                if (chainIndex > 0) {
                    padding += Flow.access$100(Flow.this);
                }
                ...
                if (Flow.access$700(Flow.this) == 3 && !verticalWidget.hasBaseline()) {
                    int i3 = 0;
                    while (true) {
                        if (i3 >= count) {
                            break;
                        ...
                        if (this.mStartIndex + index2 >= Flow.access$400(Flow.this)) {
                            break;
                        }
                        ConstraintWidget widget3 = Flow.access$500(Flow.this)[this.mStartIndex + index2];
                ...
                for (int i4 = 0; i4 < count; i4++) {
                    ...
                    if (this.mStartIndex + index3 < Flow.access$400(Flow.this)) {
                        ConstraintWidget widget4 = Flow.access$500(Flow.this)[this.mStartIndex + index3];
                        if (widget4 != null) {
                            if (i4 == 0) {
                                widget4.connect(widget4.mLeft, this.mLeft, this.mPaddingLeft);
                            }
                            if (index3 == 0) {
                                int style = Flow.access$800(Flow.this);
                                float bias = Flow.access$900(Flow.this);
                                if (isInRtl) {
                                    bias = 1.0f - bias;
                                }
                                if (this.mStartIndex == 0 && Flow.access$1000(Flow.this) != -1) {
                                    style = Flow.access$1000(Flow.this);
                                    float access$1100 = Flow.access$1100(Flow.this);
                                    if (isInRtl) {
                                        access$1100 = 1.0f - access$1100;
                                    }
                                    bias = access$1100;
                                } else if (isLastChain && Flow.access$1200(Flow.this) != -1) {
                                    style = Flow.access$1200(Flow.this);
                                    float access$1300 = Flow.access$1300(Flow.this);
                                    if (isInRtl) {
                            ...
                            if (previous != null) {
                                widget4.mLeft.connect(previous.mRight, Flow.access$000(Flow.this));
                                if (i4 == firstVisible) {
                            ...
                            if (widget4 != verticalWidget) {
                                if (Flow.access$700(Flow.this) == 3 && baselineVerticalWidget.hasBaseline() && widget4 != baselineVerticalWidget && widget4.hasBaseline()) {
                                    widget4.mBaseline.connect(baselineVerticalWidget.mBaseline, 0);
                                } else {
                                    switch (Flow.access$700(Flow.this)) {
                                        case 0:
            ...
            horizontalWidget.setHorizontalChainStyle(Flow.access$800(Flow.this));
            int padding2 = this.mPaddingLeft;
            if (chainIndex > 0) {
                padding2 += Flow.access$000(Flow.this);
            }
            if (isInRtl) {
            ...
            for (int i5 = 0; i5 < count && this.mStartIndex + i5 < Flow.access$400(Flow.this); i5++) {
                ConstraintWidget widget5 = Flow.access$500(Flow.this)[this.mStartIndex + i5];
                if (widget5 != null) {
                    if (i5 == 0) {
                        widget5.connect(widget5.mTop, this.mTop, this.mPaddingTop);
                        int style2 = Flow.access$600(Flow.this);
                        float bias2 = Flow.access$1400(Flow.this);
                        if (this.mStartIndex == 0 && Flow.access$1500(Flow.this) != -1) {
                            style2 = Flow.access$1500(Flow.this);
                            bias2 = Flow.access$1600(Flow.this);
                        } else if (isLastChain && Flow.access$1700(Flow.this) != -1) {
                            style2 = Flow.access$1700(Flow.this);
                            bias2 = Flow.access$1800(Flow.this);
                        }
                    ...
                    if (previous != null) {
                        widget5.mTop.connect(previous.mBottom, Flow.access$100(Flow.this));
                        if (i5 == firstVisible) {
                    ...
                    if (widget5 != horizontalWidget) {
                        if (isInRtl) {
                            switch (Flow.access$1900(Flow.this)) {
                                case 0:
        ...
        public void measureMatchConstraints(int availableSpace) {
            ...
            for (int i2 = 0; i2 < count && this.mStartIndex + i2 < Flow.access$400(Flow.this); i2++) {
                ConstraintWidget widget = Flow.access$500(Flow.this)[this.mStartIndex + i2];
                if (this.mOrientation == 0) {
    ...
    private void measureChainWrap(ConstraintWidget[] widgets, int count, int orientation, int max, int[] measured) {
        ...
        if (orientation == 0) {
            ...
            while (i3 < count) {
                ...
                boolean doWrap3 = (width == max || (this.mHorizontalGap + width) + w > max) && WidgetsList.access$2000(list3) != null;
            ...
            while (i4 < count) {
                ...
                boolean doWrap4 = (height == max || (this.mVerticalGap + height) + h > max) && WidgetsList.access$2000(list5) != null;
        ...
        if (nbMatchConstraintsWidgets4 > 0 && needInternalMeasure) {
            ...
            while (i5 < listCount) {
                ...
                WidgetsList current = (WidgetsList) this.mChainList.get(i5);
                if (orientation == 0) {
        ...
        for (int i6 = 0; i6 < listCount; i6++) {
            WidgetsList current2 = (WidgetsList) this.mChainList.get(i6);
            if (orientation == 0) {
                if (i6 < listCount - 1) {
                    WidgetsList next = (WidgetsList) this.mChainList.get(i6 + 1);
                    bottom = WidgetsList.access$2000(next).mTop;
                    paddingBottom2 = 0;
                } else {
                    bottom = this.mBottom;
                    paddingBottom2 = getPaddingBottom();
                }
                ConstraintAnchor currentBottom = WidgetsList.access$2000(current2).mBottom;
                ...
                if (i6 < listCount - 1) {
                    WidgetsList next2 = (WidgetsList) this.mChainList.get(i6 + 1);
                    right = WidgetsList.access$2000(next2).mLeft;
                    paddingRight2 = 0;
                } else {
                    right = this.mRight;
                    paddingRight2 = getPaddingRight();
                }
                ConstraintAnchor currentRight = WidgetsList.access$2000(current2).mRight;
    ...
    private void measureNoWrap(ConstraintWidget[] widgets, int count, int orientation, int max, int[] measured) {
        ...
        if (this.mChainList.size() == 0) {
            ...
            list = (WidgetsList) this.mChainList.get(0);
            list.clear();
    ...
    public void addToSolver(LinearSystem system, boolean optimize) {
        ...
        switch (this.mWrapMode) {
            case 0:
                if (this.mChainList.size() > 0) {
                    WidgetsList list = (WidgetsList) this.mChainList.get(0);
            ...
            case 1:
                ...
                int i = 0;
                while (i < count) {
                    WidgetsList list2 = (WidgetsList) this.mChainList.get(i);
