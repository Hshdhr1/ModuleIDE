...
public abstract class WidgetRun implements Dependency {
    ...
    public boolean isCenterConnection() {
        ...
        for (int i = 0; i < count; i++) {
            DependencyNode dependency = (DependencyNode) this.start.targets.get(i);
        ...
        for (int i2 = 0; i2 < count2; i2++) {
            DependencyNode dependency2 = (DependencyNode) this.end.targets.get(i2);
    ...
    protected final DependencyNode getTarget(ConstraintAnchor anchor) {
        ...
        switch (1.$SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type[targetType.ordinal()]) {
            case 1:
