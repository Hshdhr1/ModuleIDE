...
public class Grouping {
    ...
    public static boolean simpleSolvingPass(ConstraintWidgetContainer layout, BasicMeasure.Measurer measurer) {
        ...
        for (int i = 0; i < count; i++) {
            ConstraintWidget child = (ConstraintWidget) children.get(i);
        ...
        for (int i2 = 0; i2 < count; i2++) {
            ConstraintWidget child2 = (ConstraintWidget) children.get(i2);
        ...
        if (verticalGuidelines != null) {
            Iterator it = verticalGuidelines.iterator();
            while (it.hasNext()) {
                Guideline guideline2 = (Guideline) it.next();
                findDependents(guideline2, 0, allDependencyLists, null);
            }
        }
        if (horizontalBarriers != null) {
            Iterator it2 = horizontalBarriers.iterator();
            while (it2.hasNext()) {
                HelperWidget barrier2 = (HelperWidget) it2.next();
        ...
        if (left.getDependents() != null) {
            Iterator it3 = left.getDependents().iterator();
            while (it3.hasNext()) {
                ConstraintAnchor first = (ConstraintAnchor) it3.next();
        ...
        if (right.getDependents() != null) {
            Iterator it4 = right.getDependents().iterator();
            while (it4.hasNext()) {
                ConstraintAnchor first2 = (ConstraintAnchor) it4.next();
        ...
        if (center.getDependents() != null) {
            Iterator it5 = center.getDependents().iterator();
            while (it5.hasNext()) {
                ConstraintAnchor first3 = (ConstraintAnchor) it5.next();
                findDependents(first3.mOwner, 0, allDependencyLists, null);
                center = center;
            }
        }
        if (isolatedHorizontalChildren != null) {
            Iterator it6 = isolatedHorizontalChildren.iterator();
            while (it6.hasNext()) {
                ConstraintWidget widget = (ConstraintWidget) it6.next();
                findDependents(widget, 0, allDependencyLists, null);
            }
        }
        if (horizontalGuidelines != null) {
            Iterator it7 = horizontalGuidelines.iterator();
            while (it7.hasNext()) {
                Guideline guideline3 = (Guideline) it7.next();
                findDependents(guideline3, 1, allDependencyLists, null);
            }
        }
        if (verticalBarriers != null) {
            Iterator it8 = verticalBarriers.iterator();
            while (it8.hasNext()) {
                HelperWidget barrier3 = (HelperWidget) it8.next();
        ...
        if (top.getDependents() != null) {
            Iterator it9 = top.getDependents().iterator();
            while (it9.hasNext()) {
                ConstraintAnchor first4 = (ConstraintAnchor) it9.next();
        ...
        if (baseline.getDependents() != null) {
            Iterator it10 = baseline.getDependents().iterator();
            while (it10.hasNext()) {
                ConstraintAnchor first5 = (ConstraintAnchor) it10.next();
        ...
        if (bottom.getDependents() != null) {
            Iterator it11 = bottom.getDependents().iterator();
            while (it11.hasNext()) {
                ConstraintAnchor first6 = (ConstraintAnchor) it11.next();
        ...
        if (center2.getDependents() != null) {
            Iterator it12 = center2.getDependents().iterator();
            while (it12.hasNext()) {
                ConstraintAnchor first7 = (ConstraintAnchor) it12.next();
                findDependents(first7.mOwner, 1, allDependencyLists, null);
                center2 = center2;
            }
        }
        if (isolatedVerticalChildren != null) {
            Iterator it13 = isolatedVerticalChildren.iterator();
            while (it13.hasNext()) {
                ConstraintWidget widget2 = (ConstraintWidget) it13.next();
                findDependents(widget2, 1, allDependencyLists, null);
            }
        }
        for (int i3 = 0; i3 < count; i3++) {
            ConstraintWidget child3 = (ConstraintWidget) children.get(i3);
        ...
        if (layout.getHorizontalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
            ...
            Iterator it14 = allDependencyLists.iterator();
            while (it14.hasNext()) {
                WidgetGroup list = (WidgetGroup) it14.next();
        ...
        if (layout.getVerticalDimensionBehaviour() == ConstraintWidget.DimensionBehaviour.WRAP_CONTENT) {
            ...
            Iterator it15 = allDependencyLists.iterator();
            while (it15.hasNext()) {
                WidgetGroup list2 = (WidgetGroup) it15.next();
    ...
    private static WidgetGroup findGroup(ArrayList arrayList, int groupId) {
        int count = arrayList.size();
        for (int i = 0; i < count; i++) {
            WidgetGroup group = (WidgetGroup) arrayList.get(i);
            if (groupId == group.id) {
                return group;
            }
        }
    ...
    public static WidgetGroup findDependents(ConstraintWidget constraintWidget, int orientation, ArrayList arrayList, WidgetGroup group) {
        int groupId;
        if (orientation == 0) {
            ...
            if (constraintWidget instanceof HelperWidget) {
                ...
                if (groupId2 != -1) {
                    ...
                    while (true) {
                        ...
                        WidgetGroup widgetGroup2 = (WidgetGroup) arrayList.get(i2);
