...
public class ChainRun extends WidgetRun {
    ...
    boolean supportsWrapComputation() {
        ...
        for (int i = 0; i < count; i++) {
            WidgetRun run = (WidgetRun) this.widgets.get(i);
    ...
    */
    ...
    void apply() {
        ...
        ConstraintWidget firstWidget = ((WidgetRun) this.widgets.get(0)).widget;
        ConstraintWidget lastWidget = ((WidgetRun) this.widgets.get(count - 1)).widget;
        if (this.orientation == 0) {
