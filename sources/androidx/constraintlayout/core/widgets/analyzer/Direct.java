...
public class Direct {
    ...
    public static void solvingPass(ConstraintWidgetContainer layout, BasicMeasure.Measurer measurer) {
        ...
        for (int i2 = 0; i2 < count; i2++) {
            ConstraintWidget child = (ConstraintWidget) children.get(i2);
        ...
        if (hasGuideline) {
            for (int i3 = 0; i3 < count; i3++) {
                ConstraintWidget child2 = (ConstraintWidget) children.get(i3);
        ...
        if (hasBarrier) {
            for (int i4 = 0; i4 < count; i4++) {
                ConstraintWidget child3 = (ConstraintWidget) children.get(i4);
        ...
        for (int i5 = 0; i5 < count; i5++) {
            ConstraintWidget child4 = (ConstraintWidget) children.get(i5);
        ...
        if (hasGuideline2) {
            for (int i6 = 0; i6 < count; i6++) {
                ConstraintWidget child5 = (ConstraintWidget) children.get(i6);
        ...
        if (hasBarrier2) {
            for (int i7 = 0; i7 < count; i7++) {
                ConstraintWidget child6 = (ConstraintWidget) children.get(i7);
        ...
        for (int i8 = 0; i8 < count; i8++) {
            ConstraintWidget child7 = (ConstraintWidget) children.get(i8);
    ...
    private static void horizontalSolvingPass(int level, ConstraintWidget layout, BasicMeasure.Measurer measurer, boolean isRtl) {
        ...
        if (left.getDependents() != null && left.hasFinalValue()) {
            Iterator it = left.getDependents().iterator();
            while (it.hasNext()) {
                ConstraintAnchor first = (ConstraintAnchor) it.next();
        ...
        if (right.getDependents() != null && right.hasFinalValue()) {
            Iterator it2 = right.getDependents().iterator();
            while (it2.hasNext()) {
                ConstraintAnchor first2 = (ConstraintAnchor) it2.next();
    ...
    private static void verticalSolvingPass(int level, ConstraintWidget layout, BasicMeasure.Measurer measurer) {
        ...
        if (top.getDependents() != null && top.hasFinalValue()) {
            Iterator it = top.getDependents().iterator();
            while (it.hasNext()) {
                ConstraintAnchor first = (ConstraintAnchor) it.next();
                ConstraintWidget widget = first.mOwner;
                boolean canMeasure = canMeasure(level + 1, widget);
        ...
        if (bottom.getDependents() != null && bottom.hasFinalValue()) {
            Iterator it2 = bottom.getDependents().iterator();
            while (it2.hasNext()) {
                ConstraintAnchor first2 = (ConstraintAnchor) it2.next();
                ConstraintWidget widget2 = first2.mOwner;
                boolean canMeasure2 = canMeasure(level + 1, widget2);
        ...
        if (baseline.getDependents() != null && baseline.hasFinalValue()) {
            ...
            Iterator it3 = baseline.getDependents().iterator();
            while (it3.hasNext()) {
                ConstraintAnchor first3 = (ConstraintAnchor) it3.next();
