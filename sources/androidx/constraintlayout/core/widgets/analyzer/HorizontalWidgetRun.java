...
public class HorizontalWidgetRun extends WidgetRun {
    ...
    public void update(Dependency dependency) {
                    ...
                    if (this.widget.mMatchConstraintDefaultHeight == 0 || this.widget.mMatchConstraintDefaultHeight == 3) {
                        ...
                        if (s1 && s2 && e1 && e2) {
                            ...
                            if (secondStart.resolved && secondEnd.resolved) {
                                ...
                                computeInsetRatio(tempDimensions, ((DependencyNode) this.start.targets.get(0)).value + this.start.margin, ((DependencyNode) this.end.targets.get(0)).value - this.end.margin, secondStart.value + secondStart.margin, secondEnd.value - secondEnd.margin, ratio, definedSide);
                            ...
                            if (this.start.resolved && this.end.resolved) {
                                ...
                                computeInsetRatio(tempDimensions, this.start.value + this.start.margin, this.end.value - this.end.margin, ((DependencyNode) secondStart.targets.get(0)).value + secondStart.margin, ((DependencyNode) secondEnd.targets.get(0)).value - secondEnd.margin, ratio, definedSide);
                                this.dimension.resolve(tempDimensions[0]);
                                this.widget.verticalRun.dimension.resolve(tempDimensions[1]);
                            }
                            ...
                            computeInsetRatio(tempDimensions, ((DependencyNode) this.start.targets.get(0)).value + this.start.margin, ((DependencyNode) this.end.targets.get(0)).value - this.end.margin, ((DependencyNode) secondStart.targets.get(0)).value + secondStart.margin, ((DependencyNode) secondEnd.targets.get(0)).value - secondEnd.margin, ratio, definedSide);
                            this.dimension.resolve(tempDimensions[0]);
                            this.widget.verticalRun.dimension.resolve(tempDimensions[1]);
                            break;
                        } else if (s1 && e1) {
                            ...
                            int x1 = ((DependencyNode) this.start.targets.get(0)).value + this.start.margin;
                            int x2 = ((DependencyNode) this.end.targets.get(0)).value - this.end.margin;
                            switch (definedSide) {
                                case -1:
                                case 0:
                            ...
                            int y1 = ((DependencyNode) secondStart.targets.get(0)).value + secondStart.margin;
                            int y2 = ((DependencyNode) secondEnd.targets.get(0)).value - secondEnd.margin;
                            switch (definedSide) {
                                case -1:
                                case 1:
                                    int dy3 = y2 - y1;
        ...
        if (!this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && this.widget.mMatchConstraintDefaultWidth == 0 && !this.widget.isInHorizontalChain()) {
            ...
            DependencyNode endTarget = (DependencyNode) this.end.targets.get(0);
        ...
        if (!this.dimension.resolved && this.dimensionBehavior == ConstraintWidget.DimensionBehaviour.MATCH_CONSTRAINT && this.matchConstraintsType == 1 && this.start.targets.size() > 0 && this.end.targets.size() > 0) {
            DependencyNode startTarget2 = (DependencyNode) this.start.targets.get(0);
            DependencyNode endTarget2 = (DependencyNode) this.end.targets.get(0);
        ...
        DependencyNode startTarget3 = (DependencyNode) this.start.targets.get(0);
        DependencyNode endTarget3 = (DependencyNode) this.end.targets.get(0);
