...
public class ConstraintWidgetContainer extends WidgetContainer {
    ...
    public boolean addChildrenToSolver(LinearSystem system) {
        ...
        while (this.widgetsToAdd.size() > 0) {
            ...
            while (true) {
                ...
                VirtualLayout layout = (VirtualLayout) ((ConstraintWidget) it.next());
            ...
            if (numLayouts == this.widgetsToAdd.size()) {
                ...
                while (it2.hasNext()) {
                    ((ConstraintWidget) it2.next()).addToSolver(system, optimize);
                }
                this.widgetsToAdd.clear();
            }
        }
        if (LinearSystem.USE_DEPENDENCY_ORDERING) {
            ...
            Iterator it3 = widgetsToAdd.iterator();
            while (it3.hasNext()) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:165:0x0353 A[SYNTHETIC] */
    /*
