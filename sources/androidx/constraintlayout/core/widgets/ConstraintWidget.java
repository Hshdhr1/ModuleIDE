...
public class ConstraintWidget {
    ...
    private void serializeSize(StringBuilder ret, String type, int size, int min, int max, int override, int matchConstraintMin, int matchConstraintDefault, float MatchConstraintPercent, float weight) {
        ret.append(type);
        ret.append(" :  {\n");
        serializeAttribute(ret, "size", size, -2.1474836E9f);
        serializeAttribute(ret, "min", min, 0.0f);
        serializeAttribute(ret, "max", max, 2.1474836E9f);
        serializeAttribute(ret, "matchMin", matchConstraintMin, 0.0f);
        serializeAttribute(ret, "matchDef", matchConstraintDefault, 0.0f);
        serializeAttribute(ret, "matchPercent", matchConstraintDefault, 1.0f);
        ret.append("},\n");
    }
    ...
    public ConstraintAnchor getAnchor(ConstraintAnchor.Type anchorType) {
        switch (1.$SwitchMap$androidx$constraintlayout$core$widgets$ConstraintAnchor$Type[anchorType.ordinal()]) {
            case 1:
                return this.mLeft;
            case 2:
                return this.mTop;
    ...
    /* JADX WARN: Removed duplicated region for block: B:270:0x0371  */
    ...
    */
    ...
    public void copy(ConstraintWidget src, HashMap hashMap) {
        ...
        this.mParent = this.mParent == null ? null : (ConstraintWidget) hashMap.get(src.mParent);
        ...
        this.mHorizontalNextWidget = constraintWidget == null ? null : (ConstraintWidget) hashMap.get(constraintWidget);
        ConstraintWidget constraintWidget2 = src.mVerticalNextWidget;
        this.mVerticalNextWidget = constraintWidget2 != null ? (ConstraintWidget) hashMap.get(constraintWidget2) : null;
    }
    ...
    public void addChildrenToSolverByDependency(ConstraintWidgetContainer container, LinearSystem system, HashSet hashSet, int orientation, boolean addSelf) {
        if (addSelf) {
        ...
        if (orientation == 0) {
            ...
            if (dependents != null) {
                ...
                while (it.hasNext()) {
                    ConstraintAnchor anchor = (ConstraintAnchor) it.next();
                    anchor.mOwner.addChildrenToSolverByDependency(container, system, hashSet, orientation, true);
                }
            }
            ...
            if (dependents2 != null) {
                ...
                while (it2.hasNext()) {
                    ConstraintAnchor anchor2 = (ConstraintAnchor) it2.next();
                    anchor2.mOwner.addChildrenToSolverByDependency(container, system, hashSet, orientation, true);
                }
                return;
            }
            return;
        ...
        if (dependents3 != null) {
            ...
            while (it3.hasNext()) {
                ConstraintAnchor anchor3 = (ConstraintAnchor) it3.next();
                anchor3.mOwner.addChildrenToSolverByDependency(container, system, hashSet, orientation, true);
            }
        }
        ...
        if (dependents4 != null) {
            ...
            while (it4.hasNext()) {
                ConstraintAnchor anchor4 = (ConstraintAnchor) it4.next();
                anchor4.mOwner.addChildrenToSolverByDependency(container, system, hashSet, orientation, true);
            }
        }
        ...
        if (dependents5 != null) {
            ...
            while (it5.hasNext()) {
                ConstraintAnchor anchor5 = (ConstraintAnchor) it5.next();
                anchor5.mOwner.addChildrenToSolverByDependency(container, system, hashSet, orientation, true);
            }
        }
    }
}
