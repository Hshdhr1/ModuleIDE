...
public class HelperWidget extends ConstraintWidget implements Helper {
    ...
    public void copy(ConstraintWidget src, HashMap hashMap) {
        ...
        for (int i = 0; i < count; i++) {
            add((ConstraintWidget) hashMap.get(srcHelper.mWidgets[i]));
        }
    }
    ...
    public void addDependents(ArrayList arrayList, int orientation, WidgetGroup group) {
        ...
        for (int i2 = 0; i2 < this.mWidgetsCount; i2++) {
            ...
            Grouping.findDependents(widget2, orientation, arrayList, group);
        }
    }
