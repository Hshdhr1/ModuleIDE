...
public class Chain {
    ...
    public static void applyChainConstraints(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem system, ArrayList arrayList, int orientation) {
        int offset;
        int chainsSize;
        ...
        for (int i = 0; i < chainsSize; i++) {
            ...
            first.define();
            if (arrayList == null || (arrayList != null && arrayList.contains(first.mFirst))) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:231:0x06e8 A[ADDED_TO_REGION] */
