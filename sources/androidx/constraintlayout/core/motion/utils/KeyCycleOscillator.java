...
public abstract class KeyCycleOscillator {
    ...
    public String toString() {
        ...
        while (it.hasNext()) {
            WavePoint wp = (WavePoint) it.next();
    ...
    public void setup(float pathLength) {
        ...
        if (count != 0) {
            Collections.sort(this.mWavePoints, new 1());
            double[] time = new double[count];
            double[][] values = (double[][]) Array.newInstance(double.class, new int[]{count, 3});
    ...
    class 1 implements Comparator {
        ...
        public int compare(WavePoint lhs, WavePoint rhs) {
            return KeyCycleOscillator$1$$ExternalSyntheticBackport0.m(lhs.mPosition, rhs.mPosition);
        }
    }
    ...
    static class CycleOscillator {
        ...
        public void setup(float pathLength) {
            ...
            double[][] splineValues = (double[][]) Array.newInstance(double.class, new int[]{this.mPosition.length, 3});
