...
public class Oscillator {
    ...
    double getP(double time) {
        ...
        double[] dArr = this.mPosition;
        double d2 = dArr[index2] - dArr[index2 - 1];
        Double.isNaN(d);
        double m = d / d2;
        double d3 = this.mArea[index2 - 1];
        double d4 = fArr[index2 - 1];
        double d5 = dArr[index2 - 1] * m;
        Double.isNaN(d4);
        double p = d3 + ((d4 - d5) * (t - dArr[index2 - 1])) + ((((t * t) - (dArr[index2 - 1] * dArr[index2 - 1])) * m) / 2.0d);
        return p;
    }
    ...
    double getDP(double time) {
        ...
        Double.isNaN(d);
        double m = d / d2;
        double d3 = fArr[index2 - 1];
        double d4 = dArr[index2 - 1] * m;
        Double.isNaN(d3);
        double p = (m * t) + (d3 - d4);
        return p;
    }
