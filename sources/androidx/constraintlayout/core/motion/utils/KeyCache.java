...
public class KeyCache {
    ...
    public void setFloatValue(Object view, String type, int element, float value) {
        ...
        HashMap<String, float[]> array2 = (HashMap) this.map.get(view);
        if (array2 == null) {
            array2 = new HashMap<>();
        }
        ...
        float[] vArray3 = (float[]) array2.get(type);
        if (vArray3 == null) {
            vArray3 = new float[0];
        }
    ...
    public float getFloatValue(Object view, String type, int element) {
        ...
        float[] vArray;
        if (this.map.containsKey(view) && (array = (HashMap) this.map.get(view)) != null && array.containsKey(type) && (vArray = (float[]) array.get(type)) != null && vArray.length > element) {
