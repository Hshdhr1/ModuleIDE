...
public class MotionPaths implements Comparable {
    ...
    */
    void setView(float r35, androidx.constraintlayout.core.motion.MotionWidget r36, int[] r37, double[] r38, double[] r39, double[] r40) {
        /*
    ...
    int getCustomDataCount(String name) {
        CustomVariable a = (CustomVariable) this.customAttributes.get(name);
        if (a == null) {
            return 0;
        }
