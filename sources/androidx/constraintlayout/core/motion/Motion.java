...
public class Motion {
    ...
    public void buildPath(float[] points, int pointCount) {
        ...
        SplineSet trans_x = hashMap == null ? null : (SplineSet) hashMap.get("translationX");
        HashMap hashMap2 = motion.mAttributesMap;
        SplineSet trans_y = hashMap2 == null ? null : (SplineSet) hashMap2.get("translationY");
        HashMap hashMap3 = motion.mCycleMap;
        KeyCycleOscillator osc_x = hashMap3 == null ? null : (KeyCycleOscillator) hashMap3.get("translationX");
        HashMap hashMap4 = motion.mCycleMap;
        KeyCycleOscillator osc_y = hashMap4 != null ? (KeyCycleOscillator) hashMap4.get("translationY") : null;
        int i = 0;
        while (i < pointCount) {
            ...
            float end = Float.NaN;
            while (it.hasNext()) {
                MotionPaths frame = (MotionPaths) it.next();
    ...
    private float getPreCycleDistance() {
        ...
        while (i < pointCount) {
            ...
            if (i2 > 0) {
                ...
                double d4 = points[0];
                Double.isNaN(d4);
                double hypot = Math.hypot(y - d3, x - d4);
                Double.isNaN(d2);
                sum = (float) (d2 + hypot);
            }
            x = points[0];
    ...
    MotionKeyPosition getPositionKeyframe(int layoutWidth, int layoutHeight, float x, float y) {
        ...
        while (it.hasNext()) {
            MotionKey key = (MotionKey) it.next();
    ...
    public int buildKeyFrames(float[] keyFrames, int[] mode, int[] pos) {
        ...
        if (mode != null) {
            Iterator it = this.mMotionPaths.iterator();
            while (it.hasNext()) {
                MotionPaths keyFrame = (MotionPaths) it.next();
        ...
        if (pos != null) {
            ...
            while (it2.hasNext()) {
                MotionPaths keyFrame2 = (MotionPaths) it2.next();
    ...
    int getAttributeValues(String attributeType, float[] points, int pointCount) {
        ...
        SplineSet spline = (SplineSet) this.mAttributesMap.get(attributeType);
        if (spline == null) {
            return -1;
        }
    ...
    private void insertKey(MotionPaths point) {
        ...
        Iterator it = this.mMotionPaths.iterator();
        while (it.hasNext()) {
            MotionPaths p = (MotionPaths) it.next();
        ...
        if (pos == 0) {
            Utils.loge("MotionController", " KeyPath position \"" + point.position + "\" outside of range");
        }
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
        ...
        if (arrayList != null) {
            ...
            while (it3.hasNext()) {
                MotionKey key = (MotionKey) it3.next();
        ...
        if (!splineAttributes.isEmpty()) {
            ...
            Iterator it4 = splineAttributes.iterator();
            while (it4.hasNext()) {
                String attribute2 = (String) it4.next();
                if (attribute2.startsWith("CUSTOM,")) {
                    ...
                    while (it5.hasNext()) {
                        ...
                        MotionKey key2 = (MotionKey) it5.next();
                        Iterator it6 = it4;
                        if (key2.mCustom == null) {
                            it4 = it6;
                            triggerList2 = triggerList3;
                        } else {
                            CustomVariable customAttribute = (CustomVariable) key2.mCustom.get(customAttributeName2);
            ...
            if (arrayList2 != null) {
                ...
                while (it7.hasNext()) {
                    MotionKey key3 = (MotionKey) it7.next();
            ...
            for (String spline : this.mAttributesMap.keySet()) {
                int curve = 0;
                if (interpolation.containsKey(spline) && (boxedCurve = (Integer) interpolation.get(spline)) != null) {
                    curve = boxedCurve.intValue();
                }
                SplineSet splineSet = (SplineSet) this.mAttributesMap.get(spline);
                if (splineSet != null) {
        ...
        if (!timeCycleAttributes2.isEmpty()) {
            ...
            Iterator it8 = timeCycleAttributes2.iterator();
            while (it8.hasNext()) {
                String attribute3 = (String) it8.next();
                if (!this.mTimeCycleAttributesMap.containsKey(attribute3)) {
                    ...
                    if (attribute3.startsWith("CUSTOM,")) {
                        ...
                        Iterator it9 = this.mKeyList.iterator();
                        while (it9.hasNext()) {
                            Iterator it10 = it8;
                            MotionKey key4 = (MotionKey) it9.next();
                            HashSet<String> timeCycleAttributes3 = timeCycleAttributes2;
                            if (key4.mCustom == null) {
                                timeCycleAttributes2 = timeCycleAttributes3;
                                it8 = it10;
                            } else {
                                CustomVariable customAttribute2 = (CustomVariable) key4.mCustom.get(customAttributeName3);
            ...
            if (arrayList3 != null) {
                ...
                while (it11.hasNext()) {
                    MotionKey key5 = (MotionKey) it11.next();
            ...
            for (String spline2 : this.mTimeCycleAttributesMap.keySet()) {
                ...
                if (interpolation.containsKey(spline2)) {
                    curve2 = ((Integer) interpolation.get(spline2)).intValue();
                }
                ((TimeCycleSplineSet) this.mTimeCycleAttributesMap.get(spline2)).setup(curve2);
            }
        }
        ...
        while (it12.hasNext()) {
            MotionPaths point = (MotionPaths) it12.next();
            points[count] = point;
            count++;
        }
        int variables2 = 18;
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (!points[j].customAttributes.containsKey(attributeName) || (attribute = (CustomVariable) points[j].customAttributes.get(attributeName)) == null) {
                    j++;
                } else {
        ...
        double[][] splineData = (double[][]) Array.newInstance(double.class, new int[]{i6, this.mInterpolateVariables.length});
                ...
                if (j3 < variables3) {
                    if (!points[j3].hasCustomData(name)) {
                        ...
                        if (splinePoints != null) {
                            ...
                            attributeNameSet = attributeNameSet2;
                            mask = mask2;
                            splinePoints = (double[][]) Array.newInstance(double.class, new int[]{points.length, points[j3].getCustomDataCount(name)});
        ...
        if (points[0].mPathMotionArc != -1) {
            ...
            double[][] values = (double[][]) Array.newInstance(double.class, new int[]{size, 2});
        ...
        if (this.mKeyList != null) {
            Iterator it13 = cycleAttributes.iterator();
            while (it13.hasNext()) {
                String attribute4 = (String) it13.next();
            ...
            Iterator it14 = this.mKeyList.iterator();
            while (it14.hasNext()) {
                MotionKey key6 = (MotionKey) it14.next();
            ...
            while (it15.hasNext()) {
                ((KeyCycleOscillator) it15.next()).setup(distance);
            }
        }
    }
    ...
    static class 1 implements DifferentialInterpolator {
        float mX;
        ...
        public float getInterpolation(float x) {
            this.mX = x;
            return (float) this.val$easing.get(x);
        }
    ...
    public boolean interpolate(MotionWidget child, float global_position, long time, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            while (true) {
                ...
                ((CustomVariable) this.mStartMotionPath.customAttributes.get(this.mAttributeNames[i2 - 1])).setInterpolatedValue(child, this.mValuesBuff);
                i2++;
            }
    ...
    void getPostLayoutDvDp(float position, int width, int height, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        SplineSet rotation = hashMap3 == null ? null : (SplineSet) hashMap3.get("rotationZ");
        HashMap hashMap4 = this.mAttributesMap;
        SplineSet scale_x = hashMap4 == null ? null : (SplineSet) hashMap4.get("scaleX");
        HashMap hashMap5 = this.mAttributesMap;
        SplineSet scale_y = hashMap5 == null ? null : (SplineSet) hashMap5.get("scaleY");
        HashMap hashMap6 = this.mCycleMap;
        KeyCycleOscillator osc_x = hashMap6 == null ? null : (KeyCycleOscillator) hashMap6.get("translationX");
        HashMap hashMap7 = this.mCycleMap;
        KeyCycleOscillator osc_y = hashMap7 == null ? null : (KeyCycleOscillator) hashMap7.get("translationY");
        HashMap hashMap8 = this.mCycleMap;
        KeyCycleOscillator osc_r = hashMap8 == null ? null : (KeyCycleOscillator) hashMap8.get("rotationZ");
        HashMap hashMap9 = this.mCycleMap;
        KeyCycleOscillator osc_sx = hashMap9 == null ? null : (KeyCycleOscillator) hashMap9.get("scaleX");
        HashMap hashMap10 = this.mCycleMap;
        KeyCycleOscillator osc_sy = hashMap10 != null ? (KeyCycleOscillator) hashMap10.get("scaleY") : null;
