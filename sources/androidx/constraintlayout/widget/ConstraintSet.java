...
public class ConstraintSet {
    ...
    static /* synthetic */ int access$100(TypedArray x0, int x1, int x2) {
        return lookupID(x0, x1, x2);
    }

    static /* synthetic */ HashMap access$1300(ConstraintSet x0) {
        return x0.mConstraints;
    }
    ...
    static /* synthetic */ void access$300(Constraint x0, int x1, int x2) {
        setDeltaValue(x0, x1, x2);
    }

    static /* synthetic */ void access$400(Constraint x0, int x1, float x2) {
        setDeltaValue(x0, x1, x2);
    }

    static /* synthetic */ void access$500(Constraint x0, int x1, String x2) {
        setDeltaValue(x0, x1, x2);
    }

    static /* synthetic */ void access$600(Constraint x0, int x1, boolean x2) {
        setDeltaValue(x0, x1, x2);
    }
    ...
    public void readFallback(ConstraintSet set) {
        for (Integer key : set.mConstraints.keySet()) {
            int id = key.intValue();
            Constraint parent = (Constraint) set.mConstraints.get(key);
            ...
            if (constraint != null) {
                ...
                for (String s : parent.mCustomConstraints.keySet()) {
                    if (!constraint.mCustomConstraints.containsKey(s)) {
                        constraint.mCustomConstraints.put(s, (ConstraintAttribute) parent.mCustomConstraints.get(s));
                    }
                }
            }
        }
    ...
    public void readFallback(ConstraintLayout constraintLayout) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            ConstraintLayout.LayoutParams param = view.getLayoutParams();
            int id = view.getId();
            ...
            if (constraint != null) {
                if (!constraint.layout.mApply) {
                    Constraint.access$000(constraint, id, param);
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                switch (mapToConstant.get(attr)) {
                    case 1:
                        this.baselineToBaseline = ConstraintSet.access$100(a, attr, this.baselineToBaseline);
                        break;
                    case 2:
                        this.bottomMargin = a.getDimensionPixelSize(attr, this.bottomMargin);
                        break;
                    case 3:
                        this.bottomToBottom = ConstraintSet.access$100(a, attr, this.bottomToBottom);
                        break;
                    case 4:
                        this.bottomToTop = ConstraintSet.access$100(a, attr, this.bottomToTop);
                        break;
                    case 5:
                    ...
                    case 9:
                        this.endToEnd = ConstraintSet.access$100(a, attr, this.endToEnd);
                        break;
                    case 10:
                        this.endToStart = ConstraintSet.access$100(a, attr, this.endToStart);
                        break;
                    case 11:
                    ...
                    case 23:
                        ...
                        break;
                    case 24:
                        this.leftToLeft = ConstraintSet.access$100(a, attr, this.leftToLeft);
                        break;
                    case 25:
                        this.leftToRight = ConstraintSet.access$100(a, attr, this.leftToRight);
                        break;
                    case 26:
                    ...
                    case 27:
                        ...
                        break;
                    case 28:
                        this.rightToLeft = ConstraintSet.access$100(a, attr, this.rightToLeft);
                        break;
                    case 29:
                        this.rightToRight = ConstraintSet.access$100(a, attr, this.rightToRight);
                        break;
                    case 30:
                        if (Build.VERSION.SDK_INT >= 17) {
                    ...
                    case 31:
                        this.startToEnd = ConstraintSet.access$100(a, attr, this.startToEnd);
                        break;
                    case 32:
                        this.startToStart = ConstraintSet.access$100(a, attr, this.startToStart);
                        break;
                    case 33:
                        this.topMargin = a.getDimensionPixelSize(attr, this.topMargin);
                        break;
                    case 34:
                        this.topToBottom = ConstraintSet.access$100(a, attr, this.topToBottom);
                        break;
                    case 35:
                        this.topToTop = ConstraintSet.access$100(a, attr, this.topToTop);
                        break;
                    case 36:
                    ...
                    case 59:
                        ...
                        break;
                    case 61:
                        this.circleConstraint = ConstraintSet.access$100(a, attr, this.circleConstraint);
                        break;
                    case 62:
                    ...
                    case 75:
                        ...
                        break;
                    case 76:
                        String hexString2 = Integer.toHexString(attr);
                        int i3 = mapToConstant.get(attr);
                    ...
                    case 81:
                        ...
                        break;
                    case 91:
                        this.baselineToTop = ConstraintSet.access$100(a, attr, this.baselineToTop);
                        break;
                    case 92:
                        this.baselineToBottom = ConstraintSet.access$100(a, attr, this.baselineToBottom);
                        break;
                    case 93:
                ...
                if (!Modifier.isStatic(field.getModifiers())) {
                    try {
                        ...
                        if (type == Integer.TYPE) {
                            ...
                            if (str.intValue() != -1) {
                                String stringId = scene.lookUpConstraintName(str.intValue());
                                stringBuilder.append("    ");
                                stringBuilder.append(name);
                                stringBuilder.append(" = \"");
                                stringBuilder.append(stringId == null ? str : stringId);
                                stringBuilder.append("\"\n");
                            }
        ...
        void fillFromAttributeList(Context context, AttributeSet attrs) {
            ...
            for (int i = 0; i < N; i++) {
                ...
                switch (mapToConstant.get(attr)) {
                    ...
                    case 12:
                        this.transformPivotTarget = ConstraintSet.access$100(a, attr, this.transformPivotTarget);
                        break;
                }
            }
            a.recycle();
            ...
            for (int i = 0; i < N; i++) {
                ...
                switch (mapToConstant.get(attr)) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        this.mAnimateRelativeTo = ConstraintSet.access$100(a, attr, this.mAnimateRelativeTo);
                        break;
                    case 6:
    ...
    public static class Constraint {
        ...
        static /* synthetic */ void access$000(Constraint x0, int x1, ConstraintLayout.LayoutParams x2) {
            x0.fillFrom(x1, x2);
        }

        static /* synthetic */ void access$1000(Constraint x0, String x1, int x2) {
            x0.setColorValue(x1, x2);
        }

        static /* synthetic */ void access$1100(Constraint x0, String x1, float x2) {
            x0.setFloatValue(x1, x2);
        }

        static /* synthetic */ void access$1200(Constraint x0, String x1, String x2) {
            x0.setStringValue(x1, x2);
        }

        static /* synthetic */ void access$700(Constraint x0, ConstraintHelper x1, int x2, Constraints.LayoutParams x3) {
            x0.fillFromConstraints(x1, x2, x3);
        }

        static /* synthetic */ void access$800(Constraint x0, int x1, Constraints.LayoutParams x2) {
            x0.fillFromConstraints(x1, x2);
        }

        static /* synthetic */ void access$900(Constraint x0, String x1, int x2) {
            x0.setIntValue(x1, x2);
        }
        ...
        private ConstraintAttribute get(String attributeName, ConstraintAttribute.AttributeType attributeType) {
            if (this.mCustomConstraints.containsKey(attributeName)) {
                ConstraintAttribute ret = (ConstraintAttribute) this.mCustomConstraints.get(attributeName);
                if (ret.getType() != attributeType) {
                    String valueOf = String.valueOf(ret.getType().name());
    ...
    public void clone(ConstraintSet set) {
        ...
        for (Integer key : set.mConstraints.keySet()) {
            Constraint constraint = (Constraint) set.mConstraints.get(key);
            if (constraint != null) {
    ...
    public void clone(Constraints constraints) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            Constraints.LayoutParams param = view.getLayoutParams();
            int id = view.getId();
            if (this.mForceId && id == -1) {
                throw new RuntimeException("All children of ConstraintLayout must have ids to use ConstraintSet");
            }
            ...
            if (constraint != null) {
                if (view instanceof ConstraintHelper) {
                    ...
                    Constraint.access$700(constraint, helper, id, param);
                }
                Constraint.access$800(constraint, id, param);
            }
        }
    }
    ...
    public void applyCustomAttributes(ConstraintLayout constraintLayout) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            int id = view.getId();
            if (!this.mConstraints.containsKey(Integer.valueOf(id))) {
                String valueOf = String.valueOf(Debug.getName(view));
    ...
    public void applyToHelper(ConstraintHelper helper, ConstraintWidget child, ConstraintLayout.LayoutParams layoutParams, SparseArray mapIdToWidget) {
        Constraint constraint;
        int id = helper.getId();
        if (this.mConstraints.containsKey(Integer.valueOf(id)) && (constraint = (Constraint) this.mConstraints.get(Integer.valueOf(id))) != null && (child instanceof HelperWidget)) {
    ...
    public void center(int centerID, int firstID, int firstSide, int firstMargin, int secondId, int secondSide, int secondMargin, float bias) {
        ...
        if (firstSide == 6 || firstSide == 7) {
            ...
            Constraint constraint2 = (Constraint) this.mConstraints.get(Integer.valueOf(centerID));
            if (constraint2 != null) {
        ...
        Constraint constraint3 = (Constraint) this.mConstraints.get(Integer.valueOf(centerID));
        if (constraint3 != null) {
    ...
    public void clear(int viewId, int anchor) {
        Constraint constraint;
        if (!this.mConstraints.containsKey(Integer.valueOf(viewId)) || (constraint = (Constraint) this.mConstraints.get(Integer.valueOf(viewId))) == null) {
            return;
        }
        switch (anchor) {
            case 1:
    ...
    public void setIntValue(int viewId, String attributeName, int value) {
        Constraint.access$900(get(viewId), attributeName, value);
    }

    public void setColorValue(int viewId, String attributeName, int value) {
        Constraint.access$1000(get(viewId), attributeName, value);
    }

    public void setFloatValue(int viewId, String attributeName, float value) {
        Constraint.access$1100(get(viewId), attributeName, value);
    }

    public void setStringValue(int viewId, String attributeName, String value) {
        Constraint.access$1200(get(viewId), attributeName, value);
    }
    ...
    private void addAttributes(ConstraintAttribute.AttributeType attributeType, String... attributeName) {
        for (int i = 0; i < attributeName.length; i++) {
            if (this.mSavedAttributes.containsKey(attributeName[i])) {
                ConstraintAttribute constraintAttribute = (ConstraintAttribute) this.mSavedAttributes.get(attributeName[i]);
    ...
    public void parseIntAttributes(Constraint set, String attributes) {
        ...
        for (int i = 0; i < sp.length; i++) {
            ...
            if (attr.length != 2) {
                String valueOf = String.valueOf(sp[i]);
                Log.w("ConstraintSet", valueOf.length() != 0 ? " Unable to parse ".concat(valueOf) : new String(" Unable to parse "));
            } else {
                Constraint.access$1100(set, attr[0], Integer.decode(attr[1]).intValue());
            }
        }
    }
    ...
    public void parseColorAttributes(Constraint set, String attributes) {
        ...
        for (int i = 0; i < sp.length; i++) {
            ...
            if (attr.length != 2) {
                ...
                Constraint.access$1000(set, attr[0], Color.parseColor(attr[1]));
            }
        }
    }
    ...
    public void parseFloatAttributes(Constraint set, String attributes) {
        ...
        for (int i = 0; i < sp.length; i++) {
            ...
            if (attr.length != 2) {
                ...
                Constraint.access$1100(set, attr[0], Float.parseFloat(attr[1]));
            }
        }
    }
    ...
    public void parseStringAttributes(Constraint set, String attributes) {
        ...
        for (int i = 0; i < sp.length; i++) {
            ...
            String valueOf = String.valueOf(sp[i]);
            Log.w("ConstraintSet", valueOf.length() != 0 ? " Unable to parse ".concat(valueOf) : new String(" Unable to parse "));
            Constraint.access$1200(set, attr[0], attr[1]);
        }
    }
            ...
            for (int eventType = xml.getEventType(); eventType != 1; eventType = xml.next()) {
                switch (eventType) {
                    ...
                    case 2:
                        ...
                        Constraint constraint = fillFromAttributeList(context, Xml.asAttributeSet(xml), false);
    ...
    */
    ...
    static String getDebugName(int v) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (field.getName().contains("_") && field.getType() == Integer.TYPE && Modifier.isStatic(field.getModifiers()) && Modifier.isFinal(field.getModifiers())) {
                try {
                    int val = field.getInt((Object) null);
                    if (val == v) {
    ...
    class WriteXmlEngine {
        ...
        void writeLayout() throws IOException {
            this.writer.write("\n<ConstraintSet>\n");
            for (Integer id : ConstraintSet.access$1300(ConstraintSet.this).keySet()) {
                Constraint c = (Constraint) ConstraintSet.access$1300(ConstraintSet.this).get(id);
                String idName = getName(id.intValue());
                this.writer.write("  <Constraint");
                Writer writer = this.writer;
                StringBuilder sb = new StringBuilder(String.valueOf(idName).length() + 21);
                sb.append("\n       android:id=\"");
                sb.append(idName);
                sb.append("\"");
        ...
        String getName(int id) {
            if (this.idMap.containsKey(Integer.valueOf(id))) {
                String str = (String) this.idMap.get(Integer.valueOf(id));
        ...
        void writeConstraint(String my, int leftToLeft, String other, int margin, int goneMargin) throws IOException {
            ...
            Writer writer = this.writer;
            String valueOf = String.valueOf("\n       ");
            String valueOf2 = String.valueOf(my);
            writer.write(valueOf2.length() != 0 ? valueOf.concat(valueOf2) : new String(valueOf));
            this.writer.write(":[");
        ...
        void writeVariable(String name, int[] value) throws IOException {
            ...
            while (i < value.length) {
                Writer writer2 = this.writer;
                String valueOf3 = String.valueOf(i == 0 ? "[" : ", ");
                String valueOf4 = String.valueOf(getName(value[i]));
    ...
    class WriteJsonEngine {
        ...
        void writeLayout() throws IOException {
            ...
            for (Integer id : ConstraintSet.access$1300(ConstraintSet.this).keySet()) {
                Constraint c = (Constraint) ConstraintSet.access$1300(ConstraintSet.this).get(id);
                String idName = getName(id.intValue());
                this.writer.write(String.valueOf(idName).concat(":{\n"));
                Layout l = c.layout;
        ...
        private void writeDimension(String dimString, int dim, int dimDefault, float dimPercent, int dimMin, int dimMax, boolean constrainedDim) throws IOException {
            if (dim == 0) {
                if (dimMax != -1 || dimMin != -1) {
                    switch (dimDefault) {
                        case 0:
                            Writer writer = this.writer;
                            StringBuilder sb = new StringBuilder(String.valueOf(dimString).length() + 46);
                            sb.append("       ");
                            sb.append(dimString);
                            sb.append(": {'spread' ,");
                            sb.append(dimMin);
                        ...
                        case 1:
                            Writer writer2 = this.writer;
                            StringBuilder sb2 = new StringBuilder(String.valueOf(dimString).length() + 44);
                            sb2.append("       ");
                            sb2.append(dimString);
                            sb2.append(": {'wrap' ,");
                            sb2.append(dimMin);
                        ...
                        case 2:
                            Writer writer3 = this.writer;
                            StringBuilder sb3 = new StringBuilder(String.valueOf(dimString).length() + 56);
                            sb3.append("       ");
                            sb3.append(dimString);
                            sb3.append(": {'");
                            sb3.append(dimPercent);
                            sb3.append("'% ,");
                            sb3.append(dimMin);
                            sb3.append(", ");
                            sb3.append(dimMax);
            ...
            if (dim == -2) {
                ...
                StringBuilder sb6 = new StringBuilder(String.valueOf(dimString).length() + 16);
                sb6.append("       ");
            ...
            if (dim == -1) {
                ...
                StringBuilder sb7 = new StringBuilder(String.valueOf(dimString).length() + 18);
                sb7.append("       ");
            ...
            StringBuilder sb8 = new StringBuilder(String.valueOf(dimString).length() + 22);
            sb8.append("       ");
        ...
        String getName(int id) {
            ...
            String name = lookup(id);
            this.idMap.put(Integer.valueOf(id), name);
            StringBuilder sb2 = new StringBuilder(String.valueOf(name).length() + 2);
            sb2.append("'");
            sb2.append(name);
            sb2.append("'");
            return sb2.toString();
        ...
        void writeVariable(String name, String value) throws IOException {
            ...
            writer2.write(valueOf3.length() != 0 ? ", ".concat(valueOf3) : new String(", "));
            this.writer.write("\n");
        }
    }
}
