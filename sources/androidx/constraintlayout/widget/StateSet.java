    ...
    */
    private void load(android.content.Context r12, org.xmlpull.v1.XmlPullParser r13) {
        ...
        L88:
            ...
            r7.<init>(r12, r13)     // Catch: java.io.IOException -> La6 org.xmlpull.v1.XmlPullParserException -> Lab
            r5 = r7
            android.util.SparseArray r7 = r11.mStateList     // Catch: java.io.IOException -> La6 org.xmlpull.v1.XmlPullParserException -> Lab
    ...
    public int convertToConstraintSet(int currentConstrainSettId, int stateId, float width, float height) {
        ...
        if (width == -1.0f || height == -1.0f) {
            ...
            while (it.hasNext()) {
                if (currentConstrainSettId == ((Variant) it.next()).mConstraintID) {
                    return currentConstrainSettId;
                }
            }
        ...
        while (it2.hasNext()) {
            Variant mVariant = (Variant) it2.next();
    ...
    public int updateConstraints(int currentId, int id, float width, float height) {
        ...
        if (currentId == id) {
            ...
            if (this.mCurrentConstraintNumber != -1 && ((Variant) state.mVariants.get(currentId)).match(width, height)) {
                return currentId;
            }
            ...
            return match == -1 ? state.mConstraintID : ((Variant) state.mVariants.get(match)).mConstraintID;
        }
        ...
        return match2 == -1 ? state2.mConstraintID : ((Variant) state2.mVariants.get(match2)).mConstraintID;
    }
