...
public class ConstraintLayout extends ViewGroup {
    ...
    static /* synthetic */ int access$000(ConstraintLayout x0) {
        return x0.mOptimizationLevel;
    }

    static /* synthetic */ ArrayList access$100(ConstraintLayout x0) {
        return x0.mConstraintHelpers;
    }
    ...
    class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget widget, BasicMeasure.Measure measure) {
            ...
            switch (1.$SwitchMap$androidx$constraintlayout$core$widgets$ConstraintWidget$DimensionBehaviour[horizontalBehavior.ordinal()]) {
                case 1:
            ...
            switch (1.$SwitchMap$androidx$constraintlayout$core$widgets$ConstraintWidget$DimensionBehaviour[verticalBehavior.ordinal()]) {
                case 1:
                ...
                case 4:
                    ...
                    if (measure.measureStrategy == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                        boolean otherDimensionStable2 = child.getMeasuredWidth() == widget.getWidth();
                        boolean useCurrent2 = measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !shouldDoWrap2 || (shouldDoWrap2 && otherDimensionStable2) || (child instanceof Placeholder) || widget.isResolvedVertically();
                        if (!useCurrent2) {
                            break;
                        } else {
            ...
            ConstraintWidgetContainer container = widget.getParent();
            if (container != null && Optimizer.enabled(ConstraintLayout.access$000(ConstraintLayout.this), 256) && child.getMeasuredWidth() == widget.getWidth() && child.getMeasuredWidth() < container.getWidth() && child.getMeasuredHeight() == widget.getHeight() && child.getMeasuredHeight() < container.getHeight() && child.getBaseline() == widget.getBaselineDistance() && !widget.isMeasureRequested()) {
                boolean similar = isSimilarSpec(widget.getLastHorizontalMeasureSpec(), horizontalSpec2, widget.getWidth()) && isSimilarSpec(widget.getLastVerticalMeasureSpec(), verticalSpec4, widget.getHeight());
                if (similar) {
            ...
            if (verticalDimension2 != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && measure.measureStrategy != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && horizontalMatchConstraints && widget.mMatchConstraintDefaultWidth == 0 && verticalMatchConstraints && widget.mMatchConstraintDefaultHeight == 0) {
                ...
                boolean optimizeDirect = Optimizer.enabled(ConstraintLayout.access$000(ConstraintLayout.this), 1);
                if (!optimizeDirect) {
            ...
            measure.measuredNeedsSolverPass = (verticalSpec3 == measure.horizontalDimension && widthPadding == measure.verticalDimension) ? false : true;
        ...
        public final void didMeasures() {
            ...
            int helperCount = ConstraintLayout.access$100(this.layout).size();
            if (helperCount > 0) {
                for (int i2 = 0; i2 < helperCount; i2++) {
                    ConstraintHelper helper = (ConstraintHelper) ConstraintLayout.access$100(this.layout).get(i2);
    ...
    public void onViewAdded(View view) {
        ...
        if ((view instanceof Guideline) && !(widget instanceof androidx.constraintlayout.core.widgets.Guideline)) {
            ...
            layoutParams.widget.setOrientation(layoutParams.orientation);
        }
    ...
    private void setChildrenConstraints() {
        ...
        if (helperCount > 0) {
            for (int i5 = 0; i5 < helperCount; i5++) {
                ConstraintHelper helper = (ConstraintHelper) this.mConstraintHelpers.get(i5);
        ...
        for (int i7 = 0; i7 < count; i7++) {
            ...
            this.mTempMapIdToWidget.put(child2.getId(), getViewWidget(child2));
        }
        for (int i8 = 0; i8 < count; i8++) {
            ...
            if (widget2 != null) {
                ...
                applyConstraintsFromLayoutParams(isInEditMode, child3, widget2, layoutParams, this.mTempMapIdToWidget);
            }
        }
    }
    ...
    */
    protected void applyConstraintsFromLayoutParams(boolean r22, android.view.View r23, androidx.constraintlayout.core.widgets.ConstraintWidget r24, androidx.constraintlayout.widget.ConstraintLayout.LayoutParams r25, android.util.SparseArray r26) {
        /*
    ...
    private void setWidgetBaseline(ConstraintWidget widget, LayoutParams layoutParams, SparseArray idToWidget, int baselineTarget, ConstraintAnchor.Type type) {
        View view = (View) this.mChildrenByIds.get(baselineTarget);
        ConstraintWidget target = (ConstraintWidget) idToWidget.get(baselineTarget);
        if (target != null && view != null && (view.getLayoutParams() instanceof LayoutParams)) {
            layoutParams.needsBaseline = true;
            if (type == ConstraintAnchor.Type.BASELINE) {
                LayoutParams targetParams = view.getLayoutParams();
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (helperCount > 0) {
            for (int i2 = 0; i2 < helperCount; i2++) {
                ConstraintHelper helper = (ConstraintHelper) this.mConstraintHelpers.get(i2);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (arrayList != null && (helperCount = arrayList.size()) > 0) {
            for (int i = 0; i < helperCount; i++) {
                ConstraintHelper helper = (ConstraintHelper) constraintLayout.mConstraintHelpers.get(i);
