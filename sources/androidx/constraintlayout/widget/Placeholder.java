...
public class Placeholder extends View {
    ...
    public void updatePreLayout(ConstraintLayout container) {
        ...
        if (findViewById != null) {
            ConstraintLayout.LayoutParams layoutParamsContent = findViewById.getLayoutParams();
    ...
    public void setContentId(int id) {
        ...
        if (view != null) {
            ...
            ConstraintLayout.LayoutParams layoutParamsContent = this.mContent.getLayoutParams();
            layoutParamsContent.isInPlaceholder = false;
            this.mContent = null;
        }
        this.mContentId = id;
        if (id != -1 && (v = getParent().findViewById(id)) != null) {
            v.setVisibility(8);
        }
    }
