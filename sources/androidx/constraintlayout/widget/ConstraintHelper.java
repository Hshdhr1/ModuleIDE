...
public abstract class ConstraintHelper extends View {
    ...
    public void validateParams() {
        ...
        if (layoutParams instanceof ConstraintLayout.LayoutParams) {
            ...
            layoutParams2.widget = this.mHelperWidget;
        }
    }
    ...
    private void addID(String idString) {
        ...
        StringBuilder sb = new StringBuilder(String.valueOf(idString2).length() + 23);
    ...
    private void addTag(String tagString) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            ConstraintLayout.LayoutParams layoutParams = v.getLayoutParams();
            if (layoutParams instanceof ConstraintLayout.LayoutParams) {
                ConstraintLayout.LayoutParams lp = layoutParams;
    ...
    public void updatePreLayout(ConstraintLayout container) {
        ...
        for (int i = 0; i < this.mCount; i++) {
            int id = this.mIds[i];
            View view = container.getViewById(id);
            if (view == null && (foundId = findId(container, (candidate = (String) this.mMap.get(Integer.valueOf(id))))) != 0) {
                this.mIds[i] = foundId;
    ...
    public void loadParameters(ConstraintSet.Constraint constraint, HelperWidget child, ConstraintLayout.LayoutParams layoutParams, SparseArray mapIdToWidget) {
        ...
        if (child != null) {
            ...
            if (constraint.layout.mReferenceIds != null) {
                for (int i = 0; i < constraint.layout.mReferenceIds.length; i++) {
                    ...
                    ConstraintWidget widget = (ConstraintWidget) mapIdToWidget.get(id);
                    if (widget != null) {
                        child.add(widget);
                    }
                }
