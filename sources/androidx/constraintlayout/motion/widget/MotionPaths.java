...
class MotionPaths implements Comparable {
    ...
    void getCenter(double p, int[] toUse, double[] data, float[] point, double[] vdata, float[] velocity) {
        ...
        if (motionController == null) {
            ...
            double d12 = dangle2;
            Double.isNaN(d12);
            float dpos_x = (float) (d11 + (cos2 * d12));
            double d13 = v_x3;
            double d14 = dradius;
    ...
    */
    void setView(float r36, android.view.View r37, int[] r38, double[] r39, double[] r40, double[] r41, boolean r42) {
        /*
    ...
    void getRect(int[] toUse, double[] data, float[] path, int offset) {
        ...
        while (true) {
            ...
            if (i < toUse.length) {
                ...
                if (angle != 0.0f) {
                    float v_x2 = angle;
                    float sin2 = (float) Math.sin(Math.toRadians(v_x2));
                    float cos2 = (float) Math.cos(Math.toRadians(v_x2));
                    float f = cx;
                    float f2 = cy;
                    float f3 = x1;
                    float f4 = y1;
                    float tx1 = xRotate(sin2, cos2, f, f2, f3, f4);
                    float ty1 = yRotate(sin2, cos2, f, f2, f3, f4);
                    float f5 = x2;
                    float f6 = y2;
                    float tx2 = xRotate(sin2, cos2, f, f2, f5, f6);
                    float ty2 = yRotate(sin2, cos2, f, f2, f5, f6);
                    float f7 = x3;
                    float f8 = y3;
                    float tx3 = xRotate(sin2, cos2, f, f2, f7, f8);
                    float ty3 = yRotate(sin2, cos2, f, f2, f7, f8);
                    float f9 = x4;
                    float f10 = y4;
                    float tx4 = xRotate(sin2, cos2, f, f2, f9, f10);
                    float ty4 = yRotate(sin2, cos2, f, f2, f9, f10);
                    x1 = tx1;
                    y1 = ty1;
                    x2 = tx2;
                    y2 = ty2;
    ...
    int getCustomDataCount(String name) {
        ConstraintAttribute a = (ConstraintAttribute) this.attributes.get(name);
        if (a == null) {
            return 0;
        }
    ...
    public void applyParameters(ConstraintSet.Constraint c) {
        ...
        for (String s : at) {
            ConstraintAttribute attr = (ConstraintAttribute) c.mCustomConstraints.get(s);
