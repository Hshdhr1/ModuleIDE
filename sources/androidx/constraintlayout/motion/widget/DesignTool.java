...
public class DesignTool implements ProxyInterface {
    ...
    private static void Connect(int dpi, ConstraintSet set, View view, HashMap attributes, int from, int to) {
        String connection = (String) allAttributes.get(Pair.create(Integer.valueOf(from), Integer.valueOf(to)));
        String connectionValue = (String) attributes.get(connection);
        if (connectionValue != null) {
            int marginValue = 0;
            String margin = (String) allMargins.get(connection);
            if (margin != null) {
                marginValue = GetPxFromDp(dpi, (String) attributes.get(margin));
            }
    ...
    private static void SetBias(ConstraintSet set, View view, HashMap attributes, int type) {
        String bias = "layout_constraintHorizontal_bias";
        if (type == 1) {
            bias = "layout_constraintVertical_bias";
        }
        String biasValue = (String) attributes.get(bias);
        if (biasValue != null) {
            if (type == 0) {
    ...
    private static void SetDimensions(int dpi, ConstraintSet set, View view, HashMap attributes, int type) {
        String dimension = "layout_width";
        if (type == 1) {
            dimension = "layout_height";
        }
        String dimensionValue = (String) attributes.get(dimension);
    ...
    private static void SetAbsolutePositions(int dpi, ConstraintSet set, View view, HashMap attributes) {
        String absoluteX = (String) attributes.get("layout_editor_absoluteX");
        if (absoluteX != null) {
            set.setEditorAbsoluteX(view.getId(), GetPxFromDp(dpi, absoluteX));
        }
        String absoluteY = (String) attributes.get("layout_editor_absoluteY");
        if (absoluteY != null) {
    ...
    public int getKeyFramePositions(Object view, int[] type, float[] pos) {
        MotionController controller = (MotionController) this.mMotionLayout.mFrameArrayList.get((View) view);
        if (controller == null) {
            return 0;
        }
    ...
    public float getKeyFramePosition(Object view, int type, float x, float y) {
        MotionController mc;
        if ((view instanceof View) && (mc = (MotionController) this.mMotionLayout.mFrameArrayList.get((View) view)) != null) {
    ...
    public void setViewDebug(Object view, int debugMode) {
        ...
        if ((view instanceof View) && (motionController = (MotionController) this.mMotionLayout.mFrameArrayList.get(view)) != null) {
    ...
    public int designAccess(int cmd, String type, Object viewObject, float[] in, int inLength, float[] out, int outLength) {
        ...
        if (cmd != 0 && (this.mMotionLayout.mScene == null || view == null || (motionController = (MotionController) this.mMotionLayout.mFrameArrayList.get(view)) == null)) {
            return -1;
        }
        switch (cmd) {
            case 1:
    ...
    public Object getKeyframeAtLocation(Object viewObject, float x, float y) {
        ...
        if (view == null || (motionController = (MotionController) this.mMotionLayout.mFrameArrayList.get(view)) == null) {
            return null;
        }
    ...
    public Boolean getPositionKeyframe(Object keyFrame, Object view, float x, float y, String[] attribute, float[] value) {
        if (keyFrame instanceof KeyPositionBase) {
            ...
            MotionController motionController = (MotionController) this.mMotionLayout.mFrameArrayList.get((View) view);
    ...
    public void dumpConstraintSet(String set) {
        ...
        StringBuilder sb = new StringBuilder(String.valueOf(set).length() + 24);
        sb.append(" dumping  ");
        sb.append(set);
        sb.append(" (");
        sb.append(setId);
