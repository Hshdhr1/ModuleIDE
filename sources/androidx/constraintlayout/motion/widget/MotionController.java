...
public class MotionController {
    ...
    void buildPath(float[] points, int pointCount) {
        ...
        HashMap hashMap3 = motionController.mCycleMap;
        ViewOscillator osc_x = hashMap3 == null ? null : (ViewOscillator) hashMap3.get("translationX");
        HashMap hashMap4 = motionController.mCycleMap;
        ViewOscillator osc_y = hashMap4 != null ? (ViewOscillator) hashMap4.get("translationY") : null;
        int i = 0;
        while (i < pointCount) {
            ...
            Iterator it = motionController.mMotionPaths.iterator();
            float start = 0.0f;
    ...
    public void setup(int parentWidth, int parentHeight, float transitionDuration, long currentTime) {
                ...
                if (attribute2.startsWith("CUSTOM,")) {
                    ...
                    while (it5.hasNext()) {
                        ...
                        if (key2.mCustomConstraints != null) {
                            ConstraintAttribute customAttribute = (ConstraintAttribute) key2.mCustomConstraints.get(customAttributeName);
        ...
        if (!timeCycleAttributes2.isEmpty()) {
            ...
            Iterator it7 = timeCycleAttributes2.iterator();
            while (it7.hasNext()) {
                String attribute3 = (String) it7.next();
                    ...
                    if (attribute3.startsWith("CUSTOM,")) {
                        ...
                        while (it8.hasNext()) {
                            ...
                            if (key4.mCustomConstraints != null) {
                                ConstraintAttribute customAttribute2 = (ConstraintAttribute) key4.mCustomConstraints.get(customAttributeName2);
            ...
            for (String spline2 : this.mTimeCycleAttributesMap.keySet()) {
                ...
                ((ViewTimeCycle) this.mTimeCycleAttributesMap.get(spline2)).setup(curve2);
            }
        }
        ...
        while (it10.hasNext()) {
            MotionPaths point = (MotionPaths) it10.next();
            points[count] = point;
            count++;
        }
        int variables = 18;
        ...
        for (String s : this.mEndMotionPath.attributes.keySet()) {
            if (this.mStartMotionPath.attributes.containsKey(s)) {
                ...
                if (!splineAttributes.contains(valueOf.length() != 0 ? "CUSTOM,".concat(valueOf) : new String("CUSTOM,"))) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (!points[j].attributes.containsKey(attributeName) || (attribute = (ConstraintAttribute) points[j].attributes.get(attributeName)) == null) {
                    j++;
        ...
        double[][] splineData = (double[][]) Array.newInstance(double.class, new int[]{i5, this.mInterpolateVariables.length});
        ...
        while (true) {
            ...
            if (interpolateVariable < MotionPaths.names.length) {
                String s2 = String.valueOf(MotionPaths.names[this.mInterpolateVariables[j2]]).concat(" [");
                int i7 = 0;
                while (true) {
                    int interpolateVariable2 = interpolateVariable;
                    if (i7 < points.length) {
                        String valueOf2 = String.valueOf(s2);
                        int variables2 = variables;
                        double d = splineData[i7][j2];
                        StringBuilder sb = new StringBuilder(String.valueOf(valueOf2).length() + 24);
                        sb.append(valueOf2);
                        sb.append(d);
                        s2 = sb.toString();
                        i7++;
                        interpolateVariable = interpolateVariable2;
        ...
        if (this.mKeyList != null) {
            Iterator it11 = cycleAttributes.iterator();
            while (it11.hasNext()) {
                String attribute4 = (String) it11.next();
            ...
            while (it13.hasNext()) {
                ((ViewOscillator) it13.next()).setup(distance);
            }
        }
    }
    ...
    */
    ...
    void getPostLayoutDvDp(float position, int width, int height, float locationX, float locationY, float[] mAnchorDpDt) {
        ...
        SplineSet rotation = hashMap3 == null ? null : (SplineSet) hashMap3.get("rotation");
        ...
        ViewOscillator osc_x = hashMap6 == null ? null : (ViewOscillator) hashMap6.get("translationX");
        HashMap hashMap7 = this.mCycleMap;
        ViewOscillator osc_y = hashMap7 == null ? null : (ViewOscillator) hashMap7.get("translationY");
        HashMap hashMap8 = this.mCycleMap;
        ViewOscillator osc_r = hashMap8 == null ? null : (ViewOscillator) hashMap8.get("rotation");
        HashMap hashMap9 = this.mCycleMap;
        ViewOscillator osc_sx = hashMap9 == null ? null : (ViewOscillator) hashMap9.get("scaleX");
        HashMap hashMap10 = this.mCycleMap;
        ViewOscillator osc_sy = hashMap10 != null ? (ViewOscillator) hashMap10.get("scaleY") : null;
