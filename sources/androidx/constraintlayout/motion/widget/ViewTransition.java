...
public class ViewTransition {
    ...
    Interpolator getInterpolator(Context context) {
        switch (this.mDefaultInterpolator) {
            ...
            case -1:
                Easing easing = Easing.getInterpolator(this.mDefaultInterpolatorString);
    ...
    class 1 implements Interpolator {
        ...
        1(final ViewTransition this$0, final Easing val$easing) {
    ...
    */
    ...
    void applyTransition(ViewTransitionController controller, MotionLayout layout, int fromId, ConstraintSet current, View... views) {
        if (this.mDisabled) {
            return;
        }
    ...
    boolean matchesView(View view) {
        ...
        return (lp instanceof ConstraintLayout.LayoutParams) && (tag = view.getLayoutParams().constraintTag) != null && tag.matches(this.mTargetString);
    }
