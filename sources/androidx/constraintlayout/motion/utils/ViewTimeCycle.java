...
public abstract class ViewTimeCycle extends TimeCycleSplineSet {
    ...
    public static ViewTimeCycle makeCustomSpline(String str, SparseArray attrList) {
    ...
    */
    ...
    public static class CustomSet extends ViewTimeCycle {
        ...
        public CustomSet(String attribute, SparseArray attrList) {
        ...
        public void setup(int curveType) {
            ...
            double[][] values = (double[][]) Array.newInstance(double.class, new int[]{size, dimensionality + 2});
    ...
    static class ProgressSet extends ViewTimeCycle {
        ...
        public boolean setProperty(View view, float t, long time, KeyCache cache) {
            ...
            if (view instanceof MotionLayout) {
                ...
                try {
                    Method method2 = view.getClass().getMethod("setProgress", new Class[]{Float.TYPE});
                    method = method2;
