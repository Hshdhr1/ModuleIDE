...
public class MotionButton extends AppCompatButton {
    ...
    static /* synthetic */ float access$000(MotionButton x0) {
        return x0.mRoundPercent;
    }

    static /* synthetic */ float access$100(MotionButton x0) {
        return x0.mRound;
    }
    ...
    class 1 extends ViewOutlineProvider {
        ...
        public void getOutline(View view, Outline outline) {
            ...
            float r = (Math.min(w, h) * MotionButton.access$000(MotionButton.this)) / 2.0f;
    ...
    class 2 extends ViewOutlineProvider {
        ...
        public void getOutline(View view, Outline outline) {
            int w = MotionButton.this.getWidth();
            int h = MotionButton.this.getHeight();
            outline.setRoundRect(0, 0, w, h, MotionButton.access$100(MotionButton.this));
        }
    }
