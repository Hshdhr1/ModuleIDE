...
public class ImageFilterView extends AppCompatImageView {
    ...
    static /* synthetic */ float access$000(ImageFilterView x0) {
        return x0.mRoundPercent;
    }

    static /* synthetic */ float access$100(ImageFilterView x0) {
        return x0.mRound;
    }
    ...
    class 1 extends ViewOutlineProvider {
        ...
        public void getOutline(View view, Outline outline) {
            ...
            float r = (Math.min(w, h) * ImageFilterView.access$000(ImageFilterView.this)) / 2.0f;
    ...
    class 2 extends ViewOutlineProvider {
        ...
        public void getOutline(View view, Outline outline) {
            int w = ImageFilterView.this.getWidth();
            int h = ImageFilterView.this.getHeight();
            outline.setRoundRect(0, 0, w, h, ImageFilterView.access$100(ImageFilterView.this));
        }
    }
