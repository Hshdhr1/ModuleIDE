...
public class MotionLabel extends View implements FloatLayout {
    ...
    static /* synthetic */ float access$000(MotionLabel x0) {
        return x0.mRoundPercent;
    }

    static /* synthetic */ float access$100(MotionLabel x0) {
        return x0.mRound;
    }
    ...
    private void setTypefaceFromAttrs(String familyName, int typefaceIndex, int styleIndex) {
        ...
        if (styleIndex > 0) {
            ...
            int need = (typefaceStyle ^ (-1)) & styleIndex;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != 1073741824 || heightMode != 1073741824) {
            ...
            if (heightMode != 1073741824) {
                int desired = (int) (this.mPaint.getFontMetricsInt((Paint.FontMetricsInt) null) + 0.99999f);
    ...
    class 1 extends ViewOutlineProvider {
        1() {
        }
        ...
        public void getOutline(View view, Outline outline) {
            ...
            float r = (Math.min(w, h) * MotionLabel.access$000(MotionLabel.this)) / 2.0f;
    ...
    class 2 extends ViewOutlineProvider {
        2() {
        }
        ...
        public void getOutline(View view, Outline outline) {
            int w = MotionLabel.this.getWidth();
            int h = MotionLabel.this.getHeight();
            outline.setRoundRect(0, 0, w, h, MotionLabel.access$100(MotionLabel.this));
        }
    }
