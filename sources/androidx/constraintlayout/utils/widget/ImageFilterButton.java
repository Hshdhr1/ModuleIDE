...
public class ImageFilterButton extends AppCompatImageButton {
    ...
    static /* synthetic */ float access$000(ImageFilterButton x0) {
        return x0.mRoundPercent;
    }

    static /* synthetic */ float access$100(ImageFilterButton x0) {
        return x0.mRound;
    }
    ...
    class 1 extends ViewOutlineProvider {
        ...
        public void getOutline(View view, Outline outline) {
            ...
            float r = (Math.min(w, h) * ImageFilterButton.access$000(ImageFilterButton.this)) / 2.0f;
    ...
    class 2 extends ViewOutlineProvider {
        ...
        public void getOutline(View view, Outline outline) {
            int w = ImageFilterButton.this.getWidth();
            int h = ImageFilterButton.this.getHeight();
            outline.setRoundRect(0, 0, w, h, ImageFilterButton.access$100(ImageFilterButton.this));
        }
    }
