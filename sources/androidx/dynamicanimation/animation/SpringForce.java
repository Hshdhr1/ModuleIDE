...
public final class SpringForce implements Force {
    ...
    public float getAcceleration(float f, float f2) {
        return (float) (((-(this.mNaturalFreq * this.mNaturalFreq)) * (f - getFinalPosition())) - (((2.0d * this.mNaturalFreq) * this.mDampingRatio) * f2));
    }
    ...
    DynamicAnimation.MassState updateValues(double d, double d2, long j) {
        ...
        if (this.mDampingRatio > 1.0d) {
            ...
            pow = (d5 * Math.pow(2.718281828459045d, this.mGammaMinus * d3)) + (d6 * Math.pow(2.718281828459045d, this.mGammaPlus * d3));
            ...
            double d7 = (1.0d / this.mDampedFreq) * ((this.mDampingRatio * this.mNaturalFreq * d4) + d2);
            pow = Math.pow(2.718281828459045d, (-this.mDampingRatio) * this.mNaturalFreq * d3) * ((d4 * Math.cos(this.mDampedFreq * d3)) + (d7 * Math.sin(this.mDampedFreq * d3)));
            pow2 = (pow * (-this.mNaturalFreq) * this.mDampingRatio) + (Math.pow(2.718281828459045d, (-this.mDampingRatio) * this.mNaturalFreq * d3) * (((-this.mDampedFreq) * d4 * Math.sin(this.mDampedFreq * d3)) + (this.mDampedFreq * d7 * Math.cos(this.mDampedFreq * d3))));
        } else {
            double d8 = d2 + (this.mNaturalFreq * d4);
            pow = (d4 + (d8 * d3)) * Math.pow(2.718281828459045d, (-this.mNaturalFreq) * d3);
            pow2 = ((d4 + (d8 * d3)) * Math.pow(2.718281828459045d, (-this.mNaturalFreq) * d3) * (-this.mNaturalFreq)) + (d8 * Math.pow(2.718281828459045d, (-this.mNaturalFreq) * d3));
        }
