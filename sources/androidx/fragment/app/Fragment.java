...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    private static abstract class OnPreAttachedListener {
        ...
        /* synthetic */ OnPreAttachedListener(1 x0) {
            this();
        }
    }
    ...
    public Fragment() {
        ...
        this.mPostponedDurationRunnable = new 1();
    ...
    public static Fragment instantiate(Context context, String fname, Bundle args) {
        try {
            ...
            throw new InstantiationException("Unable to instantiate fragment " + fname + ": calling Fragment constructor caused an exception", e2);
            ...
            throw new InstantiationException("Unable to instantiate fragment " + fname + ": make sure class name exists, is public, and has an empty constructor that is public", e4);
        }
    }
    ...
    public void startPostponedEnterTransition() {
        ...
        if (this.mHost == null) {
            ...
            this.mHost.getHandler().postAtFrontOfQueue(new 2());
        } else {
    ...
    void callStartTransitionListener(boolean calledDirectly) {
        ...
        if (FragmentManager.USE_STATE_MANAGER && this.mView != null && (viewGroup = this.mContainer) != null && (fragmentManager = this.mFragmentManager) != null) {
            SpecialEffectsController controller = SpecialEffectsController.getOrCreateController(viewGroup, fragmentManager);
            controller.markPostponedState();
            if (calledDirectly) {
                this.mHost.getHandler().post(new 3(controller));
            } else {
    ...
    class 3 implements Runnable {
        ...
        3(SpecialEffectsController specialEffectsController) {
    ...
    class 4 extends FragmentContainer {
        4() {
        }
    ...
    void performAttach() {
        ...
        while (it.hasNext()) {
            OnPreAttachedListener listener = (OnPreAttachedListener) it.next();
    ...
    void performCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 19) {
            this.mLifecycleRegistry.addObserver(new 5());
        }
    ...
    public final ActivityResultLauncher registerForActivityResult(ActivityResultContract activityResultContract, ActivityResultCallback activityResultCallback) {
        return prepareCallInternal(activityResultContract, new 6(), activityResultCallback);
    }

    class 7 implements Function {
        final /* synthetic */ ActivityResultRegistry val$registry;

        7(ActivityResultRegistry activityResultRegistry) {
    ...
    public final ActivityResultLauncher registerForActivityResult(ActivityResultContract activityResultContract, ActivityResultRegistry registry, ActivityResultCallback activityResultCallback) {
        return prepareCallInternal(activityResultContract, new 7(registry), activityResultCallback);
    }
    ...
    private ActivityResultLauncher prepareCallInternal(ActivityResultContract activityResultContract, Function function, ActivityResultCallback activityResultCallback) {
        ...
        registerOnPreAttachListener(new 8(function, atomicReference, activityResultContract, activityResultCallback));
        return new 9(atomicReference, activityResultContract);
    }

    class 8 extends OnPreAttachedListener {
        ...
        8(Function function, AtomicReference atomicReference, ActivityResultContract activityResultContract, ActivityResultCallback activityResultCallback) {
            super(null);
        ...
        void onPreAttached() {
            ...
            ActivityResultRegistry registry = (ActivityResultRegistry) this.val$registryProvider.apply((Object) null);
            this.val$ref.set(registry.register(key, Fragment.this, this.val$contract, this.val$callback));
        }
    }

    class 9 extends ActivityResultLauncher {
        final /* synthetic */ ActivityResultContract val$contract;
        final /* synthetic */ AtomicReference val$ref;

        9(AtomicReference atomicReference, ActivityResultContract activityResultContract) {
            this.val$ref = atomicReference;
            this.val$contract = activityResultContract;
        }

        public void launch(Object obj, ActivityOptionsCompat options) {
            ActivityResultLauncher activityResultLauncher = (ActivityResultLauncher) this.val$ref.get();
            if (activityResultLauncher == null) {
                throw new IllegalStateException("Operation cannot be started before fragment is in created state");
            }
            activityResultLauncher.launch(obj, options);
        }

        public void unregister() {
            ActivityResultLauncher activityResultLauncher = (ActivityResultLauncher) this.val$ref.getAndSet((Object) null);
            if (activityResultLauncher != null) {
