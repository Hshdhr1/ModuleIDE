...
class FragmentStateManager {
    ...
    void createView() {
        ...
        if (this.mFragment.mView != null) {
            ...
            if (ViewCompat.isAttachedToWindow(this.mFragment.mView)) {
                ...
                View fragmentView = this.mFragment.mView;
                fragmentView.addOnAttachStateChangeListener(new 1(fragmentView));
            }
            this.mFragment.performViewCreated();
            FragmentLifecycleCallbacksDispatcher fragmentLifecycleCallbacksDispatcher = this.mDispatcher;
            Fragment fragment3 = this.mFragment;
    ...
    private Bundle saveBasicState() {
        ...
        if (this.mFragment.mSavedViewRegistryState != null) {
            ...
            result.putBundle("android:view_registry_state", this.mFragment.mSavedViewRegistryState);
        }
        if (!this.mFragment.mUserVisibleHint) {
            if (result == null) {
                result = new Bundle();
    ...
    void destroy() {
        ...
        if (shouldDestroy) {
            ...
            if (host instanceof ViewModelStoreOwner) {
                ...
                Activity activity = host.getContext();
