...
public abstract class FragmentTransaction {
    ...
    private Fragment createFragment(Class cls, Bundle args) {
        ...
        Fragment fragment = fragmentFactory.instantiate(classLoader, cls.getName());
        if (args != null) {
    ...
    public final FragmentTransaction add(Class cls, Bundle args, String tag) {
        return add(createFragment(cls, args), tag);
    }
    ...
    public final FragmentTransaction add(int containerViewId, Class cls, Bundle args) {
        return add(containerViewId, createFragment(cls, args));
    }
    ...
    public final FragmentTransaction add(int containerViewId, Class cls, Bundle args, String tag) {
        return add(containerViewId, createFragment(cls, args), tag);
    }
    ...
    public final FragmentTransaction replace(int containerViewId, Class cls, Bundle args) {
        return replace(containerViewId, cls, args, null);
    }
    ...
    public final FragmentTransaction replace(int containerViewId, Class cls, Bundle args, String tag) {
        return replace(containerViewId, createFragment(cls, args), tag);
    }
