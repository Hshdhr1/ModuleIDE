...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    boolean interactsWith(ArrayList arrayList, int startIndex, int endIndex) {
    ...
    Fragment expandOps(ArrayList arrayList, Fragment oldPrimaryNav) {
        int opNum = 0;
            ...
            switch (op.mCmd) {
                ...
                case 2:
                    ...
                    for (int i = arrayList.size() - 1; i >= 0; i--) {
                        Fragment old = (Fragment) arrayList.get(i);
    ...
    Fragment trackAddedFragmentsInPop(ArrayList arrayList, Fragment oldPrimaryNav) {
        for (int opNum = this.mOps.size() - 1; opNum >= 0; opNum--) {
            FragmentTransaction.Op op = (FragmentTransaction.Op) this.mOps.get(opNum);
            switch (op.mCmd) {
                case 1:
