...
public abstract class FragmentStatePagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        Fragment f;
        if (this.mFragments.size() > position && (f = (Fragment) this.mFragments.get(position)) != null) {
            return f;
        }
        ...
        if (this.mSavedState.size() > position && (fss = (Fragment.SavedState) this.mSavedState.get(position)) != null) {
