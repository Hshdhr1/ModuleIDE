...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    private void setupColorAnimator(Animator animator) {
        ...
        if ((animator instanceof AnimatorSet) && (childAnimations = ((AnimatorSet) animator).getChildAnimations()) != null) {
            ...
            while (true) {
                ...
                setupColorAnimator((Animator) childAnimations.get(i2));
                i = i2 + 1;
            }
        }
    ...
    public boolean isRunning() {
        return this.mDelegateDrawable != null ? this.mDelegateDrawable.isRunning() : this.mAnimatedVectorState.mAnimatorSet.isRunning();
    }
    ...
    class 1 implements Drawable.Callback {
        1() {
        }
    ...
    public void registerAnimationCallback(@NonNull Animatable2Compat.AnimationCallback animationCallback) {
        if (this.mDelegateDrawable != null) {
            registerPlatformCallback(this.mDelegateDrawable, animationCallback);
            return;
        }
    ...
    public boolean unregisterAnimationCallback(@NonNull Animatable2Compat.AnimationCallback animationCallback) {
        if (this.mDelegateDrawable != null) {
            unregisterPlatformCallback(this.mDelegateDrawable, animationCallback);
        }
