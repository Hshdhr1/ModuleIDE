    ...
    private static void dumpKeyframes(Object[] objArr, String str) {
        if (objArr != null && objArr.length != 0) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                Log.d("AnimatorInflater", "Keyframe " + i + ": fraction " + (keyframe.getFraction() < 0.0f ? "null" : Float.valueOf(keyframe.getFraction())) + ", , value : " + (keyframe.hasValue() ? keyframe.getValue() : "null"));
            }
        }
    }
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            if (keyframe3.getFraction() < 0.0f) {
                if (i4 == 0) {
                    ...
                    distributeKeyframes(keyframeArr, keyframeArr[i5 + 1].getFraction() - keyframeArr[i4 - 1].getFraction(), i4, i5);
                }
            }
        }
