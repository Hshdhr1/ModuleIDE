    ...
    private static class SetIndicatorInfo {
        ...
        SetIndicatorInfo(Activity activity) {
            try {
                ...
                if (home != null) {
                    ViewGroup parent = home.getParent();
                    int childCount = parent.getChildCount();
                    if (childCount == 2) {
                        ImageView childAt = parent.getChildAt(0);
                        ImageView childAt2 = childAt.getId() == 16908332 ? parent.getChildAt(1) : childAt;
                        if (childAt2 instanceof ImageView) {
                            this.mUpIndicatorView = childAt2;
                        }
                    }
                }
            }
