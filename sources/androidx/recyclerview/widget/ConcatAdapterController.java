...
class ConcatAdapterController implements NestedAdapterWrapper.Callback {
    ...
    private NestedAdapterWrapper findWrapperFor(RecyclerView.Adapter adapter) {
        ...
        return (NestedAdapterWrapper) this.mWrappers.get(index);
    }
    ...
    boolean addAdapter(int index, RecyclerView.Adapter adapter) {
    ...
    boolean removeAdapter(RecyclerView.Adapter adapter) {
        ...
        NestedAdapterWrapper wrapper = (NestedAdapterWrapper) this.mWrappers.get(index);
    ...
    private int countItemsBefore(NestedAdapterWrapper wrapper) {
        ...
        while (it.hasNext() && (item = (NestedAdapterWrapper) it.next()) != wrapper) {
    ...
    private WrapperAndLocalPosition findWrapperAndLocalPosition(int globalPosition) {
        ...
        while (true) {
            ...
            NestedAdapterWrapper wrapper = (NestedAdapterWrapper) it.next();
    ...
    public void onViewRecycled(RecyclerView.ViewHolder holder) {
        NestedAdapterWrapper wrapper = (NestedAdapterWrapper) this.mBinderLookup.get(holder);
        if (wrapper == null) {
    ...
    public void onDetachedFromRecyclerView(RecyclerView recyclerView) {
        ...
        while (true) {
            ...
            WeakReference<RecyclerView> reference = (WeakReference) this.mAttachedRecyclerViews.get(i);
    ...
    public int getLocalAdapterPosition(RecyclerView.Adapter adapter, RecyclerView.ViewHolder viewHolder, int globalPosition) {
        NestedAdapterWrapper wrapper = (NestedAdapterWrapper) this.mBinderLookup.get(viewHolder);
        if (wrapper == null) {
            return -1;
        }
    ...
    @Nullable
    public RecyclerView.Adapter getBoundAdapter(RecyclerView.ViewHolder viewHolder) {
        NestedAdapterWrapper wrapper = (NestedAdapterWrapper) this.mBinderLookup.get(viewHolder);
        if (wrapper == null) {
            return null;
        }
