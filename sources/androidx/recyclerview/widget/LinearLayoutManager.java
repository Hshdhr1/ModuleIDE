...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private boolean updateAnchorFromChildren(RecyclerView.Recycler recycler, RecyclerView.State state, AnchorInfo anchorInfo) {
        ...
        if (!state.isPreLayout() && supportsPredictiveItemAnimations()) {
            ...
            if (outOfBoundsBefore || outOfBoundsAfter) {
                ...
                anchorInfo.mCoordinate = boundsEnd;
            }
        }
        return true;
    }
    ...
    private void updateLayoutState(int layoutDirection, int requiredSpace, boolean canUseExistingSpace, RecyclerView.State state) {
        ...
        if (!layoutToEnd) {
            extraForStart = extraForEnd;
        }
        layoutState.mNoRecycleSpace = extraForStart;
        if (layoutToEnd) {
    ...
    View findReferenceChild(RecyclerView.Recycler recycler, RecyclerView.State state, boolean layoutFromEnd, boolean traverseChildrenInReverseOrder) {
        ...
        for (int i = start; i != end; i += diff) {
            ...
            if (position >= 0 && position < itemCount) {
                if (view.getLayoutParams().isItemRemoved()) {
        ...
        if (bestSecondFind == null) {
            bestSecondFind = bestFirstFind != null ? bestFirstFind : invalidMatch;
        }
    ...
    static class LayoutState {
        ...
        private View nextViewFromScrapList() {
            ...
            for (int i = 0; i < size; i++) {
                ...
                RecyclerView.LayoutParams lp = view.getLayoutParams();
        ...
        public void assignPositionFromScrapList(View ignore) {
            ...
            if (closest == null) {
                ...
                this.mCurrentPosition = closest.getLayoutParams().getViewLayoutPosition();
            }
        }
    ...
    static class AnchorInfo {
        ...
        public void assignFromViewAndKeepVisibleRect(View child, int position) {
            ...
            if (startMargin2 > 0) {
                int estimatedEnd = childStart + this.mOrientationHelper.getDecoratedMeasurement(child);
