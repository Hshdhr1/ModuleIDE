...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    static /* synthetic */ void access$000(RecyclerView x0, View x1, int x2, ViewGroup.LayoutParams x3) {
        x0.attachViewToParent(x1, x2, x3);
    }

    static /* synthetic */ void access$100(RecyclerView x0, int x1) {
        x0.detachViewFromParent(x1);
    }

    static /* synthetic */ boolean access$200(RecyclerView x0) {
        return x0.awakenScrollBars();
    }

    static /* synthetic */ void access$300(RecyclerView x0, int x1, int x2) {
    ...
    class 3 implements Interpolator {
        3() {
        }
    ...
    class 4 implements ViewInfoStore.ProcessCallback {
        4() {
        }
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateChildViewsRunnable = new 1();
        ...
        this.mItemAnimatorRunner = new 2();
        this.mLastAutoMeasureNonExactMeasuredWidth = 0;
        this.mLastAutoMeasureNonExactMeasuredHeight = 0;
        this.mViewInfoProcessCallback = new 4();
        ...
        if (className != null) {
            ...
            if (!className2.isEmpty()) {
                ...
                try {
                    ...
                    throw new IllegalStateException(attrs.getPositionDescription() + ": Cannot access non-public constructor " + className3, e2);
                    ...
                    throw new IllegalStateException(attrs.getPositionDescription() + ": Class is not a LayoutManager " + className3, e4);
                    ...
                    throw new IllegalStateException(attrs.getPositionDescription() + ": Unable to find LayoutManager " + className3, e6);
                }
            }
        }
    }
    ...
    class 5 implements ChildHelper.Callback {
        5() {
        }
        ...
        public void attachViewToParent(View child, int index, ViewGroup.LayoutParams layoutParams) {
            ...
            RecyclerView.access$000(RecyclerView.this, child, index, layoutParams);
        }
        ...
        public void detachViewFromParent(int offset) {
            ...
            RecyclerView.access$100(RecyclerView.this, offset);
        }
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new 5());
    }

    class 6 implements AdapterHelper.Callback {
        6() {
        }
    ...
    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new 6());
    }
    ...
    private void requestChildOnScreen(@NonNull View child, @Nullable View focused) {
        ...
        LayoutParams layoutParams = rectView.getLayoutParams();
    ...
    public void addFocusables(ArrayList arrayList, int direction, int focusableMode) {
        if (this.mLayout == null || !this.mLayout.onAddFocusables(this, arrayList, direction, focusableMode)) {
    ...
    static ViewHolder getChildViewHolderInt(View child) {
        ...
        return child.getLayoutParams().mViewHolder;
    }
    ...
    */
    ...
    public static class RecycledViewPool {
        ...
        public void clear() {
            for (int i = 0; i < this.mScrap.size(); i++) {
                ScrapData data = (ScrapData) this.mScrap.valueAt(i);
        ...
        public ViewHolder getRecycledView(int viewType) {
            ...
            if (scrapData != null && !scrapData.mScrapHeap.isEmpty()) {
                ...
                for (int i = scrapHeap.size() - 1; i >= 0; i--) {
                    if (!((ViewHolder) scrapHeap.get(i)).isAttachedToTransitionOverlay()) {
                        return (ViewHolder) scrapHeap.remove(i);
                    }
                }
            }
            return null;
    ...
    public final class Recycler {
        ...
        void dispatchViewRecycled(@NonNull ViewHolder holder) {
            ...
            for (int i = 0; i < listenerCount; i++) {
                ((RecyclerListener) RecyclerView.this.mRecyclerListeners.get(i)).onViewRecycled(holder);
            }
            if (RecyclerView.this.mAdapter != null) {
    ...
    public static abstract class Adapter {
        ...
        public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position, @NonNull List list) {
            onBindViewHolder(viewHolder, position);
        }

        public int findRelativeAdapterPositionIn(@NonNull Adapter adapter, @NonNull ViewHolder viewHolder, int localPosition) {
            if (adapter == this) {
        ...
        @NonNull
        public final ViewHolder createViewHolder(@NonNull ViewGroup parent, int viewType) {
            try {
        ...
        public final void bindViewHolder(@NonNull ViewHolder viewHolder, int position) {
            boolean rootBind = viewHolder.mBindingAdapter == null;
            if (rootBind) {
                viewHolder.mPosition = position;
                if (hasStableIds()) {
                    viewHolder.mItemId = getItemId(position);
                }
                viewHolder.setFlags(1, 519);
                TraceCompat.beginSection("RV OnBindView");
            }
            viewHolder.mBindingAdapter = this;
            onBindViewHolder(viewHolder, position, viewHolder.getUnmodifiedPayloads());
            if (rootBind) {
    ...
    public static abstract class LayoutManager {
        ...
        private final ViewBoundsCheck.Callback mHorizontalBoundCheckCallback = new 1();
        private final ViewBoundsCheck.Callback mVerticalBoundCheckCallback = new 2();
        ...
        class 1 implements ViewBoundsCheck.Callback {
            1() {
            }
        ...
        class 2 implements ViewBoundsCheck.Callback {
            2() {
            }
        ...
        public int getPosition(@NonNull View view) {
            return view.getLayoutParams().getViewLayoutPosition();
        }
        ...
        public int getDecoratedMeasuredWidth(@NonNull View child) {
            Rect insets = child.getLayoutParams().mDecorInsets;
        ...
        public int getTopDecorationHeight(@NonNull View child) {
            return child.getLayoutParams().mDecorInsets.top;
        }

        public int getBottomDecorationHeight(@NonNull View child) {
            return child.getLayoutParams().mDecorInsets.bottom;
        }

        public int getLeftDecorationWidth(@NonNull View child) {
            return child.getLayoutParams().mDecorInsets.left;
        }

        public int getRightDecorationWidth(@NonNull View child) {
            return child.getLayoutParams().mDecorInsets.right;
        }
        ...
        public boolean onAddFocusables(@NonNull RecyclerView recyclerView, @NonNull ArrayList arrayList, int direction, int focusableMode) {
            return false;
        }
        ...
        public void setMeasuredDimension(int widthSize, int heightSize) {
            RecyclerView.access$300(this.mRecyclerView, widthSize, heightSize);
        }
    ...
    public static abstract class ItemDecoration {
        ...
        public void getItemOffsets(@NonNull Rect outRect, @NonNull View view, @NonNull RecyclerView parent, @NonNull State state) {
            getItemOffsets(outRect, view.getLayoutParams().getViewLayoutPosition(), parent);
        }
    }
    ...
    public static abstract class ItemAnimator {
        ...
        @NonNull
        public ItemHolderInfo recordPreLayoutInformation(@NonNull State state, @NonNull ViewHolder viewHolder, int changeFlags, @NonNull List list) {
