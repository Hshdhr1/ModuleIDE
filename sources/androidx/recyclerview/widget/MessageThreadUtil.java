...
class MessageThreadUtil implements ThreadUtil {
    ...
    class 1 implements ThreadUtil.MainThreadCallback {
        ...
        private Runnable mMainThreadRunnable = new 1();

        1(ThreadUtil.MainThreadCallback mainThreadCallback) {
        ...
        class 1 implements Runnable {
            ...
            public void run() {
                SyncQueueItem msg = 1.this.mQueue.next();
                while (msg != null) {
                    switch (msg.what) {
                        case 1:
                            1.this.val$callback.updateItemCount(msg.arg1, msg.arg2);
                            break;
                        case 2:
                            1.this.val$callback.addTile(msg.arg1, (TileList.Tile) msg.data);
                            break;
                        case 3:
                            1.this.val$callback.removeTile(msg.arg1, msg.arg2);
                            break;
                        default:
                            Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                            break;
                    }
                    msg = 1.this.mQueue.next();
                }
            }
        }
    }
    ...
    public ThreadUtil.MainThreadCallback getMainThreadProxy(ThreadUtil.MainThreadCallback mainThreadCallback) {
        return new 1(mainThreadCallback);
    }
    ...
    class 2 implements ThreadUtil.BackgroundCallback {
        ...
        private Runnable mBackgroundRunnable = new 1();

        2(ThreadUtil.BackgroundCallback backgroundCallback) {
        ...
        class 1 implements Runnable {
            ...
            public void run() {
                while (true) {
                    SyncQueueItem msg = 2.this.mQueue.next();
                    if (msg != null) {
                        switch (msg.what) {
                            case 1:
                                2.this.mQueue.removeMessages(1);
                                2.this.val$callback.refresh(msg.arg1);
                                break;
                            case 2:
                                2.this.mQueue.removeMessages(2);
                                2.this.mQueue.removeMessages(3);
                                2.this.val$callback.updateRange(msg.arg1, msg.arg2, msg.arg3, msg.arg4, msg.arg5);
                                break;
                            case 3:
                                2.this.val$callback.loadTile(msg.arg1, msg.arg2);
                                break;
                            case 4:
                                2.this.val$callback.recycleTile((TileList.Tile) msg.data);
                                break;
                            default:
                                Log.e("ThreadUtil", "Unsupported message, what=" + msg.what);
                                break;
    ...
    public ThreadUtil.BackgroundCallback getBackgroundProxy(ThreadUtil.BackgroundCallback backgroundCallback) {
        return new 2(backgroundCallback);
    }
