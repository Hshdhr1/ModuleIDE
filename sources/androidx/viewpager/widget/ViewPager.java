...
/* loaded from: /storage/emulated/0/Android/data/com.apktools.app.decompile/files/decompile_temp/jadx/classes34.dex */
public class ViewPager extends ViewGroup {
    ...
    private static final Interpolator sInterpolator = new 2();
    ...
    static class 2 implements Interpolator {
        2() {
        }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new 4());
    }

    class 4 implements OnApplyWindowInsetsListener {
    ...
    void populate(int newCurrentItem) {
        ...
        if (getWindowToken() != null) {
            ...
            while (true) {
                ...
                ItemInfo ii2 = (ItemInfo) this.mItems.get(curIndex);
            ...
            if (curItem != null) {
                ...
                for (int pos = this.mCurItem - 1; pos >= 0; pos--) {
                    if (extraWidthLeft >= leftWidthNeeded && pos < startPos) {
                        ...
                        if (pos == ii3.position && !ii3.scrolling) {
                            ...
                            itemIndex--;
                            curIndex--;
                            ii3 = itemIndex >= 0 ? (ItemInfo) this.mItems.get(itemIndex) : null;
                        }
                ...
                if (extraWidthRight < 2.0f) {
                    ItemInfo ii4 = itemIndex2 < this.mItems.size() ? (ItemInfo) this.mItems.get(itemIndex2) : null;
                    ...
                    for (int pos2 = this.mCurItem + 1; pos2 < N; pos2++) {
                        if (extraWidthRight >= rightWidthNeeded && pos2 > endPos) {
                            ...
                            if (pos2 == ii4.position && !ii4.scrolling) {
                                ...
                                ii4 = itemIndex2 < this.mItems.size() ? (ItemInfo) this.mItems.get(itemIndex2) : null;
                            }
    ...
    private void enableLayers(boolean enable) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            getChildAt(i).setLayerType(layerType, (Paint) null);
        }
    }
    ...
    */
    ...
    public void addFocusables(ArrayList arrayList, int direction, int focusableMode) {
        ItemInfo ii;
        int focusableCount = arrayList.size();
        int descendantFocusability = getDescendantFocusability();
        if (descendantFocusability != 393216) {
            for (int i = 0; i < getChildCount(); i++) {
                View child = getChildAt(i);
                if (child.getVisibility() == 0 && (ii = infoForChild(child)) != null && ii.position == this.mCurItem) {
                    child.addFocusables(arrayList, direction, focusableMode);
                }
            }
        }
        if ((descendantFocusability != 262144 || focusableCount == arrayList.size()) && isFocusable()) {
