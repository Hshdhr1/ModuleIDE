...
public class CardView extends FrameLayout {
    ...
    static /* synthetic */ void access$001(CardView x0, int x1, int x2, int x3, int x4) {
        super.setPadding(x1, x2, x3, x4);
    }

    static /* synthetic */ void access$101(CardView x0, int x1) {
        super.setMinimumWidth(x1);
    }

    static /* synthetic */ void access$201(CardView x0, int x1) {
        super.setMinimumHeight(x1);
    }
    ...
    class 1 implements CardViewDelegate {
        ...
        public void setShadowPadding(int left, int top, int right, int bottom) {
            ...
            CardView.access$001(CardView.this, CardView.this.mContentPadding.left + left, CardView.this.mContentPadding.top + top, CardView.this.mContentPadding.right + right, CardView.this.mContentPadding.bottom + bottom);
        }

        public void setMinWidthHeightInternal(int width, int height) {
            if (width > CardView.this.mUserSetMinWidth) {
                CardView.access$101(CardView.this, width);
            }
            if (height > CardView.this.mUserSetMinHeight) {
                CardView.access$201(CardView.this, height);
            }
        }
