...
public class TransitionManager {
    ...
    private Transition getTransition(Scene scene) {
        ...
        if (sceneRoot != null && (currScene = Scene.getCurrentScene(sceneRoot)) != null && (sceneTransitionMap = (ArrayMap) this.mScenePairTransitions.get(scene)) != null && (transition = (Transition) sceneTransitionMap.get(currScene)) != null) {
            return transition;
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: java.lang.Object != androidx.collection.ArrayMap<android.view.ViewGroup, java.util.ArrayList<androidx.transition.Transition>> */
    ...
    private static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        public void onViewDetachedFromWindow(View v) {
            ...
            if (runningTransitions != null && runningTransitions.size() > 0) {
                ...
                while (it.hasNext()) {
                    Transition runningTransition = (Transition) it.next();
        ...
        public boolean onPreDraw() {
            ...
            if (TransitionManager.sPendingTransitions.remove(this.mSceneRoot)) {
                ...
                this.mTransition.addListener(new 1(runningTransitions));
        ...
        class 1 extends TransitionListenerAdapter {
            ...
            public void onTransitionEnd(@NonNull Transition transition) {
                ArrayList<Transition> currentTransitions = (ArrayList) this.val$runningTransitions.get(MultiListener.this.mSceneRoot);
