...
public class ChangeTransform extends Transition {
    ...
    private static final Property NON_TRANSLATIONS_PROPERTY = new 1(float[].class, "nonTranslations");
    private static final Property TRANSLATIONS_PROPERTY = new 2(PointF.class, "translations");
    ...
    public void captureStartValues(@NonNull TransitionValues transitionValues) {
        ...
        if (!SUPPORTS_VIEW_REMOVAL_SUPPRESSION) {
            transitionValues.view.getParent().startViewTransition(transitionValues.view);
        }
    }
    ...
    private ObjectAnimator createTransformAnimator(TransitionValues startValues, TransitionValues endValues, boolean handleParentChange) {
        ...
        Transforms transforms = (Transforms) endValues.values.get("android:changeTransform:transforms");
        ...
        AnimatorListenerAdapter listener = new 3(handleParentChange, finalEndMatrix, view, transforms, pathAnimatorMatrix);
    ...
    class 3 extends AnimatorListenerAdapter {
        ...
        3(boolean z, Matrix matrix, View view, Transforms transforms, PathAnimatorMatrix pathAnimatorMatrix) {
        ...
        public void onAnimationPause(Animator animation) {
            Matrix currentMatrix = this.val$pathAnimatorMatrix.getMatrix();
