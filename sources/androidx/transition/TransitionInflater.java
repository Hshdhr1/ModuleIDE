    ...
    private Object createCustom(AttributeSet attrs, Class cls, String tag) {
        ...
        try {
            synchronized (CONSTRUCTORS) {
                ...
                if (constructor == null && (c = Class.forName(className, false, this.mContext.getClassLoader()).asSubclass(cls)) != null) {
            ...
            throw new InflateException("Could not instantiate " + cls + " class " + className, e);
        }
    }
                                    ...
                                    if (transitionName2 != null) {
                                        ...
                                        if (className != null) {
                                            try {
                                                ...
                                                transition.excludeTarget((Class) clazz, true);
