...
public abstract class VisibilityPropagation extends TransitionPropagation {
    ...
    public int getViewVisibility(TransitionValues values) {
        Integer visibility;
        if (values == null || (visibility = (Integer) values.values.get("android:visibilityPropagation:visibility")) == null) {
            return 8;
        }
    ...
    private static int getViewCoordinate(TransitionValues values, int coordinateIndex) {
        int[] coordinates;
        if (values == null || (coordinates = (int[]) values.values.get("android:visibilityPropagation:center")) == null) {
            return -1;
        }
