...
public final class Duration implements TemporalAmount, Comparable, Serializable {
    ...
    public static Duration ofDays(long j) {
        return create(Duration$$ExternalSyntheticBackport9.m(j, 86400), 0);
    }

    public static Duration ofHours(long j) {
        return create(Duration$$ExternalSyntheticBackport10.m(j, 3600), 0);
    }

    public static Duration ofMinutes(long j) {
        return create(Duration$$ExternalSyntheticBackport11.m(j, 60), 0);
    }
    ...
    public static Duration ofSeconds(long j, long j2) {
        return create(Duration$$ExternalSyntheticBackport8.m(j, Duration$$ExternalSyntheticBackport12.m(j2, 1000000000L)), (int) Duration$$ExternalSyntheticBackport13.m(j2, 1000000000L));
    }
    ...
    public static Duration from(TemporalAmount temporalAmount) {
        Duration$$ExternalSyntheticBackport0.m(temporalAmount, "amount");
    ...
    public static Duration parse(CharSequence charSequence) {
        Duration$$ExternalSyntheticBackport0.m(charSequence, "text");
        ...
        if (matcher.matches() && !charMatch(charSequence, matcher.start(3), matcher.end(3), 'T')) {
            ...
            if (start >= 0 || start2 >= 0 || start3 >= 0 || start4 >= 0) {
                ...
                try {
                    ...
                    throw new DateTimeParseException("Text cannot be parsed to a Duration: overflow", charSequence, 0).initCause(e);
                }
            }
        }
    ...
    private static long parseNumber(CharSequence charSequence, int i, int i2, int i3, String str) {
        ...
        try {
            return Duration$$ExternalSyntheticBackport7.m(Duration$$ExternalSyntheticBackport6.m(charSequence, i, i2, 10), i3);
        } catch (ArithmeticException | NumberFormatException e) {
            throw new DateTimeParseException("Text cannot be parsed to a Duration: " + str, charSequence, 0).initCause(e);
        }
    }
    ...
    private static int parseFraction(CharSequence charSequence, int i, int i2, int i3) {
        ...
        try {
            int m = Duration$$ExternalSyntheticBackport5.m(charSequence, i, i2, 10);
            for (i4 = i2 - i; i4 < 9; i4++) {
                m *= 10;
            }
            return m * i3;
        } catch (NumberFormatException | ArithmeticException e) {
            throw new DateTimeParseException("Text cannot be parsed to a Duration: fraction", charSequence, 0).initCause(e);
        }
    }

    private static Duration create(boolean z, long j, long j2, long j3, long j4, int i) {
        long m = Duration$$ExternalSyntheticBackport8.m(j, Duration$$ExternalSyntheticBackport8.m(j2, Duration$$ExternalSyntheticBackport8.m(j3, j4)));
        if (z) {
            return ofSeconds(m, i).negated();
        }
        return ofSeconds(m, i);
    }
    ...
    private static class DurationUnits {
        static final List UNITS = Duration$DurationUnits$$ExternalSyntheticBackport1.m(ChronoUnit.SECONDS, ChronoUnit.NANOS);
    ...
    public Duration plus(long j, TemporalUnit temporalUnit) {
        Duration$$ExternalSyntheticBackport0.m(temporalUnit, "unit");
        if (temporalUnit == ChronoUnit.DAYS) {
            return plus(Duration$$ExternalSyntheticBackport1.m(j, 86400), 0L);
        }
        ...
        if (temporalUnit instanceof ChronoUnit) {
            ...
            return plusSeconds(Duration$$ExternalSyntheticBackport2.m(temporalUnit.getDuration().seconds, j));
        }
    ...
    public Duration plusDays(long j) {
        return plus(Duration$$ExternalSyntheticBackport4.m(j, 86400), 0L);
    }

    public Duration plusHours(long j) {
        return plus(Duration$$ExternalSyntheticBackport3.m(j, 3600), 0L);
    }

    public Duration plusMinutes(long j) {
        return plus(Duration$$ExternalSyntheticBackport14.m(j, 60), 0L);
    }
    ...
    private Duration plus(long j, long j2) {
        ...
        return ofSeconds(Duration$$ExternalSyntheticBackport8.m(Duration$$ExternalSyntheticBackport8.m(this.seconds, j), j2 / 1000000000), this.nanos + (j2 % 1000000000));
    }
    ...
    public long dividedBy(Duration duration) {
        Duration$$ExternalSyntheticBackport0.m(duration, "divisor");
    ...
    public long toMillis() {
        ...
        return Duration$$ExternalSyntheticBackport8.m(Duration$$ExternalSyntheticBackport15.m(j, 1000), j2 / 1000000);
    }
    ...
    public long toNanos() {
        ...
        return Duration$$ExternalSyntheticBackport8.m(Duration$$ExternalSyntheticBackport2.m(j, 1000000000L), j2);
    }
