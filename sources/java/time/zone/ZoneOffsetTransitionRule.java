...
public final class ZoneOffsetTransitionRule implements Serializable {
    ...
    public static ZoneOffsetTransitionRule of(Month month, int i, DayOfWeek dayOfWeek, LocalTime localTime, boolean z, TimeDefinition timeDefinition, ZoneOffset zoneOffset, ZoneOffset zoneOffset2, ZoneOffset zoneOffset3) {
        ZoneOffsetTransitionRule$$ExternalSyntheticBackport0.m(month, "month");
        ZoneOffsetTransitionRule$$ExternalSyntheticBackport0.m(localTime, "time");
        ZoneOffsetTransitionRule$$ExternalSyntheticBackport0.m(timeDefinition, "timeDefnition");
        ZoneOffsetTransitionRule$$ExternalSyntheticBackport0.m(zoneOffset, "standardOffset");
        ZoneOffsetTransitionRule$$ExternalSyntheticBackport0.m(zoneOffset2, "offsetBefore");
        ZoneOffsetTransitionRule$$ExternalSyntheticBackport0.m(zoneOffset3, "offsetAfter");
        if (i < -28 || i > 31 || i == 0) {
    ...
    static ZoneOffsetTransitionRule readExternal(DataInput dataInput) throws IOException {
        ...
        ZoneOffset ofTotalSeconds2 = i5 == 3 ? ZoneOffset.ofTotalSeconds(dataInput.readInt()) : ZoneOffset.ofTotalSeconds(ofTotalSeconds.getTotalSeconds() + (i5 * 1800));
        ...
        return of(of, i, of2, localTime, z, timeDefinition, zoneOffset, zoneOffset2, ofTotalSeconds3);
    }
    ...
    public enum TimeDefinition {
        ...
        public LocalDateTime createDateTime(LocalDateTime localDateTime, ZoneOffset zoneOffset, ZoneOffset zoneOffset2) {
            int i = 1.$SwitchMap$java$time$zone$ZoneOffsetTransitionRule$TimeDefinition[ordinal()];
            if (i != 1) {
