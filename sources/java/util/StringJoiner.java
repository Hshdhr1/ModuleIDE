...
public final class StringJoiner {
    ...
    public StringJoiner(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3) {
        StringJoiner$$ExternalSyntheticBackport0.m(charSequence2, "The prefix must not be null");
        StringJoiner$$ExternalSyntheticBackport0.m(charSequence, "The delimiter must not be null");
        StringJoiner$$ExternalSyntheticBackport0.m(charSequence3, "The suffix must not be null");
    ...
    public StringJoiner setEmptyValue(CharSequence charSequence) {
        this.emptyValue = ((CharSequence) StringJoiner$$ExternalSyntheticBackport0.m(charSequence, "The empty value must not be null")).toString();
        return this;
    }
