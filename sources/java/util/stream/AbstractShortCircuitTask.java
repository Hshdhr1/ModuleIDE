...
abstract class AbstractShortCircuitTask extends AbstractTask {
    ...
    */
    public void compute() {
        /*
            r10 = this;
            java.util.Spliterator r0 = r10.spliterator
        ...
        L1f:
            ...
            if (r8 <= 0) goto L4f
            java.util.Spliterator r1 = r0.trySplit()
            if (r1 != 0) goto L2a
            goto L4f
        L2a:
            java.util.stream.AbstractTask r2 = r7.makeChild(r1)
            java.util.stream.AbstractShortCircuitTask r2 = (java.util.stream.AbstractShortCircuitTask) r2
            r7.leftChild = r2
            java.util.stream.AbstractTask r8 = r7.makeChild(r0)
    ...
    protected void shortCircuit(Object obj) {
        if (obj != null) {
            AbstractShortCircuitTask$$ExternalSyntheticBackportWithForwarding0.m(this.sharedResult, null, obj);
        }
    }
