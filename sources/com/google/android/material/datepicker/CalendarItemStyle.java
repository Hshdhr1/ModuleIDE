...
final class CalendarItemStyle {
    ...
    void styleItem(TextView item) {
        ...
        RippleDrawable materialShapeDrawable = new MaterialShapeDrawable();
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            rippleDrawable = new RippleDrawable(this.textColor.withAlpha(30), materialShapeDrawable, shapeMask);
        } else {
            rippleDrawable = materialShapeDrawable;
        }
        ViewCompat.setBackground(item, new InsetDrawable(rippleDrawable, this.insets.left, this.insets.top, this.insets.right, this.insets.bottom));
    }
