...
public class MaterialAutoCompleteTextView extends AppCompatAutoCompleteTextView {
    ...
    static /* synthetic */ ListPopupWindow access$000(MaterialAutoCompleteTextView x0) {
        return x0.modalListPopup;
    }

    static /* synthetic */ void access$100(MaterialAutoCompleteTextView x0, Object x1) {
        x0.updateText(x1);
    }
    ...
    public MaterialAutoCompleteTextView(Context context, AttributeSet attributeSet, int defStyleAttr) {
        ...
        listPopupWindow.setOnItemClickListener(new 1());
    ...
    class 1 implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView adapterView, View selectedView, int position, long id) {
            ...
            Object selectedItem = position < 0 ? MaterialAutoCompleteTextView.access$000(materialAutoCompleteTextView).getSelectedItem() : materialAutoCompleteTextView.getAdapter().getItem(position);
            MaterialAutoCompleteTextView.access$100(MaterialAutoCompleteTextView.this, selectedItem);
            ...
            if (userOnitemClickListener != null) {
                if (selectedView == null || position < 0) {
                    selectedView = MaterialAutoCompleteTextView.access$000(MaterialAutoCompleteTextView.this).getSelectedView();
                    position = MaterialAutoCompleteTextView.access$000(MaterialAutoCompleteTextView.this).getSelectedItemPosition();
                    id = MaterialAutoCompleteTextView.access$000(MaterialAutoCompleteTextView.this).getSelectedItemId();
                }
                userOnitemClickListener.onItemClick(MaterialAutoCompleteTextView.access$000(MaterialAutoCompleteTextView.this).getListView(), selectedView, position, id);
            }
    ...
    private void updateText(Object selectedItem) {
