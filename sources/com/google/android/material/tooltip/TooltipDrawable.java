...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    static /* synthetic */ void access$000(TooltipDrawable x0, View x1) {
        x0.updateLocationOnScreen(x1);
    }
    ...
    class 1 implements View.OnLayoutChangeListener {
        ...
        public void onLayoutChange(View v, int left, int top, int right, int bottom, int oldLeft, int oldTop, int oldRight, int oldBottom) {
            TooltipDrawable.access$000(TooltipDrawable.this, v);
        }
    }
    ...
    private TooltipDrawable(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.attachedViewLayoutChangeListener = new 1();
    ...
    private void updateLocationOnScreen(View v) {
