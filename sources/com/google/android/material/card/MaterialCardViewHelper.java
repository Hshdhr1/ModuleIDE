...
class MaterialCardViewHelper {
    ...
    private void updateInsetForeground(Drawable insetForeground) {
        if (Build.VERSION.SDK_INT >= 23 && (this.materialCardView.getForeground() instanceof InsetDrawable)) {
            this.materialCardView.getForeground().setDrawable(insetForeground);
        } else {
    ...
    private Drawable insetDrawable(Drawable originalDrawable) {
        ...
        return new 1(originalDrawable, insetHorizontal, insetVertical, insetHorizontal, insetVertical);
    }

    class 1 extends InsetDrawable {
        1(Drawable arg0, int arg1, int arg2, int arg3, int arg4) {
    ...
    private void updateRippleColor() {
        ...
        if (RippleUtils.USE_FRAMEWORK_RIPPLE && (rippleDrawable = this.rippleDrawable) != null) {
