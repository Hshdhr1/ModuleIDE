...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    /* synthetic */ MaterialShapeDrawable(MaterialShapeDrawableState x0, 1 x1) {
        this(x0);
    }

    static /* synthetic */ BitSet access$000(MaterialShapeDrawable x0) {
        return x0.containsIncompatibleShadowOp;
    }

    static /* synthetic */ ShapePath.ShadowCompatOperation[] access$100(MaterialShapeDrawable x0) {
        return x0.cornerShadowOperation;
    }

    static /* synthetic */ ShapePath.ShadowCompatOperation[] access$200(MaterialShapeDrawable x0) {
        return x0.edgeShadowOperation;
    }

    static /* synthetic */ boolean access$402(MaterialShapeDrawable x0, boolean x1) {
        x0.pathDirty = x1;
        return x1;
    }
    ...
    private MaterialShapeDrawable(MaterialShapeDrawableState drawableState) {
        ...
        this.pathShadowListener = new 1();
    }

    class 1 implements ShapeAppearancePathProvider.PathListener {
        1() {
        }

        public void onCornerPathCreated(ShapePath cornerPath, Matrix transform, int count) {
            MaterialShapeDrawable.access$000(MaterialShapeDrawable.this).set(count, cornerPath.containsIncompatibleShadowOp());
            MaterialShapeDrawable.access$100(MaterialShapeDrawable.this)[count] = cornerPath.createShadowCompatOperation(transform);
        }

        public void onEdgePathCreated(ShapePath edgePath, Matrix transform, int count) {
            MaterialShapeDrawable.access$000(MaterialShapeDrawable.this).set(count + 4, edgePath.containsIncompatibleShadowOp());
            MaterialShapeDrawable.access$200(MaterialShapeDrawable.this)[count] = edgePath.createShadowCompatOperation(transform);
        }
    }
    ...
    private void calculateStrokePath() {
        ...
        ShapeAppearanceModel withTransformedCornerSizes = getShapeAppearanceModel().withTransformedCornerSizes(new 2(strokeInsetLength));
    ...
    class 2 implements ShapeAppearanceModel.CornerSizeUnaryOperator {
    ...
    static final class MaterialShapeDrawableState extends Drawable.ConstantState {
        ...
        public Drawable newDrawable() {
            MaterialShapeDrawable msd = new MaterialShapeDrawable(this, null);
            MaterialShapeDrawable.access$402(msd, true);
            return msd;
        }
