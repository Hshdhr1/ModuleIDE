...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void onVisibilityUpdated() {
        ...
        if (BadgeUtils.USE_COMPAT_PARENT && getCustomBadgeParent() != null && !visible) {
            getCustomBadgeParent().getParent().invalidate();
        }
    }
    ...
    private void tryWrapAnchorInCompatParent(View anchorView) {
        ViewGroup anchorViewParent = anchorView.getParent();
        if (anchorViewParent == null || anchorViewParent.getId() != R.id.mtrl_anchor_parent) {
            ...
            frameLayout.post(new 1(anchorView, frameLayout));
        }
    }
    ...
    class 1 implements Runnable {
        ...
        1(View view, FrameLayout frameLayout) {
    ...
    private void updateCenterAndBounds() {
        ...
        if (frameLayout != null || BadgeUtils.USE_COMPAT_PARENT) {
            (frameLayout == null ? (ViewGroup) anchorView.getParent() : frameLayout).offsetDescendantRectToMyCoords(anchorView, anchorRect);
        }
