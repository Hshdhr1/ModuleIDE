...
public abstract class NavigationBarView extends FrameLayout {
    ...
    static /* synthetic */ OnItemReselectedListener access$000(NavigationBarView x0) {
        return x0.reselectedListener;
    }

    static /* synthetic */ OnItemSelectedListener access$100(NavigationBarView x0) {
        return x0.selectedListener;
    }
    ...
    public NavigationBarView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        navigationBarMenu.setCallback(new 1());
    }
    ...
    class 1 implements MenuBuilder.Callback {
        ...
        public boolean onMenuItemSelected(MenuBuilder menu, MenuItem item) {
            if (NavigationBarView.access$000(NavigationBarView.this) == null || item.getItemId() != NavigationBarView.this.getSelectedItemId()) {
                return (NavigationBarView.access$100(NavigationBarView.this) == null || NavigationBarView.access$100(NavigationBarView.this).onNavigationItemSelected(item)) ? false : true;
            }
            NavigationBarView.access$000(NavigationBarView.this).onNavigationItemReselected(item);
            return true;
        }
