...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    static /* synthetic */ int[] access$000(NavigationView x0) {
        return x0.tmpLocation;
    }

    static /* synthetic */ NavigationMenuPresenter access$100(NavigationView x0) {
        return x0.presenter;
    }
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (itemBackground == null && hasShapeAppearance(a)) {
            ...
            if (Build.VERSION.SDK_INT >= 21 && itemRippleColor != null) {
                ...
                RippleDrawable ripple = new RippleDrawable(RippleUtils.sanitizeRippleDrawableColor(itemRippleColor), (Drawable) null, itemRippleMask);
        ...
        navigationMenu.setCallback(new 1());
    ...
    public void setCheckedItem(int id) {
        MenuItemImpl findItem = this.menu.findItem(id);
        if (findItem != null) {
    ...
    public void setCheckedItem(MenuItem checkedItem) {
        MenuItemImpl findItem = this.menu.findItem(checkedItem.getItemId());
        if (findItem != null) {
            this.presenter.setCheckedItem(findItem);
            return;
        }
    ...
    class 2 implements ViewTreeObserver.OnGlobalLayoutListener {
        ...
        public void onGlobalLayout() {
            ...
            boolean isBehindStatusBar = NavigationView.access$000(NavigationView.this)[1] == 0;
            NavigationView.access$100(NavigationView.this).setBehindStatusBar(isBehindStatusBar);
    ...
    private void setupInsetScrimsListener() {
        this.onGlobalLayoutListener = new 2();
