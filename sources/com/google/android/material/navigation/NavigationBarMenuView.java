...
public abstract class NavigationBarMenuView extends ViewGroup implements MenuView {
    ...
    static /* synthetic */ NavigationBarPresenter access$000(NavigationBarMenuView x0) {
        return x0.presenter;
    }

    static /* synthetic */ MenuBuilder access$100(NavigationBarMenuView x0) {
        return x0.menu;
    }
    ...
    void restoreBadgeDrawables(SparseArray sparseArray) {
        for (int i = 0; i < sparseArray.size(); i++) {
            ...
            if (this.badgeDrawables.indexOfKey(key) < 0) {
                this.badgeDrawables.append(key, sparseArray.get(key));
            }
        }
        NavigationBarItemView[] navigationBarItemViewArr = this.buttons;
        if (navigationBarItemViewArr != null) {
    ...
    private void setBadgeIfNeeded(NavigationBarItemView child) {
        ...
        if (isValidId(childId) && (badgeDrawable = (BadgeDrawable) this.badgeDrawables.get(childId)) != null) {
