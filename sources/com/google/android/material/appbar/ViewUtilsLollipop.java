...
class ViewUtilsLollipop {
    ...
    static void setDefaultAppBarLayoutStateListAnimator(View view, float elevation) {
        ...
        sla.addState(new int[]{16842910, R.attr.state_liftable, -R.attr.state_lifted}, ObjectAnimator.ofFloat(view, "elevation", new float[]{0.0f}).setDuration(dur));
        sla.addState(new int[]{16842910}, ObjectAnimator.ofFloat(view, "elevation", new float[]{elevation}).setDuration(dur));
