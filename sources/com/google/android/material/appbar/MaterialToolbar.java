...
public class MaterialToolbar extends Toolbar {
    ...
    private Pair calculateTitleBoundLimits(TextView titleTextView, TextView subtitleTextView) {
    ...
    private void layoutTitleCenteredHorizontally(View titleView, Pair pair) {
        int width = getMeasuredWidth();
