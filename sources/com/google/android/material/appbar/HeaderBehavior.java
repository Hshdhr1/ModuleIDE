...
abstract class HeaderBehavior extends ViewOffsetBehavior {
    ...
    public boolean onInterceptTouchEvent(CoordinatorLayout parent, View view, MotionEvent ev) {
        ...
        if (ev.getActionMasked() == 0) {
            ...
            int x = (int) ev.getX();
            int y2 = (int) ev.getY();
            boolean z = canDragView(view) && parent.isPointInChildBounds(view, x, y2);
    ...
    */
    ...
    int setHeaderTopBottomOffset(CoordinatorLayout parent, View view, int newOffset) {
        return setHeaderTopBottomOffset(parent, view, newOffset, Integer.MIN_VALUE, Integer.MAX_VALUE);
    }

    int setHeaderTopBottomOffset(CoordinatorLayout parent, View view, int newOffset, int minOffset, int maxOffset) {
        int newOffset2;
    ...
    final int scroll(CoordinatorLayout coordinatorLayout, View view, int dy, int minOffset, int maxOffset) {
        return setHeaderTopBottomOffset(coordinatorLayout, view, getTopBottomOffsetForScrollingSibling() - dy, minOffset, maxOffset);
    }

    final boolean fling(CoordinatorLayout coordinatorLayout, View view, int minOffset, int maxOffset, float velocityY) {
    ...
    void onFlingFinished(CoordinatorLayout parent, View view) {
    }
    ...
    private class FlingRunnable implements Runnable {
        ...
        FlingRunnable(CoordinatorLayout parent, View view) {
            this.parent = parent;
            this.layout = view;
        }
