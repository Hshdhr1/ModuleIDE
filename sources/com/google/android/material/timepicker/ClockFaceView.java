...
class ClockFaceView extends RadialViewGroup implements ClockHandView.OnRotateListener {
    ...
    static /* synthetic */ ClockHandView access$000(ClockFaceView x0) {
        return x0.clockHandView;
    }

    static /* synthetic */ int access$100(ClockFaceView x0) {
        return x0.clockHandPadding;
    }

    static /* synthetic */ SparseArray access$200(ClockFaceView x0) {
        return x0.textViewPool;
    }
    ...
    public ClockFaceView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setFocusable(true);
        a.recycle();
        this.valueAccessibilityDelegate = new 2();
    ...
    class 1 implements ViewTreeObserver.OnPreDrawListener {
        ...
        public boolean onPreDraw() {
            ...
            int circleRadius = ((ClockFaceView.this.getHeight() / 2) - ClockFaceView.access$000(ClockFaceView.this).getSelectorRadius()) - ClockFaceView.access$100(ClockFaceView.this);
    ...
    class 2 extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            if (index > 0) {
                info.setTraversalAfter((View) ClockFaceView.access$200(ClockFaceView.this).get(index - 1));
            }
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle args) {
            if (action == 16) {
                ...
                ClockFaceView.access$000(ClockFaceView.this).onTouchEvent(MotionEvent.obtain(eventTime, eventTime, 0, x, y, 0));
                ClockFaceView.access$000(ClockFaceView.this).onTouchEvent(MotionEvent.obtain(eventTime, eventTime, 1, x, y, 0));
                return true;
            }
        ...
        for (int i = 0; i < Math.max(this.values.length, size); i++) {
            ...
            if (i >= this.values.length) {
                ...
                if (contentDescription != 0) {
                    Resources res = getResources();
                    textView.setContentDescription(res.getString(contentDescription, new Object[]{this.values[i]}));
                }
            }
        }
    }
