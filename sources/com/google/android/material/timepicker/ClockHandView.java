...
class ClockHandView extends View {
    ...
    static /* synthetic */ void access$000(ClockHandView x0, float x1, boolean x2) {
        x0.setHandRotationInternal(x1, x2);
    }
    ...
    public void setHandRotation(float degrees, boolean animate) {
        ...
        this.rotationAnimator.addUpdateListener(new 1());
        this.rotationAnimator.addListener(new 2());
    ...
    class 1 implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            ClockHandView.access$000(ClockHandView.this, animatedValue, true);
        }
    }
    ...
    private Pair getValuesForAnimation(float degrees) {
