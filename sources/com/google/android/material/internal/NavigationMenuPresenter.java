...
public class NavigationMenuPresenter implements MenuPresenter {
    ...
    final View.OnClickListener onClickListener = new 1();

    private interface NavigationMenuItem {
    }

    static /* synthetic */ int access$000(NavigationMenuPresenter x0) {
        return x0.itemMaxLines;
    }
    ...
    public MenuView getMenuView(ViewGroup root) {
        if (this.menuView == null) {
            NavigationMenuView inflate = this.layoutInflater.inflate(R.layout.design_navigation_menu, root, false);
            this.menuView = inflate;
            inflate.setAccessibilityDelegateCompat(new NavigationMenuViewAccessibilityDelegate(this.menuView));
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            switch (getItemViewType(position)) {
                case 0:
                    ...
                    itemView.setMaxLines(NavigationMenuPresenter.access$000(NavigationMenuPresenter.this));
                    itemView.initialize(item.getMenuItem(), 0);
                    break;
                case 1:
                    TextView subHeader = holder.itemView;
        ...
        public void restoreInstanceState(Bundle state) {
            ...
            if (checkedItem != 0) {
                ...
                while (true) {
                    ...
                    NavigationMenuItem item2 = (NavigationMenuItem) this.items.get(i);
            ...
            if (actionViewStates != null) {
                ...
                for (int i2 = 0; i2 < size2; i2++) {
                    ...
                    if ((navigationMenuItem instanceof NavigationMenuTextItem) && (item = ((NavigationMenuTextItem) navigationMenuItem).getMenuItem()) != null && (actionView = item.getActionView()) != null && (container = (ParcelableSparseArray) actionViewStates.get(item.getItemId())) != null) {
