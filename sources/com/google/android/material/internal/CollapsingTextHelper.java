...
public final class CollapsingTextHelper {
    ...
    public void setCollapsedTextAppearance(int resId) {
        ...
        this.collapsedFontCallback = new CancelableFontCallback(new 1(), textAppearance.getFallbackFont());
        textAppearance.getFontAsync(this.view.getContext(), this.collapsedFontCallback);
        recalculate();
    }

    class 1 implements CancelableFontCallback.ApplyFont {
        1() {
        }
    ...
    public void setExpandedTextAppearance(int resId) {
        ...
        this.expandedFontCallback = new CancelableFontCallback(new 2(), textAppearance.getFallbackFont());
        textAppearance.getFontAsync(this.view.getContext(), this.expandedFontCallback);
        recalculate();
    }

    class 2 implements CancelableFontCallback.ApplyFont {
        2() {
        }
    ...
    private void drawMultilineTransition(Canvas canvas, float currentExpandedX, float y) {
        ...
        if (!this.fadeModeEnabled) {
            ...
            canvas.drawText(tmp, 0, Math.min(this.textLayout.getLineEnd(0), tmp.length()), 0.0f, lineBaseline, this.textPaint);
        }
    }
