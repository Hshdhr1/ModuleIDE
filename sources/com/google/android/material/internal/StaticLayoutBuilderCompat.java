...
final class StaticLayoutBuilderCompat {
    ...
    private void createConstructorWithReflection() throws StaticLayoutBuilderCompatException {
        Class<TextDirectionHeuristic> cls;
        if (initialized) {
            return;
        }
        try {
            ...
            if (Build.VERSION.SDK_INT >= 18) {
                ...
                String textDirClassName = this.isRtl ? "RTL" : "LTR";
                Class<TextDirectionHeuristic> loadClass = loader.loadClass("android.text.TextDirectionHeuristic");
            ...
            Constructor declaredConstructor = StaticLayout.class.getDeclaredConstructor(new Class[]{CharSequence.class, Integer.TYPE, Integer.TYPE, TextPaint.class, Integer.TYPE, Layout.Alignment.class, cls, Float.TYPE, Float.TYPE, Boolean.TYPE, TextUtils.TruncateAt.class, Integer.TYPE, Integer.TYPE});
