...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    static final Property WIDTH = new 4(Float.class, "width");
    static final Property HEIGHT = new 5(Float.class, "height");
    static final Property PADDING_START = new 6(Float.class, "paddingStart");
    static final Property PADDING_END = new 7(Float.class, "paddingEnd");
    ...
    static /* synthetic */ int access$000(ExtendedFloatingActionButton x0) {
        return x0.extendedPaddingStart;
    }

    static /* synthetic */ int access$100(ExtendedFloatingActionButton x0) {
        return x0.extendedPaddingEnd;
    }

    static /* synthetic */ boolean access$1000(ExtendedFloatingActionButton x0) {
        return x0.isOrWillBeShown();
    }

    static /* synthetic */ boolean access$1100(ExtendedFloatingActionButton x0) {
        return x0.isOrWillBeHidden();
    }

    static /* synthetic */ MotionStrategy access$200(ExtendedFloatingActionButton x0) {
        return x0.shrinkStrategy;
    }

    static /* synthetic */ MotionStrategy access$300(ExtendedFloatingActionButton x0) {
        return x0.hideStrategy;
    }

    static /* synthetic */ void access$400(ExtendedFloatingActionButton x0, MotionStrategy x1, OnChangedCallback x2) {
        x0.performMotion(x1, x2);
    }

    static /* synthetic */ MotionStrategy access$500(ExtendedFloatingActionButton x0) {
        return x0.extendStrategy;
    }

    static /* synthetic */ MotionStrategy access$600(ExtendedFloatingActionButton x0) {
        return x0.showStrategy;
    }

    static /* synthetic */ boolean access$700(ExtendedFloatingActionButton x0) {
        return x0.isExtended;
    }

    static /* synthetic */ boolean access$702(ExtendedFloatingActionButton x0, boolean x1) {
        x0.isExtended = x1;
        return x1;
    }

    static /* synthetic */ boolean access$802(ExtendedFloatingActionButton x0, boolean x1) {
        x0.isTransforming = x1;
        return x1;
    }

    static /* synthetic */ int access$902(ExtendedFloatingActionButton x0, int x1) {
        x0.animState = x1;
        return x1;
    }
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ChangeSizeStrategy changeSizeStrategy = new ChangeSizeStrategy(changeSizeTracker, new 1(), true);
        this.extendStrategy = changeSizeStrategy;
        ChangeSizeStrategy changeSizeStrategy2 = new ChangeSizeStrategy(changeSizeTracker, new 2(), false);
    ...
    class 1 implements Size {
        1() {
        }

        public int getWidth() {
            return (ExtendedFloatingActionButton.this.getMeasuredWidth() - (ExtendedFloatingActionButton.this.getCollapsedPadding() * 2)) + ExtendedFloatingActionButton.access$000(ExtendedFloatingActionButton.this) + ExtendedFloatingActionButton.access$100(ExtendedFloatingActionButton.this);
        }
    ...
    private void performMotion(MotionStrategy strategy, OnChangedCallback callback) {
        ...
        createAnimator.addListener(new 3(strategy, callback));
        for (Animator.AnimatorListener l : strategy.getListeners()) {
            createAnimator.addListener(l);
        }
    ...
    class 3 extends AnimatorListenerAdapter {
        ...
        3(MotionStrategy motionStrategy, OnChangedCallback onChangedCallback) {
    ...
    class 7 extends Property {
        7(Class cls, String arg1) {
            super(cls, arg1);
        }
    ...
    protected static class ExtendedFloatingActionButtonBehavior extends CoordinatorLayout.Behavior {
        ...
        protected void shrinkOrHide(ExtendedFloatingActionButton fab) {
            ...
            if (z) {
                strategy = ExtendedFloatingActionButton.access$200(fab);
            } else {
                strategy = ExtendedFloatingActionButton.access$300(fab);
            }
            ExtendedFloatingActionButton.access$400(fab, strategy, callback);
        }
        ...
        protected void extendOrShow(ExtendedFloatingActionButton fab) {
            ...
            if (z) {
                strategy = ExtendedFloatingActionButton.access$500(fab);
            } else {
                strategy = ExtendedFloatingActionButton.access$600(fab);
            }
            ExtendedFloatingActionButton.access$400(fab, strategy, callback);
        }
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (spec.hasPropertyValues("paddingStart")) {
                ...
                paddingValues[0].setFloatValues(new float[]{ViewCompat.getPaddingStart(ExtendedFloatingActionButton.this), this.size.getPaddingStart()});
            ...
            if (spec.hasPropertyValues("paddingEnd")) {
                ...
                paddingValues2[0].setFloatValues(new float[]{ViewCompat.getPaddingEnd(ExtendedFloatingActionButton.this), this.size.getPaddingEnd()});
        ...
        public boolean shouldCancel() {
            return this.extending == ExtendedFloatingActionButton.access$700(ExtendedFloatingActionButton.this) || ExtendedFloatingActionButton.this.getIcon() == null || TextUtils.isEmpty(ExtendedFloatingActionButton.this.getText());
        }
    }
