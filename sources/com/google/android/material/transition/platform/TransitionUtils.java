...
class TransitionUtils {
    ...
    class 1 implements ShapeAppearanceModel.CornerSizeUnaryOperator {
    ...
    static ShapeAppearanceModel convertToRelativeCornerSizes(ShapeAppearanceModel shapeAppearanceModel, RectF bounds) {
        return shapeAppearanceModel.withTransformedCornerSizes(new 1(bounds));
    }
    ...
    static ShapeAppearanceModel lerp(ShapeAppearanceModel startValue, ShapeAppearanceModel endValue, RectF startBounds, RectF endBounds, float startFraction, float endFraction, float fraction) {
        ...
        return transformCornerSizes(startValue, endValue, startBounds, new 2(startBounds, endBounds, startFraction, endFraction, fraction));
    }

    class 2 implements CornerSizeBinaryOperator {
        ...
        2(RectF rectF, RectF rectF2, float f, float f2, float f3) {
        ...
        public CornerSize apply(CornerSize cornerSize1, CornerSize cornerSize2) {
            float startCornerSize = cornerSize1.getCornerSize(this.val$startBounds);
            float endCornerSize = cornerSize2.getCornerSize(this.val$endBounds);
            float cornerSize = TransitionUtils.lerp(startCornerSize, endCornerSize, this.val$startFraction, this.val$endFraction, this.val$fraction);
