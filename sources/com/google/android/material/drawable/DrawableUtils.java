...
public final class DrawableUtils {
    ...
    public static AttributeSet parseDrawableXml(Context context, int id, CharSequence startTag) {
        ...
        try {
            ...
            if (!TextUtils.equals(xml.getName(), startTag)) {
    ...
    public static void setRippleDrawableRadius(RippleDrawable drawable, int radius) {
        ...
        try {
            Method setMaxRadiusMethod = RippleDrawable.class.getDeclaredMethod("setMaxRadius", new Class[]{Integer.TYPE});
            setMaxRadiusMethod.invoke(drawable, new Object[]{Integer.valueOf(radius)});
