...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    static /* synthetic */ int access$100(MaterialButtonToggleGroup x0, View x1) {
        return x0.getIndexWithinVisibleButtons(x1);
    }
    ...
    public MaterialButtonToggleGroup(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.childOrderComparator = new 1();
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        ...
        ViewCompat.setAccessibilityDelegate(buttonChild, new 2());
    }
    ...
    class 2 extends AccessibilityDelegateCompat {
        ...
        public void onInitializeAccessibilityNodeInfo(View host, AccessibilityNodeInfoCompat info) {
            ...
            info.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(0, 1, MaterialButtonToggleGroup.access$100(MaterialButtonToggleGroup.this, host), 1, false, ((MaterialButton) host).isChecked()));
        }
    }
    ...
    private void setCheckedStateForView(int viewId, boolean checked) {
        MaterialButton findViewById = findViewById(viewId);
    ...
    private void resetChildMargins(int childIndex) {
        ...
        LinearLayout.LayoutParams params = currentButton.getLayoutParams();
        if (getOrientation() == 1) {
            params.topMargin = 0;
            params.bottomMargin = 0;
        } else {
    ...
    private CornerData getNewCornerData(int index, int firstVisibleChildIndex, int lastVisibleChildIndex) {
        CornerData cornerData = (CornerData) this.originalCornerData.get(index);
    ...
    private void updateCheckedIds(Set set) {
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            setCheckedStateForView(buttonId, set.contains(Integer.valueOf(buttonId)));
            if (previousCheckedIds.contains(Integer.valueOf(buttonId)) != set.contains(Integer.valueOf(buttonId))) {
                dispatchOnButtonChecked(buttonId, set.contains(Integer.valueOf(buttonId)));
            }
        }
        invalidate();
    }
    ...
    private void dispatchOnButtonChecked(int buttonId, boolean checked) {
        ...
        while (it.hasNext()) {
            OnButtonCheckedListener listener = (OnButtonCheckedListener) it.next();
    ...
    private LinearLayout.LayoutParams buildLayoutParams(View child) {
        LinearLayout.LayoutParams layoutParams = child.getLayoutParams();
        if (layoutParams instanceof LinearLayout.LayoutParams) {
            return layoutParams;
        }
        return new LinearLayout.LayoutParams(((ViewGroup.LayoutParams) layoutParams).width, ((ViewGroup.LayoutParams) layoutParams).height);
    }
    ...
    private class PressedStateTracker implements MaterialButton.OnPressedChangeListener {
        ...
        /* synthetic */ PressedStateTracker(MaterialButtonToggleGroup x0, 1 x1) {
            this();
        }
