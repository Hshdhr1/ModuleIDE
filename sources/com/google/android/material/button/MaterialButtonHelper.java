...
class MaterialButtonHelper {
    ...
    void setRippleColor(ColorStateList rippleColor) {
        if (this.rippleColor != rippleColor) {
            ...
            if (z && (this.materialButton.getBackground() instanceof RippleDrawable)) {
                this.materialButton.getBackground().setColor(RippleUtils.sanitizeRippleDrawableColor(rippleColor));
    ...
    private MaterialShapeDrawable getMaterialShapeDrawable(boolean z) {
        ...
        if (layerDrawable != null && layerDrawable.getNumberOfLayers() > 0) {
            if (IS_MIN_LOLLIPOP) {
                return (MaterialShapeDrawable) this.rippleDrawable.getDrawable(0).getDrawable().getDrawable(!z ? 1 : 0);
            }
