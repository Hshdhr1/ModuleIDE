...
public class MaterialButton extends AppCompatButton implements Checkable, Shapeable {
    ...
    private int getTextWidth() {
        ...
        return Math.min((int) paint.measureText(buttonText), getLayout().getEllipsizedWidth());
    }
    ...
    public void setChecked(boolean checked) {
        if (isCheckable() && isEnabled() && this.checked != checked) {
            ...
            if (getParent() instanceof MaterialButtonToggleGroup) {
                getParent().onButtonCheckedStateChanged(this, this.checked);
            }
            ...
            while (it.hasNext()) {
                OnCheckedChangeListener listener = (OnCheckedChangeListener) it.next();
