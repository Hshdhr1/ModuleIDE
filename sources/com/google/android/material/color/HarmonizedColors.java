...
public class HarmonizedColors {
    ...
    private static Map createHarmonizedColorReplacementMap(Context originalContext, HarmonizedColorsOptions options) {
        ...
        for (int colorResourceId : options.getColorResourceIds()) {
            ...
            hashMap.put(Integer.valueOf(colorResourceId), Integer.valueOf(harmonizedColor));
        }
        ...
        if (colorAttributes != null) {
            ...
            if (attributes.length > 0) {
                ...
                addHarmonizedColorAttributesToReplacementMap(hashMap, themeAttributesTypedArray, themeOverlayAttributesTypedArray, colorToHarmonizeWith);
    ...
    private static boolean addResourcesLoaderToContext(Context context, Map map) {
        ResourcesLoader resourcesLoader = ColorResourcesLoaderCreator.create(context, map);
    ...
    private static void addHarmonizedColorAttributesToReplacementMap(Map map, TypedArray themeAttributesTypedArray, TypedArray themeOverlayAttributesTypedArray, int colorToHarmonizeWith) {
        ...
        for (int i = 0; i < themeAttributesTypedArray.getIndexCount(); i++) {
            ...
            if (resourceId != 0 && themeAttributesTypedArray.hasValue(i) && isColorResource(themeAttributesTypedArray.getType(i))) {
                ...
                map.put(Integer.valueOf(resourceId), Integer.valueOf(MaterialColors.harmonize(colorToHarmonize, colorToHarmonizeWith)));
            }
        }
    }
