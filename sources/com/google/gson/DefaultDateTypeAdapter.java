...
final class DefaultDateTypeAdapter extends TypeAdapter {
    ...
    DefaultDateTypeAdapter(Class cls) {
    ...
    DefaultDateTypeAdapter(Class cls, String datePattern) {
        this.dateFormats = new ArrayList();
        this.dateType = verifyDateType(cls);
    ...
    DefaultDateTypeAdapter(Class cls, int style) {
        this.dateFormats = new ArrayList();
        this.dateType = verifyDateType(cls);
    ...
    public DefaultDateTypeAdapter(Class cls, int dateStyle, int timeStyle) {
        this.dateFormats = new ArrayList();
        this.dateType = verifyDateType(cls);
    ...
    private static Class verifyDateType(Class cls) {
    ...
    */
    private java.util.Date deserializeToDate(java.lang.String r6) {
        /*
            r5 = this;
            java.util.List r3 = r5.dateFormats
            monitor-enter(r3)
            java.util.List r2 = r5.dateFormats     // Catch: java.lang.Throwable -> L27
    ...
    public String toString() {
        ...
        return simpleDateFormat instanceof SimpleDateFormat ? "DefaultDateTypeAdapter(" + simpleDateFormat.toPattern() + ')' : "DefaultDateTypeAdapter(" + simpleDateFormat.getClass().getSimpleName() + ')';
    }
}
