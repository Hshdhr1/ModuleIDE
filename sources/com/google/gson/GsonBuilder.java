...
public final class GsonBuilder {
    ...
    public GsonBuilder registerTypeHierarchyAdapter(Class cls, Object typeAdapter) {
        ...
        if ((typeAdapter instanceof JsonDeserializer) || (typeAdapter instanceof JsonSerializer)) {
            this.hierarchyFactories.add(TreeTypeAdapter.newTypeHierarchyFactory(cls, typeAdapter));
        }
        if (typeAdapter instanceof TypeAdapter) {
            this.factories.add(TypeAdapters.newTypeHierarchyFactory(cls, (TypeAdapter) typeAdapter));
        }
        return this;
    }
    ...
    private void addTypeAdaptersForDate(String datePattern, int dateStyle, int timeStyle, List list) {
        ...
        list.add(TypeAdapters.newFactory(java.util.Date.class, dateTypeAdapter));
        list.add(TypeAdapters.newFactory(Timestamp.class, timestampTypeAdapter));
        list.add(TypeAdapters.newFactory(Date.class, javaSqlDateTypeAdapter));
    }
}
