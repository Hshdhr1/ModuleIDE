...
public class ISO8601Utils {
    ...
    public static String format(Date date, boolean millis, TimeZone tz) {
        ...
        padInt(formatted, gregorianCalendar.get(1), "yyyy".length());
        formatted.append('-');
        padInt(formatted, gregorianCalendar.get(2) + 1, "MM".length());
        formatted.append('-');
        padInt(formatted, gregorianCalendar.get(5), "dd".length());
        formatted.append('T');
        padInt(formatted, gregorianCalendar.get(11), "hh".length());
        formatted.append(':');
        padInt(formatted, gregorianCalendar.get(12), "mm".length());
        formatted.append(':');
        padInt(formatted, gregorianCalendar.get(13), "ss".length());
        if (millis) {
            formatted.append('.');
            padInt(formatted, gregorianCalendar.get(14), "sss".length());
        }
