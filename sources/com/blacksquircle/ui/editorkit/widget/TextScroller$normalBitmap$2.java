...
final class TextScroller$normalBitmap$2 extends Lambda implements Function0 {
    final /* synthetic */ TextScroller this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    TextScroller$normalBitmap$2(TextScroller textScroller) {
        super(0);
    ...
    public final Bitmap invoke() {
        ...
        TextScroller.access$getThumbNormal$p(this.this$0).draw(new Canvas(createBitmap));
        return createBitmap;
    }
}
